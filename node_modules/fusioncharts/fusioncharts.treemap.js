...
(function (T) {
    ...
    T.register("module", ["private", "modules.renderer.js-treemap", function () {
        function Z(a) {
        ...
        function O() {
            ...
            this.statePointerLow = {value: void 0, index: void 0};
            this.statePointerHigh = {value: void 0, index: void 0}
        }

        var ia, ja, ga, ka, D = this.hcLib, aa = D.chartAPI, N = Math, W = N.max, la = N.round, sa = N.tan, ma = N.min,
            ta = N.PI, na = D.extend2, X = this.window, ua = D.parsexAxisStyles, N = D.Raphael, oa = D.graphics,
            ba = oa.convertColor, pa = oa.getLightColor, K = this.raiseEvent, y = D.pluckNumber, H = D.pluck,
            va = D.each, ca = D.BLANKSTRING,
            wa = "rgba(192,192,192," + (/msie/i.test(X.navigator.userAgent) && !X.opera ? .002 : 1E-6) + ")",
            X = !D.CREDIT_REGEX.test(X.location.hostname), qa = D.plotEventHandler, da = D.schedular,
            xa = D.preDefStr.DEFAULT;
        N.addSymbol({
            backIcon: function (a, b, d) {
                --d;
                var c = b + d, t = c - d / 2, k = a + d, n = t - d;
                return ["M", a, b - d, "L", a - d, b, a, c, a, t, k, t, k, n, k - d, n, "Z"]
            }, homeIcon: function (a, b, d) {
                --d;
                var c = 2 * d, t = a - d, k = t + c / 6, n = b + d, B = k + c / 4, w = n - d / 2, z = B + c / 6,
                    m = w + d / 2, A = z + c / 4, f = m - d;
        ...
        r.prototype.addChildren = function (a, b) {
            var d = this.getChildren() || (this.next = []), c = d.length;
            b || (b = c - 1);
        ...
        r.prototype.getSibling = function (a) {
            a = a.toLowerCase();
            var b = this.getParent(), d = this.getLabel(), c, t;
            if (b) for (b = b.getChildren(), c = 0; c < b.length; c++) if (t = b[c], t = t.getLabel(), t === d) switch (a) {
                case "left":
                    return b[c - 1];
                case "right":
                    return b[c + 1]
        ...
        O.prototype.addInBucket = function (a) {
            var b = this._b, d = a.getColorValue(), c = 0, t = b.length - 1;
            if (d) {
                a:{
                    for (var k, n; c <= t;) if (k = (c + t) / 2 | 0, n = b[k], n = n.getColorValue(), n < d) c = k + 1; else if (n > d) t = k - 1; else {
                        d = k;
                        break a
                    }
                    d = ~t
        ...
        O.prototype.moveLowerShadePointer = function (a) {
            var b = this._b, d, c, t, k = this.statePointerLow;
            d = k.index;
            c = k.value;
            var n = !1;
            d = void 0 !== d ? d : 0;
        ...
        O.prototype.moveHigherShadePointer = function (a) {
            var b =
                this._b, d = b.length, c, t, k = this.statePointerHigh;
            t = k.index;
            c = k.value;
            var n = !1, d = void 0 !== t ? t : d - 1;
        ...
        aa("treemap", {
            ...
            applicableDSList: {treemap: !0},
            _mouseEvtHandler: function (a) {
                var b = a.data, d = b.chart, b = b.mouseTracker, c = d.config, t = c.canvasLeft, k = c.canvasRight,
                    n = c.canvasBottom, B = c.canvasTop, w = c.datasetOrder || d.components.dataset,
                    c = D.getMouseCoordinate(d.linkedItems.container, a.originalEvent, d), z = c.chartX, m = c.chartY,
                    A, f, h = !1, l = w.length, x, v = b._lastDatasetIndex, c =
                        b._lastPointIndex;
                if (z > t && z < k && m > B && m < n || d.config.plotOverFlow) for (; l-- && !h;) (A = w[l]) && (f = A._getHoveredPlot && A._getHoveredPlot(z, m)) && f.hovered && (h = !0, f.datasetIndex = l, x = b._getMouseEvents(a, f.datasetIndex, f.pointIndex));
                ...
                if (h) for (d = x.events && x.events.length, b._lastDatasetIndex = f.datasetIndex, c = b._lastPointIndex = f.pointIndex, f = 0; f < d; f += 1) A && A._firePlotEvent &&
                A._firePlotEvent(x.events[f], c, a)
            },
            addData: function () {
                var a = this._ref.algorithmFactory, b = Array.prototype.slice.call(arguments, 0);
                b.unshift("addData");
            ...
            _createDatasets: function () {
                var a = this.components, b =
                    this.jsonData, d = b.dataset, d = b.data || d && d[0].data, c = this.defaultDatasetType, t = [];
            ...
            init: function () {
                var a = {}, b = {}, d = {};
                this._ref = {
                    afAPI: ia(a, b, d), algorithmFactory: ja(a, b, d), containerManager: ka(a,
                        b, d), treeOpt: ga
                };
                aa.guageBase.init.apply(this, arguments)
            }
        }, aa.guageBase, {enablemousetracking: !0});
        T.register("component", ["dataset", "TreeMap", {
            type: "treemap", pIndex: 2, customConfigFn: "_createDatasets", init: function (a) {
                this.JSONData = a.data[0];
                this.components = {};
                this.conf = {};
                this.graphics = {elemStore: {rect: [], label: [], highlight: [], hot: [], polypath: []}};
                this.configure()
            }, configure: function () {
                var a, b = this.chart, d = b.components, c = this.conf, b = b.jsonData.chart;
                c.metaTreeInf = {};
                ...
                d.postLegendInitFn({min: 0, max: 100});
                c.isConfigured = !0
            }, _getHoveredPlot: function (a, b) {
                var d, c;
                for (c = (this.kdTree || []).length; c-- && (!this.kdTree[c] || !(d = this.kdTree[c].searchTreemap(a, b)));) ;
                if (d) return this.pointObj = d, {pointIndex: d.i || d.index, hovered: !0, pointObj: d}
                ...
                function d(a, b, p, u) {
                    ...
                    if (0 !== a.length) {
                        ...
                        if (1 === p - b) return a[b][g] > a[p][g] ? (e.point = a[b], e.left = {point: a[p]}) : (e.point = a[p], e.left = {point: a[b]}), e;
                        g = b + p >> 1;
                ...
                var n = a && a[0] && a[0].plotDetails.rect || 5, B, w = Math.max, z = Math.floor, m = Math.sqrt,
                    A = Math.min, f = Math.log, h = Math.exp, l = Math.pow;
                B = {};
                a = a || [];
                for (B = a.length; B--;) a[B].r > n && (n = a[B].r), a[B].x = +a[B].plotDetails.rect.x, a[B].y = +a[B].plotDetails.rect.y;
                B = {
                    tree: d(a, 0, a.length - 1, !1), search: function (a, c) {
                        function d(e) {
                            var p = b(a, e.x1, e.x2) && b(c, e.y1, e.y2), q;
                            q = e.point.y;
                        ...
                        var g, q = a - n, f = a + n, h = c - n, z = c + n, w = !1, A = 0;
                        u(this.tree);
                        return g && g.point || g
                    }, searchTreemap: function (a, c) {
                        var b, d = function (e, g) {
                            if (e && e.point) {
                                var q = e.point.x, l = q + e.point.plotDetails.rect.width, f = e.point.y,
                ...
                var a = this.chart.config.trackerConfig, b, d = [];
                ...
                var c = this, t = c.conf, k = c.chart, n = k.getJobList(), B = k.components.paper;
                b = c.chart.config.trackerConfig[b || 0];
                var w = k.graphics.trackerGroup, z = b && b.node && b.node.plotItem,
                    m = b && b.evtFns && b.evtFns.tooltip[0], A = k.components.paper.canvas.style, f = D.toolTip;
                d = d.originalEvent;
                var h = c.graphics.singleTracker, l = c.pointObj.plotDetails,
                    x = l && l.rect, t = t.highlightParentsOnHover, v = b && b.node.path,
                ...
                if (z) switch (a) {
                    case "mouseover":
                        ...
                        break;
                    case "mouseout":
                        h.attr({x: 0, y: 0, width: 0, height: 0, stroke: "#ffffff", "stroke-width": "0px"});
                        f.hide();
                        A.cursor = xa;
                        h.toFront();
                ...
                var a = this, b =
                        a.conf, d = a.chart, c = d.config.trackerConfig, t = d.getJobList(), k = d.config, n = d.components,
                    B = k.canvasLeft, w = k.canvasRight, z = k.canvasBottom, m = k.canvasTop, A = n.paper,
                    f = d.jsonData.chart, h = d.graphics, l = h.trackerGroup, x, v, p, u, e, k = b.metaTreeInf,
                    g = a.graphics.elemStore, q = {}, C, R, I = ["fontFamily", "fontSize", "fontWeight", "fontStyle"],
                    ra = {}, P, n = n.gradientLegend, r, Q = d._ref, Y = Q.afAPI.visibilityController,
                    J = d.get("config", "animationObj"), F = J.duration || 0, ea = J.dummyObj, y = J.animObj,
                    fa = J.animType, S, J = Q.containerManager, Q = Q.algorithmFactory,
                    G;
                c && (c.length = 0);
                S = ua({}, {}, f, {fontFamily: "Verdana,sans", fontSize: "10px"});
                c = 0;
                ...
                q.drawPolyPath = function (a, c) {
                    var b, e;
                    b = (q.graphicPool(!1, "polyPathItem") || (e = A.path(x))).attr({path: a._path}).animateWith(ea, y, {path: a.path}, F, fa);
                    b.css(c);
                    e && g.polypath.push(e);
                    return b
                };
                ...
                q.drawText = function (a, c, d, l, p) {
                    var v = {}, x, f, h = q.graphicPool(!1, "labelItem") || (x = A.text(e)),
                        m = q.graphicPool(!1, "highlightItem") || (f = A.text(u)), w = d.textAttrs;
                    d = d.highlightAttrs;
                    na(v, w);
                    delete v.fill;
                    v["stroke-linejoin"] = "round";
                    h.attr({x: l.x || C, y: l.y || R, fill: "#000000"}).css(w);
                    h.attr(p);
                    a = 0 > c.x || 0 > c.y ? ca : a;
                    h.animateWith(ea, y, {text: a, x: c.x, y: c.y}, F, fa);
                    m.attr({text: a, x: l.x || C, y: l.y || R, stroke: b.labelGlow ? "#ffffff" : wa}).css(v).css(d);
                    m.attr(p);
                    m.animateWith(ea, y, {x: c.x, y: c.y}, F, fa);
                    g.label.push(x);
                    g.highlight.push(f);
                    return {label: h, highlightMask: m}
                };
                ...
                q.disposeItems = function (a, c) {
                    var b, e, d,
                        g = c || "plotItem labelItem hotItem highlightItem polyPathItem pathlabelItem pathhighlightItem stackedpolyPathItem stackedpathlabelItem stackedpathhighlightItem".split(" ");
                ...
                q.graphicPool = function () {
                    ...
                    return function (b, c, e) {
                        ...
                        if (b) d.push(e); else if (b = d.splice(0, 1)[0]) return b.show(), b
                    }
                }();
                ...
                J.draw();
                r = Q.applyShadeFiltering({fill: b.rangeOutBgColor, opacity: .01 * b.rangeOutBgAlpha}, function (a) {
                    this.plotItem && this.plotItem.css(a)
                });
                n && n.enabled && (n.resetLegend(), n.clearListeners());
                n.notifyWhenUpdate(function (a, b) {
                    r.call(this, {start: a, end: b})
                }, this);
                b.isConfigured = !1;
        ...
        ia = function (a, b, d) {
            ...
            c.prototype.get = function () {
                var a = this.order, b = this.bucket, c = this.cleansingFn;
                return function f(d, l) {
                    var x, v, p, u;
                    v = ["label", "value", "data", "svalue"];
                    if (d) for (u in x = new r(d.label, c(d.value), c(d.svalue)), p = d.data || [], 0 === p.length && b && b.addInBucket(x), x.setDepth(l), d) -1 === v.indexOf(u) && x.setMeta(u, d[u]);
                    a && (p = a(p));
                    ...
                    return {
                        next: function (a) {
                            ...
                            if (!p) {
                                ...
                                (g = (a = void 0 !== a ? b.getDepth() >= a ? [] : b.getChildren() : b.getChildren()) && a.length || 0) &&
                                [].unshift.apply(c, a);
                                0 === c.length && (p = !0);
                                return b
                            }
            ...
            b = function () {
                var a = [], b, c = !1, d = {visibility: "visible"};
                return {
            ...
            a.initConfigurationForlabel = function (a, b, c) {
                var d = a.x, f = a.y, h = b / 2, l = c.showParent ? 0 : 1, x = c.showChildLabels;
                return function (a, p, u, e) {
                    u = !1;
                    var g = {x: void 0, y: void 0, width: void 0, height: void 0}, q = {}, C = 0, w = {}, I = {}, t,
                        w = a.meta;
            ...
            a.mapColorManager = function (a, b, c) {
                ...
                return function (c, h, l) {
                    h = {};
                    var x = c.cssConf, v = c.meta, v = v.fillcolor ? Z(v.fillcolor) : void 0, p = c.getParent(), u;
                    u = c.getColorValue();
                    a.isLegendEnabled = !0;
            ...
            a.abstractEventRegisterer = function (c, b, k, t) {
                ...
                var h = b.chart, l = h.components, x = l.dataset[0], v = l.toolbarBtns, p = h.chartInstance, u = b.conf,
                    e = l.gradientLegend, g = c.drawTree, q = t.disposeChild, C, R = h.getJobList(), I = arguments, B,
                    P, y = {colorValue: "svalue", label: "name", value: "value", rect: "metrics"};
                B = a.context.getInstance("ClickedState");
                h._intSR = {};
                h._intSR.backToParent = C = function (b) {
                    var c = this, d = c, e = d && c.getParent(),
                    ...
                    b ? K("beforedrillup", {node: c, withoutHead: !u.showParent}, p, void 0, function () {
                        e && (l.state = "drillup", l.node = [{virginNode: a.getVisibleRoot()}, e], q(d), g.apply(e, I));
                        K("drillup", {node: c, withoutHead: !u.showParent, drillUp: C, drillUpToTop: P}, p);
                        c = c && c.getParent()
                    }, function () {
                        K("drillupcancelled", {node: c, withoutHead: !u.showParent}, p)
                    }) : (e && (l.state = "drillup", l.node = [{virginNode: a.getVisibleRoot()}, e], q(d), g.apply(e, I)), c = c && c.getParent())
                };
                h._intSR.resetTree = P = function (c) {
                    var b = this, d = b && b.getParent(), e,
                        l = a.context.getInstance("ClickedState").get("VisibileRoot") || {};
                    h.config.trackerConfig.length = 0;
                    for (R.trackerDrawID.push(da.addJob(x.kdTreePartioning, D.priorityList.tracker)); d;) e = d, d = d.getParent();
                    c ? K("beforedrillup", {node: b, withoutHead: !u.showParent},
                        p, void 0, function () {
                            e && (l.state = "drillup", l.node = [{virginNode: a.getVisibleRoot()}, e], q(e), g.apply(e, I), K("drillup", {
                                node: b,
                            ...
                            K("drillupcancelled", {node: b, withoutHead: !u.showParent}, p)
                        }) : e && (l.state = "drillup", l.node = [{virginNode: a.getVisibleRoot()}, e], q(e), g.apply(e, I))
                };
                return {
                    click: function (a, b) {
                        var g = a.virginNode, l = x.graphics.singleTracker, k = x.kdTree, m, I, z;
                        K("dataplotclick", f(a.virginNode), p);
                        if (I = g.getParent()) {
                            if (g ===
                                b) z = I, k && (k.length = 0), h.config.trackerConfig.length = 0, m = "drillup"; else {
                                if (g.next) z = g, k && (k.length = 0); else if (z = I, b === z) {
                                    m = void 0;
                                    return
                                }
                                h.config.trackerConfig.length = 0;
                            ...
                            m && K("before" + m, {node: z, withoutHead: !u.showParent}, p, void 0, function () {
                                B.set("VisibileRoot", {node: a, state: m});
                                q.call(t, z);
                                n = z;
                                d.draw();
                                K(m, {node: z, withoutHead: !u.showParent, drillUp: C, drillUpToTop: P}, p)
                            }, function () {
                                K(m + "cancelled", {node: z, withoutHead: !u.showParent},
                                    p)
                            });
                            v.back && v.back.attachEventHandlers({click: C.bind(z)});
                            v.home && v.home.attachEventHandlers({click: P.bind(z)});
                            l && l.attr({x: 0, y: 0, width: 0, height: 0, stroke: "rgba(255,255,255,0)"})
                        }
                        ...
                        var c = f(a.virginNode), b = x.graphics.singleTracker;
                        b && b.attr({x: 0, y: 0, width: 0, height: 0, stroke: "rgba(255,255,255,0)"});
        ...
        ja = function (a, b) {
            ...
            function k() {
                ...
                a = c.slice(-1)[0];
                return function () {
                    var d = Array.prototype.slice.call(arguments, 0), f = d.shift(), e = d.shift();
                    ga(m, function (a) {
            ...
            var n, B = a.AbstractTreeMaker, w, z, m, A, f, h;
            n = {
                sliceanddice: {
                    areaBaseCalculator: function (a, c) {
                        return function (b, d, f) {
                            var e, g, q = {}, h, k, m, t = e = 0;
                            if (b) {
                                f && (e = f.textMargin || e);
                                t = e;
                                f = b.getParent();
                                ...
                                if (f) {
                                    ...
                                    k = m.width -
                                        2 * a;
                                    q.effectiveRect = {height: h, width: k, x: m.x + a, y: m.y + c + t};
                                    q.effectiveArea = h * k;
                        ...
                        return function (a, c) {
                            ...
                            return {height: b, width: d, x: e, y: g}
                        }
                    }, horizontalVerticalManager: function (a) {
                        var c = "vertical" === a ? !0 : !1;
                        return function (a, b, d) {
                            var e, g, q, l = a.effectiveArea * a.ratio, f = a.effectiveRect, h = b.rect;
                            a.lastIsParent ?
                            ...
                            return {height: a, width: e, x: g, y: q}
                        }
                    }, drawTree: function (c,
                                           b, d, p) {
                        var u = b.chart, e = u.components, g = u.config || (u.config = {}),
                            q = g.trackerConfig || (g.trackerConfig = []), m = e.numberFormatter, e = e.toolbarBtns,
                            k = p.drawRect, t = p.drawText, z = p.drawHot, g = d.horizontalPadding,
                            w = d.verticalPadding, A = b.chart.linkedItems.smartLabel, n = a.iterator, B = n(this).df,
                            J, y = c.areaBaseCalculator(g, w), r = b.conf, H = r.highlightParentsOnHover, K,
                            S = a.context, g = a.visibilityController, G = a.mapColorManager(r, b.conf.colorRange),
                            w = a.abstractEventRegisterer.apply(a, arguments), ha = w.click, V = w.mouseover,
                            L = w.mouseout,
                            w = r.slicingMode,
                            M = c["alternate" === w ? "alternateModeManager" : "horizontalVerticalManager"](w),
                            w = u._intSR, E, n = S.getInstance("ClickedState").get("VisibileRoot") || {};
                        ...
                        K = a.initConfigurationForlabel({x: 5, y: 5}, r.parentLabelLineHeight, r);
                        ...
                        u = w.backToParent;
                        g = w.resetTree;
                        e.back && e.back.attachEventHandlers({click: u.bind(J)});
                        e.home && e.home.attachEventHandlers({click: g.bind(J)});
                        (function U(a, c) {
                            var b, d, e,
                                g, f, l, x, v;
                            l = {};
                            ...
                            a && (E = m.yAxis(a.getValue()), O = m.sYAxis(a.getColorValue()), a.setPath(), b = a.rect || {}, d = a.textRect || {}, e = a.rect = {}, x = a.textRect = {}, e.width = c.width, e.height = c.height, e.x = c.x, e.y = c.y, x = G(a), (w = a.plotItem) && p.graphicPool(!0, "plotItem", w, b), w = a.plotItem = k(e, x, b, a.overAttr), a.cssConf = x, v = K(a, e), g = v.conf, l.textMargin = g.rectShiftY, x = a.textRect = g.textRect, u = A.getSmartText(g.label, x.width, x.height).text, a.plotItem = w, (g = a.labelItem) ? (f = a.highlightItem, p.graphicPool(!0,
                                ...
                                E + Q : ca, n.rect = e, P.hover = [function (a) {
                                var b, c, d;
                                ...
                                a.plotItem.tracker.attr({fill: b});
                                L(this)
                            }.bind(n)], P.tooltip = [n.toolText], P.click = [function () {
                                ha(this, J)
                            }.bind(n)], (e = a.hotItem) && p.graphicPool(!0, "hotItem", e, b), q.push({
                                node: a, key: "hotItem",
                                plotDetails: n, evtFns: P, callback: z
                    ...
                    orderNodes: function () {
                        ...
                        a.prototype.addNode = function (a) {
                            var b = this._rTotalArea, c, d, e, g, f, h, l, m = this._hSegmented, k = this._rx,
                                n = this._ry, w, t, z, A, B = 0;
                            this.nodes.push(a);
                            e = 0;
                            ...
                            this.getNextLogicalDivision = function () {
                                return {height: z, width: A, x: w, y: t}
                            };
                            return a
                        };
                        return {RowLayout: a}
                        ...
                        var k = c.chart, e = k.config || (k.config = {}), g = e.trackerConfig || (e.trackerConfig = []),
                            e = k.components, q = e.numberFormatter, e = e.toolbarBtns,
                            n = b.areaBaseCalculator(d.horizontalPadding, d.verticalPadding),
                            w = b.layoutManager.RowLayout, t = c.chart.linkedItems.smartLabel, z = m.drawRect,
                            A = m.drawText, B = m.drawHot, r = a.iterator, y = r(this).bf, J, F = c.conf,
                            K = F.highlightParentsOnHover, H, O = a.context,
                            S = a.mapColorManager(F, c.conf.colorRange),
                            r = a.abstractEventRegisterer.apply(a, arguments), G = r.click, ha = r.mouseover,
                            V = r.mouseout, r = k._intSR, L = a.visibilityController, M, E;
                        ...
                        H = a.initConfigurationForlabel({x: 5, y: 5},
                        ...
                        k = r.backToParent;
                        r = r.resetTree;
                        e.back && e.back.attachEventHandlers({click: k.bind(J)});
                        e.home && e.home.attachEventHandlers({click: r.bind(J)});
                        (function U(a, b) {
                            var c, d = {}, e, f, l, k, x, v, u = 0, r, y, E, L;
                            v = {};
                            var M;
                            r = {};
                            y = {};
                            ...
                            if (a) {
                                ...
                                l = A(L, k, {textAttrs: M.attr, highlightAttrs: M.highlight}, l, a.overAttr);
                                a.labelItem = l.label;
                                ...
                                g.push({node: a, key: "hotItem", plotDetails: r, evtFns: y, callback: B});
                                if (x = void 0 !== h ? a.getDepth() >= h ? void 0 : a.getChildren() : a.getChildren()) for (r = n(x, function (a, b) {
                                    var c, d, e = 0, g, f, l = [];
                                    c = new w({
                                    ...
                                    for (d = x.length; e++ !== d;) g = x[e - 1], f = c.addNode(g),
                                        !1 === f ? (c = c.getNextLogicalDivision(), c = new w(c, b.getValue() - u), e--) : (u += parseFloat(g.getValue(), 10), l.push(g));
                                    return l
        ...
        ga = function (a, b, d, c) {
            ...
            function k(a) {
                var b, c, d, k = this.getChildren() || [], f = k.length;
                for (b = 0; b < f; b += 1) if (d = k[b], d.label.toLowerCase().trim() === a.toLowerCase().trim()) {
                    c = d;
                    break
                }
                return c
            ...
            return {
                deleteData: function (a, c) {
                    var k = t(a), m = (void 0).iterator(k).df, r = k && k.getParent(),
                        f = k && k.getSiblingCount("left"), h = r && r.getChildren(), l = (void 0).getVisibleRoot();
                    if (k && r) {
                        h.splice(f, 1);
                    ...
                    for (var n, f, h, l = 0, r = !0, v = (void 0).getVisibleRoot(); a.length;) if (n = a.pop(), n = (void 0).makeTree(n, c, !1), l = n.getValue(), f = t(d || [])) for (f.getChildren() || (h = f.getValue(), r = !1),
        ...
        ka = function (a, b, d) {
            ...
            function k(a, b, c) {
                var d = a.width, f = a.height, h = m.seperatorAngle / 2;
                a = ["M", a.x, a.y];
                ...
                return {path: a.concat(c(f)[b]), _path: a.concat(c(0)[b]), offset: k}
            }
            ...
            var B, w, z, m, A, f, h = function (b, c) {
                var f, h, l = a.mapColorManager(m, m.colorRange, !0), n = function () {
                        var a;
                        return {
                            get: function (c, b, d) {
                                var e = {y: c.startY, height: c.effectiveHeight};
                                b = f[b];
                                var g = b.getParent();
                                e.x = a || (a = c.startX);
                    ...
                    }(), r = a.initConfigurationForlabel({x: 5, y: 5}, m.parentLabelLineHeight, m), t = A.drawPolyPath,
                    v = A.drawText, w = A.drawHot, u = {
                        navigationHistory: {
                            path: "polyPathItem",
                            label: "pathlabelItem",
                    ...
                    }, y = B.chart, F = y.config.trackerConfig, D = y.components.gradientLegend,
                    ...
                    H = function (c) {
                        return function () {
                            ...
                            F.length = 0;
                            b.state = "drillup";
                            b.node = [{virginNode: a.getVisibleRoot()}, c];
                ...
                y.setStyle({fontSize: G, lineHeight: G});
                for (G = 0; G < h; G += 1) L = f[G], M = n.get(b, G, c), N = (V = k(M, c ? "both" : 1 === h ? "both" : 0 === G ? "left" : G < h - 1 ? "no" : "right")).offset, L[u[c ? "stacked" : "navigationHistory"].path] = t(V, l(L, !0, !0), G), V = r(L, M, !1, !0), E = V.conf, U = E.textRect,
                    ...
                    node: L, key: u[c ? "stacked" : "navigationHistory"].hotItem, plotDetails: {rect: M}, evtFns: {
                        click: [H(L, c)], hover: [K(L), O()], tooltip: [m.showTooltip ?
                            L.getLabel() : ca]
                    }, callback: w
                })
            }, l = function (a) {
                return {treeMap: r, navigationBar: h, stackedNavigation: n}[a]
            }, x = function () {
                var a = {treeMap: 1, navigationBar: 0, stackedNavigation: 0};
                return {
                    set: function (c) {
                        var b = y(m.navigationBarHeightRatio, m.navigationBarHeight / z.effectiveHeight, .15),
                            ...
                            f = 2 * p("navigationBar"), b = W((6 + d + f) / z.effectiveHeight, b);
                        .1 > b ? b = .1 : .15 < b && (b = .15);
                        m.navigationBarHeightRatio = b;
                        a = c ? {treeMap: 1 - b, navigationBar: b, stackedNavigation: 0} :
                            {treeMap: 1, navigationBar: 0, stackedNavigation: 0}
                    }, get: function () {
                        return a
                    }
                }
            }(), v = 0, p = function (a) {
                var b = m.plotBorderThickness, c = m.navigationBarBorderThickness;
                return m.verticalPadding + ("navigationBar" === a ? c : b)
            }, u = function (a) {
                var b = z.effectiveWidth, c = z.effectiveHeight, d = p(a);
                a = x.get()[a];
                1 <= v && (v = 0);
                v += a;
                return {
