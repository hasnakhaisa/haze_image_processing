...
(function (E) {
    ...
    E.register("module", ["private", "modules.renderer.js-spark", function () {
        var b = this.hcLib, k = b.BLANKSTRING, d = b.pluck, a = b.pluckNumber, n = b.extend2, L = b.chartAPI,
            D = b.graphics.getLightColor, u = b.COMMASTRING, e = b.graphics.convertColor, C = b.getValidValue, N = Math,
            J = N.min, K = N.max, I = N.ceil, G = b.toRaphaelColor, Z = b.parseUnsafeString,
            S = b.graphics.getColumnColor, c = b.graphics.parseColor, F = b.COLOR_TRANSPARENT,
            g = b.POSITION_BOTTOM, H = b.POSITION_MIDDLE, B = b.POSITION_START, f = b.POSITION_END, r = b.HUNDREDSTRING,
            N = !b.CREDIT_REGEX.test(this.window.location.hostname), y = n({}, b.defaultGaugePaletteOptions),
            W = function () {
                var c = this.chart, v = c.config, l = v.dataLabelStyle, p = c.components.paper, g = v.valuepadding + 2,
                    m = this.graphics.dataLabelContainer || c.graphics.datalabelsGroup,
                    h = v.sparkValues || (v.sparkValues = {}), w = c.graphics,
                    w = w.sparkLabels || (w.sparkLabels = {}), q = c.linkedItems.smartLabel,
                    z = c.get("config", "animationObj"), c = z.transposeAnimDuration,
                ...
                m && m.attr({"clip-rect": null});
                t.y = .5 * v.canvasHeight + v.canvasTop;
                t.x = v.canvasLeft - g;
                if (h.openValue && h.openValue.label || w.openValue) w.openValue ? (w.openValue.attr({
                ...
                if (h.closeValue && h.closeValue.label ||
                    w.closeValue) w.closeValue ? (w.closeValue.attr({
                ...
                if (h.highLowValue && h.highLowValue.label || w.highValue) h.highLowValue && h.highLowValue.label === k && (na = A = x = k), q.useEllipsesOnOverflow(v.useEllipsesWhenOverflow), q.setStyle(l), w.startBraces ? c ? w.startBraces.animate(t, c, z) : w.startBraces.attr(t) : w.startBraces = p.text({
                    text: A,
                    x: t.x,
                    y: t.y,
                    "text-anchor": B,
                ...
                function () {
                    var c = this.chart, v = c.jsonData.chart, l = c.components, c = l.colorManager,
                        p = this.components.data, l = l.xAxis[0], g = a(v.periodlength, 0), m;
                    m = l.getLimit();
        ...
        L("sparkchartbase", {
            ...
            _setAxisLimits: function () {
                ...
                c[0] && c[0].setAxisConfig({numDivLines: 0});
            ...
            _spaceManager: function () {
                ...
                c = v.borderWidth;
                var g = v.canvasMarginTop, m = v.canvasMarginBottom, h = v.canvasMarginLeft, w = v.canvasMarginRight,
                    q = v.minCanvasHeight, z = v.minCanvasWidth, A = v.height, x = v.width, na = !1, ta = !1,
                    t = v.origCanvasTopMargin,
                ...
                this._allocateSpace({top: p, bottom: p, left: p, right: p});
                this._allocateSpace({bottom: l});
                ...
                w = w > x - v.canvasRight ?
                    w + v.canvasRight - x : 0;
                this._allocateSpace({top: g, bottom: m, left: h, right: w});
            ...
            _manageCaptionSpacing: function (c) {
                var v = this.config, l = this.components, p =
                        l.caption, g = l.subCaption, m = p.config, h = g.config, p = p.components, g = g.components,
                    w = this.jsonData.chart, q = this.linkedItems.smartLabel, z = Z(w.caption), A = Z(w.subcaption),
                    w = m.captionPadding = a(w.captionpadding, 2), x = l.chartMenuBar, x = x && x.getLogicalSpace(),
                    na = v.height - (x && x.height || 0), ta = 0, x = 0,
                    t = K(l.canvas.config.canvasBorderThickness, 0), pa = 0, l = {}, ma, R;
            ...
            _manageCaptionPosition: function () {
                var c = this.config, v = this.components, l = v.caption.config, v = v.subCaption.config,
                    p = l.captionPosition, a = K(l.width, v.width), m = c.borderWidth || 0, h = c.height,
                    w = (c.sparkValues || {}).openValueWidth || 0, q = l.captionPadding, z = l.captionSubCaptionGap;
                switch (p) {
                    case H:
        ...
        L("sparkcolumn", {
            ...
            _parseCanvasCosmetics: function () {
                ...
                v = p.shadow = a(g.showshadow, w, 0) && w ? {enabled: !0, opacity: c / 100} : 0;
            ...
            canvasBorderThickness: 1,
            singleseries: !1
        }, L.sparkchartbase, {showplotborder: 0, enablemousetracking: !0});
        E.register("component",
            ["dataset", "sparkcolumn", {
                _setConfigure: function (c) {
                    var p = this.chart, l = p.jsonData.chart, g = this.config, b = p.config, m = this.JSONData,
                        h = c || m.data, w = h && h.length, q = p.config.categories, q = q && q.length;
                    c = c && c.data.length || J(q, w);
                    var w = b.plothovereffect, z = p.components.colorManager, b = b.useroundedges, A, x, na, ta, t, pa,
                        ma, R, Aa, f, y, H, M, F, B, W, n;
                    ...
                    for (W = 0; W < c; W++) if (B = h[W], ta = p[W], ma = ta.config, A = z, x = f, ma.setValue == q && (A = y, x = M), ta.config.setValue == n && (A = H, x = F), ma.colorArr = A = S(A + u + g.plotgradientcolor, R, "0", "90", b, x, Aa, 0, 0), 0 !== w && A) {
                        x = na = void 0;
                        ...
                        ma.setRolloutAttr = {fill: G(A[0]), stroke: void 0, "stroke-width": void 0};
                        ma.setRolloverAttr = {fill: G(B[0]), stroke: void 0, "stroke-width": void 0}
                    }
                }, draw: function () {
        ...
        L("sparkwinloss", {
            ...
            applicableDSList: {sparkwinloss: !0},
            _setAxisLimits: function () {
                var c = this.components.yAxis;
                L.mscartesian._setAxisLimits.call(this);
                c[0] && c[0].setAxisRange({min: -1, max: 1})
            },
            _placeOpenCloseValues: function (c) {
                var p = this.config, l = this.linkedItems.smartLabel, g = p.dataLabelStyle, r = a(g.borderThickness, 0),
                    m = this.config.valuepadding +
            ...
            singleseries: !0
        }, L.sparkchartbase, {enablemousetracking: !0});
        E.register("component", ["dataset", "sparkwinloss", {
            _setConfigure: function (c, p) {
                var l = this.chart, g = l.config, f = this.config, m = this.JSONData, h = c || m.data,
                    w = h && h.length, q = l.config.categories, q = q && q.length, w = c && c.data.length || J(q, w),
                    q = l.jsonData.chart, z = l.components, A = z.colorManager, z = z.xAxis[0], x = g.showplotborder,
                    na = f.plotColor = A.getPlotColor(this.index || this.positionIndex), ta = b.parseUnsafeString,
                    t = d(q.plotfillcolor, A.getColor("plotFillColor")), pa = d(q.wincolor, A.getColor("winColor")),
                    ma = d(q.losscolor, A.getColor("lossColor")),
                    R = d(q.drawcolor, A.getColor("drawColor")), A = d(q.scorelesscolor, A.getColor("scorelessColor")),
                    Aa = q.winhovercolor, y = q.losshovercolor, H = q.drawhovercolor, u = q.scorelesshovercolor, M = 0,
                    F = 0, B = 0, W, n, e = g.plotborderthickness, S = g.isroundedges, Z = g.plothovereffect,
                    I = f.plotfillangle, U, V, L, la, N = f.plotBorderDashStyle, O, P, Y, T, qa, E, ja, ka, Fa, Ia,
                    ea = b.getDashStyle, va = this.components.data, ga = l.isBar, Ha = l.is3D, Ca,
                    Ja = f.maxValue || -Infinity, Na = f.minValue || Infinity, xa;
                ...
                f.maxValue = 1;
                f.minValue = -1;
                1 == a(q.showvalue, 1) && (l.config.sparkValues = {closeValue: {}}, l.config.sparkValues.closeValue.label = M +
                    "-" + F + (0 < B ? "-" + B : k))
            }, draw: function () {
                this.__base__.draw.call(this);
                p.call(this)
        ...
        E.register("component", ["datasetGroup", "SparkWinLoss", {
            manageSpace: function () {
                ...
                m[2] *= p;
                f.clip || r || (f.attr({"clip-rect": m}),
                    w.attr({}));
                h ? (!r && f.animate({"clip-rect": m}, h, "normal"), !r && w.animate({}, h, "normal")) : (!r && f.attr({"clip-rect": m}), !r && w.attr({}));
                this.preDrawCalculate();
                this.drawSumValueFlag = !0;
                for (p = 0; p < g; p++) for (r = c[p], f = r.length, this.manageClip = !0, r = 0; r < f; r++) m = c[p][r].dataSet, m.draw()
            }
        }, "column"]);
        L("sparkline", {
            standaloneInit: !0,
        ...
        }, L.sparkchartbase, {showvalues: 0, enablemousetracking: !0});
        E.register("component", ["dataset", "sparkline", {
            type: "sparkline", configure: function () {
                ...
                var g = this.chart, l = this.config, r = this.JSONData, f = g.jsonData.chart, r = p || r.data, m,
                    h = g.components.xAxis[0];
                p = p && p.data.length || h.getCategoryLen();
                var w = g.components.colorManager, g = g.config, q, z, h = c(d(f.opencolor, "0099FF")),
                    A = c(d(f.closecolor, "0099FF")), x = c(d(f.highcolor, "00CC00")), na = c(d(f.lowcolor, "CC0000")),
                    ta = c(d(f.anchorcolor, w.getColor("plotFillColor"))),
                    t = a(f.showopenanchor, f.drawanchors, f.showanchors, 1),
                    pa = a(f.showcloseanchor, f.drawanchors, f.showanchors, 1),
                    ma = a(f.showhighanchor, f.drawanchors, f.showanchors, 1),
                    R = a(f.showlowanchor, f.drawanchors, f.showanchors, 1), Aa = a(f.anchoralpha, 100),
                    b = a(f.drawanchors,
                        f.showanchors, 0) ? a(f.anchoralpha, 100) : 0, y = d(f.linecolor, w.getColor("plotFillColor")),
                    H, M, G, F, u, B;
                this.__base__._setConfigure.call(this);
                w = this.components.data;
                M = l.maxValue;
                G = l.minValue;
                l.shadow = {opacity: a(f.showshadow, 0) ? l.alpha / 100 : 0};
                m = w[0];
                q = m.config;
                ...
                pa = q.displayValue;
                for (z = 0; z < p; z++) m = w[z], q = m.config, m = r[z], F = a(m.anchorbgalpha,
    ...
    E.register("module", ["private", "modules.renderer.js-messagelogger", function () {
        var b = this.window, k = b.document, d = 8 === k.documentMode, a = this.hcLib, n = a.Raphael,
            L = a.componentDispose, D = a.pluckNumber, u = a.isIE, e = a.graphics.HEXtoRGB, C = a.graphics.convertColor,
            N = a.pluck, J = Math.min, K, I = {}, G = {
                display: "block",
                paddingLeft: "10px", paddingRight: "10px", "font-family": "Arial", "font-size": "11px"
            };
        I.literal = I.info = {title: '<span style="color: #005900">$titleVal$</span>', body: "<span>$msgVal$</span>"};
        I.link = {title: I.info.title, body: '<a href="$msgLinkVal$">$msgVal$</a>'};
        I.error = {
            title: '<span style="color: #CC0000">$titleVal$</span>',
            body: '<span style="color: #CC0000">$msgVal$</span>'
        };
        K = function (a, b) {
            var c = this.config = {}, d = (a.msgType || "").toLowerCase(), g = a.msgTitle, H = a.msgText,
                G = N(a.msgLink, H);
            c.totalHTML = "";
            this.graphics =
                {};
            this.linkedItems = {msgLogger: b};
            d = I[d] || I.literal;
        ...
        K.prototype = {
            draw: function () {
                var a = this.config, b = this.graphics, c, F = b.element, g = this.linkedItems.msgLogger,
                    H = g.graphics, B = H && H.log && H.log.element, H = H.logWrapper && H.logWrapper.element,
                    g = g.config;
                if (!F) {
                    F = b.element = k.createElement("span");
                    for (c in G) F.style[c] = G[c];
        ...
        E.register("component", ["logger", "message", {
            ...
            init: function (a) {
                ...
                var a = this.config || (this.config = {}), b = this.linkedItems.chart,
                    c = b.get && b.get("jsonData", "chart") || {},
                    d = a.usemessagelog = b.get("config", "usemessagelog");
                ...
                var d = this.config, c = this.components.messages, G = D(a.msgGoesToLog, d.messageGoesToLog),
                    g = D(a.msgGoesToJS, d.messageGoesToJS), H = b[d.messageJSHandler], u = N(a.msgId, ""),
                    f = N(a.msgTitle, ""), r = N(a.msgText, ""), y = N(a.msgType, "literal");
                ...
                for (b = 0; b < c; b += 1) a[b] && a[b].dispose && a[b].dispose();
                a.splice(0, c)
            }, isDrawn: function () {
                return !!this.graphics.container
            }, draw: function () {
                var a = this.config, b = this.components.messages, c;
                if (a.usemessagelog) for (this._createHTMLDialogue(), a.visible || this.hide(), c = b.length, a = 0; a < c; a += 1) b[a] && b[a].draw && b[a].draw(); else this.isDrawn() && (this.clearLog(), this.hide())
            }, _createHTMLDialogue: function () {
                var a = this, b = a.config, c = a.graphics, d = a.components, g = a.linkedItems.chart,
                    H = g.get("components", "paper"), G = g.get("linkedItems", "container"), f = g.get("config"),
                    r = f.width,
                    y = f.height, u = (g = f.style) && g.inCanvasStyle, p = b.messageLogShowTitle,
                    ia = b.messageLogIsCancelable, v = b.messageLogColor, l = b.messageLogTitle, e = d.paper, D = c.cg,
                    m = b.messageLogWPercent / 100 * r, h = b.messageLogHPercent / 100 * y, w = (r - m) / 2,
                    q = (y - h) / 2, z = m - 18 - 22, A = h - 18 - 22, x = w + m - 21, na = q + 3, g = c.container,
                    f = a.isDrawn() && f.animation && f.animation.transposeAnimDuration;
                g || (g = c.container = H.html("div", {fill: "transparent"}, {
                    fontSize: "10px",
                    lineHeight: "15px"
                }, G), c.veil = H.html("div", {id: "veil", fill: "000000", opacity: .1}, void 0, g).on("click",
                    function () {
                        ia && a.hide()
                    ...
                    x: 5,
                    y: 5
                }, {"font-weight": "bold"}, g)), c.dialog = H.html("div", {
                    id: "dialog",
                    strokeWidth: 1
                }, {
                    borderRadius: "5px",
                    ...
                    {id: "closeBtnContainer"}, {}, g), d.paper = e = new n("closeBtnContainer", 18, 18), e.setConfig("stroke-linecap", "round"), D = c.cg = e.group("closeGroup"), c.closeButton = e.symbol("closeIcon", 0, 0, 6, D).attr({
                    transform: "t9,9",
                    "stroke-width": 2,
                    stroke: C("999999"),
                    ishot: !0,
                    ...
                    a.hide()
                })), c.logWrapper = H.html("div", {id: "logWrapper"}, {overflow: "auto"}, c.dialog).on("scroll", function () {
                ...
                }), c.log = H.html("div", {id: "log", x: 0, y: 0}, {}, c.logWrapper));
                g.css({fontFamily: u.fontFamily});
                c.dialog.attr({fill: "ffffff", stroke: v});
                c.logBackground.attr({fill: v});
                d = {width: r, height: y};
                H = {x: w, y: q, width: m, height: h};
                G = {width: m, height: h};
                x = {width: 18, height: 18, x: x, y: na};
                m = {x: (m - z) / 2, y: (h - A) / 2, width: z, height: A};
    ...
    E.register("module", ["private", "modules.renderer.js-alertmanager", function () {
        ...
        E.register("component", ["manager", "alert", {
            pIndex: 1, init: function (b) {
                this.linkedItems = {chart: b}
            }, configure: function () {
                var b =
                        this.linkedItems.chart, a = b.get("jsonData", "alerts"), a = a && a.alert,
                    b = b.get("components", "numberFormatter"), n = this.config || (this.config = {}), k, D;
                if (a && a.length) for (n.alertArr = a, n = a.length, k = 0; k < n; k += 1) D = a[k], D.minvalue = b.getCleanValue(D.minvalue), D.maxvalue = b.getCleanValue(D.maxvalue); else n.alertArr = []
            }, processRTData: function (b) {
                var a = this.linkedItems.chart.get("components", "numberFormatter"), n, k, D, u, e, C, N;
                if (b && b.dataset && b.dataset.length) for (D = b.dataset.length, n = 0; n < D; n += 1) if (u = b.dataset[n], u.data &&
                u.data.length) for (e = u.data.length, k = 0; k < e; k += 1) N = (C = u.data[k]) && a.getCleanValue(C.value), null !== N && this._doAlert(a.getCleanValue(C.value))
            }, _doAlert: function (d) {
                var a = this.linkedItems.chart, n = this.config.alertArr, L = n.length, D, u, e;
                for (u = 0; u < L; u += 1) if (D = n[u], e = D.action && D.action.toLowerCase(), D.minvalue <= d && D.maxvalue >= d) {
                    if ("1" !== D.occuronce || !D.hasOccurred) {
                        ...
                        b.raiseEvent("AlertComplete",
                            {alertValue: d, alertMaxValue: D.maxvalue, alertMinValue: D.minvalue}, a.chartInstance)
                    }
                } else "showannotation" === e && "1" === D.state && a.hideAnnotation && a.hideAnnotation(D.param), D.state = "2"
            }
        }])
    }]);
        ...
        L = function (D) {
            ...
            e.rtStateChanged && (e.rtStateChanged = !1, J = (N = u.jsVars) && N.instanceAPI) && (K = J.config || {}, C = J.jsonData && J.jsonData.chart, J = K && K.chart || {}, I = 1E3 * a(K.updateInterval, K.refreshInterval), G = 1E3 * a(K.clearInterval, 0), Z = K.dataStreamURL, K = !!(K && K.realtimeEnabled && 0 < I && void 0 !== Z && "" !== Z && J), S = e._rtAjaxObj, c = function () {
                ...
                if (!u.disposed) {
                    ...
                    } else e._toRealtime = clearTimeout(e._toRealtime)
                }
    ...
    E.register("module", ["private", "modules.renderer.js-widgets", function () {
        ...
        Array.prototype.forEach || (Array.prototype.forEach = function (a, b) {
            ...
            for (u = 0; u < k;) u in e && (N = e[u], a.call(d, N, u, e)), u++
        });
        b.prototype = {
            numDecimals: function (b) {
                ...
                u *= Math.PI / 180;
                return {x: a + d * Math.cos(u), y: b - d * Math.sin(u)}
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-funnelpyramidbase", function () {
        var b = this, k = b.hcLib, d = k.pluck, a = k.pluckNumber, n = k.BLANKSTRING, L = k.preDefStr,
            D = L.showHoverEffectStr, u = k.graphics.convertColor, e = k.extend2, C = k.parseUnsafeString,
            N = k.graphics.getLightColor, J = k.COMMASTRING, K = k.ZEROSTRING, I = k.getValidValue, G = k.parseTooltext,
            Z = k.setLineHeight, S = Math, c = S.round, F = S.ceil, g = S.max, H = S.min, B = S.pow, f = S.sqrt,
            r = k.COMMASPACE, y = {},
            W = k.graphics.getDarkColor, p = L.colors.c000000, ia = L.configStr, v = L.animationObjStr,
            l = L.POSITION_START, ra = L.POSITION_MIDDLE, L = b.window,
            L = /msie/i.test(L.navigator.userAgent) && !L.opera, Da = k.regex.hexcode,
            m = "rgba(192,192,192," + (L ? .002 : 1E-6) + ")", h = k.regex.dropHash, w = k.HASHSTRING,
            q = k.toRaphaelColor, z = k.plotEventHandler, A = k.regex.startsRGBA, x = function (c) {
                var a = [], t;
                (function (c) {
                ...
                return {
                    get: function (t) {
                        ...
                        if (!isNaN(c) && 0 !== c) {
                            var t;
                            for (t = 0; 3 > t; t++) a[t] += parseInt(255 * c, 10), 0 > a[t] && (a[t] = 0), 255 < a[t] && (a[t] = 255)
                        }
                        return this
                    },
        ...
        E.register("component", ["dataset", "FunnelPyramidBase", {
            type: "funnelpyramidbase", pIndex: 2, customConfigFn: "_createDatasets", init: function (c) {
                ...
                var c = this.chart, q = c.components.colorManager, t = c.config, h = t.style, p = this.components,
                    b = this.conf || {}, g = this.JSONData.data ||
                    [], c = c.jsonData ? c.jsonData.chart : {}, l = this.utils(this), f = l.invokeHookFns,
                    l = l.copyProperties, m = k.setLineHeight, t = t.canvasHeight, x = this.configureSpecifics,
                    v = this.preDrawingHook, z = q.getColor("baseFontColor");
                ...
                b.emptyItems();
                for (c = 0; c < h.length; c += 1) t = h[c], t.pseudoPoint || (t.legendItemId = b.addItems(this, void 0, {
                    type: this.type,
                    label: t.label,
                    index: c,
                    enabled: a(q.includeinlegend, 1),
                    legendItemId: t.legendItemId
                }))
            }, getNormalizeDataSet: function (c, q) {
                var t = this.getPointInContext(), h = this.chart, b = this.conf, p = h.components,
                    g = p.numberFormatter, l = this.chart.linkedItems.smartLabel, p = p.colorManager, f, m = [], x, r,
                    v, z = 0, w, A, y, H, ia, F = 0, B, W, ra, D, S, P, Da = b.showPercentValues, Z = b.labelSepChar,
                    L = h.jsonData.chart, E = b.isSliced, ja, ka, Fa, Ia, ea = {apply: b.showShadow, opacity: 1}, va,
                    ga, Ha = b.plotBorderThickness;
                ...
                if (r) for (b.sumValue = z, r = g.dataLabels(z), w = x.length, l.useEllipsesOnOverflow(h.config.useEllipsesWhenOverflow), h = 0; h < w; h += 1) {
                    f = x[h];
                    Na = f.legendItemId;
                    A = f.cleanValue;
                    y = h ? x[h - 1].value : A;
                    ...
                    if (B = a(f.issliced, E)) F += 1, b.preSliced = B;
                    ...
                    Oa = f;
                    var Ka = {
                        labelfont: "fontFamily", labelfontcolor: "color",
                        labelfontsize: "fontSize", labelfontbold: "fontWeight", labelfontitalic: "fontStyle"
                    }, Ea = void 0, La = void 0;
                    for (La in Ka) La in Oa && (Ea = Ea || {}, Ea[Ka[La]] = Oa[La]);
                ...
                var a = this.chart.components.numberFormatter, t, q, b, h, p = {refreshedData: []};
                p.sumValue = p.countPoint = 0;
                p.highestValue = Number.NEGATIVE_INFINITY;
                t = 0;
                for (q = c.length; t < q; t++) b = c[t], b.vline || (b.cleanValue = h = Math.abs(a.getCleanValue(b.value,
                ...
                var t = this.chart, q = a(c.showhovereffect, this.conf.showHoverEffect), h = {enabled: q}, p = {}, f,
                    t = t.jsonData ? t.jsonData.chart : {};
                ...
                return {enabled: q, options: h, rolloverOptions: p}
                ...
                var c = this.getPointInContext(),
                    h = this.chart, t = h.config, b = h.components, q = b.caption.config.height || 0,
                    p = b.subCaption.config.height || 0, f = this.conf, l = f.showTooltip, x = f.slicingDistance, m;
                m = t.height - (t.marginTop + t.marginBottom);
                var r = t.width - (t.marginRight + t.marginLeft), v = this.components.data, z, w;
                z = f.blankSpace;
                var d = this.LABEL_PLACEMENT_ITERATOR_INDEX_START, c = c.upperRadiusFactor, A, y, G, H, ia, B,
                    u = h.linkedItems.smartLabel, W, e, ra, n, K, k, D;
                K = 0;
                var I, C = 0;
                ...
                b = f._tempSnap = {top3DSpace: 0, bottom3DSpace: 0, topLabelSpace: 0, rightLabelSpace: 0};
                m = Math.min(2 * (m - x), r);
                t.marginTop += x / 2;
                t.marginBottom += x / 2;
                x = v.length;
                ...
                if (!w) for (d = this.LABEL_PLACEMENT_ITERATOR_INDEX_START, x = v.length; d < x; d += 1) e = v[d], K = e.y, K = e.getModifiedCurrentValue && e.getModifiedCurrentValue(W) || K,
                ...
                var h, a, b;
                if (c && 0 !== c.length) for (h = 0, a = c.length; h < a; h++) b = c[h], b.connector && b.connector.hide(),
                ...
                function f(c, h) {
                    var a = (h || {}).alpha, a = void 0 === a ? b.post : {opacity: a};
                    c && (c.attr(b.pre), c.animateWith(m, x, a, l, r, p))
                }

                var g = this.chart.get(ia, v), l = g.duration, m = g.dummyObj, x = g.animObj, r = g.animType, z = !1, d,
                    w, A, y, G;
                q = q || function () {
                };
                a = a || [];
                d = 0;
                for (w = c.length; d < w; d++) if (A = c[d]) if (a.length) for (y = 0, G = a.length; y < G; y++) g = c[d][h][a[y]], f(g, A.point); else g =
                    A, f(g[h], A.point)
            }, drawIndividualDataLabel: function (c, h) {
                var b = this.conf, q = this.components.data, p = c.displayValue, f = c.plot, g = c.labelY, l = c.labelX,
                    m = c.style || {}, x = a(parseInt(m.fontSize, 10), b.baseFontSize), r = b.lineHeight, v = .3 * x,
                    z = .3 * r, d, w = b.connectorEndSwitchHistoryY, A = b.labelDistance, y = b.blankSpace,
                    x = b.streamLinedData;
                ...
                f.dataLabel.attr({"text-bound": [m.backgroundColor, m.borderColor, m.borderThickness, m.borderPadding, m.borderRadius, m.borderDash]})
            }, drawAllLabels: function () {
                var c = this.chart, b = c.graphics, h = this.graphics.plotItems, a = this.labelDrawingConfig,
                    q = b.datalabelsGroup, p = ["fontFamily", "fontSize", "fontWeight",
                        "fontStyle"], f = {}, c = c.components.paper, g = this.conf, l, m, x, r;
                r = 0;
                for (m = p.length; r < m; r++) x = p[r], x in this._chartLevelAttr && (f[x] = this._chartLevelAttr[x]);
                b.datalabelsGroup.css(f);
                for (r = a.length - 1; -1 < r; r--) b = a[r], f = b.point, m = !!f.link, x = f.y, b.args && b.css && (b.args.fill = b.css.color || b.css.fill), null !== x && void 0 !== x && f.shapeArgs ? ((l = h[r]) && l.dataLabel ? (l.dataLabel.removeCSS(p), l.dataLabel.attr(b.args).css(b.css)) : (f.plot.dataLabel = l.dataLabel = c.text(b.args, b.css, q), g.showLabelsAtCenter && 0 === r && g.streamLinedData ||
                ...
                }), m = b.actions, !f.doNotSlice && l.dataLabel.click(m.click, b.context), l.dataLabel.hover(m.hover[0], m.hover[1]), l.dataLabel.attr({transform: b.transform})) : h[r] ? (f.plot = h[r], m = f.plot.dataLabel, m.removeCSS(p), m && m.attr(b.args).css(b.css)) : f.plot = h[r] = {
                ...
                b = 0;
                for (h = c.length; b < h; b++) this.drawTracker(c[b])
            }, drawTracker: function (c) {
                var b = this.chart, h = b.components.paper, b = b.graphics.trackerGroup, a, q, f = +new Date, p, g;
                if (p = c.plot) q = p.trackerObj, p.graphic && (a = p.graphic.Shapeargs.silhuette, g = {
                    link: c.link,
                    value: c.y,
                    ...
                    path: a, isTracker: f,
                    fill: m, stroke: "none", transform: "t0," + (p._startTranslateY || 0), ishot: !0, cursor: p.cursor
                ...
                var a = this.conf, q = a.maxValue, p = a.is2d, g = a.x, m = this.graphics.plotItems || [],
                    x = this.chart, r = x.config, v = r.canvasTop, z = a.unitHeight, d = a.drawingRadius,
                    A = a.labelDistance, w = a.showLabelsAtCenter, y = a.isHollow, G = .3 * r.style.fontSize,
                    H = a.yScale, ia = a.blankSpace, W = a.lastRadius, F = x.linkedItems.smartLabel, B, u = 0, e, K,
                    n = c.length - 1, k = !1, D = 0, I, C, S = a.lineHeight, Da = .8 / r.effCanvasHeight,
                    Z = x.config.width - 2, J = a.streamLinedData;
                B = {
                    flag: !1, point: void 0, sLabel: void 0, setAll: function (c, b, a) {
                        this.flag = c;
                        this.point = b;
                        this.sLabel = a
                    }
                ...
                var N = {
                    point: void 0, sLabel: void 0, set: function (c, b) {
                        return function (a, h) {
                            var q, p;
                            a.dontPlot || (this.point && this.sLabel ? (q = c(this.point, this.sLabel), p = c(a, h), b(q, p) && (this.point = a, this.sLabel = h)) : (this.point = a, this.sLabel =
                                h))
                        }
                    }
                ...
                r = 0;
                for (B = c.length; r < B; r++) if (e = c[r]) e.x = r, m[r] && (e.isSliced = m[r].sliced || !!e.isSliced || !!a.isSliced), r ? (h && (k = !k), e.isSliced && (C = e.x, 1 < C && !Ca[C] && (Ca[C] = !0, a.noOfGap += 1), C < n && (Ca[C + 1] = !0, a.noOfGap +=
                ...
                this.findBestPosition.call(this, c, {
                    lTrimmedInfo: L, rTrimmedInfo: E,
                    lLargestLabel: ga, rLargestLabel: Ha
                })
            }, findBestPosition: function (c, b) {
                var a = this.conf, h = this.chart, q = h.config, p = 0, f = b.lTrimmedInfo, g = b.rTrimmedInfo,
                    l = b.lLargestLabel, r = b.rLargestLabel, m = h.linkedItems.smartLabel, x = 0,
                    v = a.streamLinedData, d = a.blankSpace, a = q.width - a.blankSpace;
                if (!f.flag || !g.flag) {
                    if (g.flag) {
                        if (!l.point) return;
                        p = g.sLabel;
                    ...
                    if (p) for (l = 0, r = c.length; l < r; l++) q = c[l], !l && v ? q.labelX += p : (q.alignmentSwitch ? (h = 0 > p ? m.getSmartText(q.oriText, q.pWidth, Number.POSITIVE_INFINITY, !0) : m.getSmartText(q.oriText, q.pWidth + p, Number.POSITIVE_INFINITY, !0), q.isLabelTruncated && (x = h.width - q.pWidth)) : h = 0 < p ? m.getSmartText(q.oriText, q.pWidth, Number.POSITIVE_INFINITY, !0) : m.getSmartText(q.oriText, q.pWidth - p, Number.POSITIVE_INFINITY, !0), q.virtualWidth = h.width, q.displayValue = h.text, q.labelX += p - x, q.shapeArgs && (q.shapeArgs.x +=
                        p), x = 0); else for (m.useEllipsesOnOverflow(q.useEllipsesWhenOverflow), l = 0, r = c.length; l < r; l++) q = c[l], 0 < (x = q.labelX + q.pWidth - a) && (q.lOverflow = x, q.labelX -= x, h.isLegendRight ? q.displayValue = m.getSmartText(q.oriText, q.pWidth - x, Number.POSITIVE_INFINITY, !0).text : (q.lOverflow = x, q.labelX -= x))
                }
            }, getPlotData: function (c) {
                var b = this.components.data[c], a = this.userData || (this.userData = []),
                    h = "y name color alpha borderColor borderWidth link label displayValue datasetIndex toolText".split(" "),
                    q;
                if (a[c]) c = a[c]; else {
                    c =
                        a[c] = {};
                    for (a = 0; a < h.length; a++) c[q = h[a]] = b[q];
                    c.value = c.y;
                    c.label = c.name;
                    delete c.y;
                    delete c.name
                ...
                var b = {
                    ...
                    if (l) A = {silhuette: ["M", r, a, "L", t, a, d, z, v, z, "Z"]}, m || (b = Math.round(b),
                        A.lighterHalf = ["M", r, a, "L", b, a, b, z, v, z, "Z"], A.darkerHalf = ["M", b, a, "L", t, a, d, z, b, z, "Z"]); else if (m) {
                        v = b;
                        d = a;
                        a = h || .01;
                        t = q || .01;
                        ...
                        h = -q;
                        z = {x: c(B(a, 2) * q / (w - d) * 100) / 100, y: c(100 * (B(r, 2) / (w - d) + d)) / 100};
                        q = {x: c(B(t, 2) * q / (w - p) * 100) / 100, y: c(100 * (B(g, 2) / (w - p) + p)) / 100};
                        x = {
                            x: c(B(a, 2) * h / (w - d) * 100) / 100, y: c(100 * (B(r,
                                2) / (w - d) + d)) / 100
                        };
                        w = {x: c(B(t, 2) * h / (w - p) * 100) / 100, y: c(100 * (B(g, 2) / (w - p) + p)) / 100};
                        z = {topLeft: x, bottomLeft: w, topRight: z, bottomRight: q};
                        for (A in z) if (isNaN(z[A].x) || isNaN(z[A].y)) z[A].x = "topLeft" === A || "bottomLeft" === A ? -a : a, z[A].y = "bottomRight" === A || "bottomLeft" === A ? p : d;
                        p = z.topLeft;
                        h = z.bottomLeft;
                        A = v + p.x;
                        w = v + z.topRight.x;
                        ...
                        A = t
                    } else A = h * g, w = q * g, p = H(5, h), h = H(2, 2 * A), q = H(2, h), g = q / g, A = {
                    ...
                    if ("string" === typeof c) r = b[c] ? this._3dAttr[c] : this._attr(c); else {
                        for (g in c) l = c[g], b[g] ? (d[g] = l, "fill" === g ? (l && l.linearGradient && l.stops && l.stops[0] && (l = l.stops[0][1]), A.test(l) ? (t = new x(l), m = t.get("hex"), t = 100 * t.get("a")) : l && l.FCcolor ? (m = l.FCcolor.color.split(J)[0], t = l.FCcolor.opacity.split(J)[0]) : Da.test(l) &&
                        ...
                        d.is2D ? (z && (m = p(d.x, d.y, d.R1, d.R2, d.h, d.r3dFactor, d.is2D), r.shadowElement.attr({path: m.silhuette}), d.isFunnel ? r.funnel2D.attr({path: m.silhuette}) : (r.lighterHalf.attr({path: m.lighterHalf}), r.darkerHalf.attr({path: m.darkerHalf}), r.borderElement.attr({path: m.silhuette}))), v &&
                        (d.isFunnel ? r.funnel2D.attr("fill", q(u(d.color, a(d.opacity, 100)))) : (!1 === d.use3DLighting ? m = t = d.color : (m = W(d.color, 80), t = N(d.color, 80)), r.lighterHalf.attr("fill", q(u(t, a(d.opacity, 100)))), r.darkerHalf.attr("fill", q(u(m, a(d.opacity, 100))))))) : (z && (m = p(d.x, d.y, d.R1, d.R2, d.h, d.r3dFactor, d.is2D), r.shadowElement.attr("path", m.silhuette), d.isFunnel ? (r.front.attr("path", m.front), r.back.attr("path", m.back), r.toptop && m.top && r.toptop.attr("path", m.top)) : (r.front.attr("path", m.front), r.toptop.attr("path", m.top),
                            ...
                            FCcolor: {
                                color: m + J + m + J + z + J + z, alpha: t +
                                J + t + J + t + J + t, ratio: "0,50,0,50", angle: 0
                            }
                    ...
                    return function (h, l, r) {
                        if (h = a[h]) return h.animateWith(p, f, {path: l}, q, g, c.postPlotCallback);
                        r = r || y;
                        c.postPlotCallback();
                ...
                return function (c, b, h, q, f, d, x,
                    ...
                    if (G) {
                        ...
                        c.is2D || q.isHollow !== c.isHollow) for (f = 0, w = h.length; f < w; f++) if (d = h[f], q = G[d]) delete G[d], q.remove()
                    } else G = void 0;
                    x = G || v.group(x, e);
                    x.toFront();
                    x.Shapeargs = b;
                    v = r(this, v, x, "easeIn");
                    x.shadowElement = v("shadowElement", b.silhuette, {fill: m, stroke: "none"});
                    ...
                    A ? z ? x.funnel2D = v("funnel2D", b.silhuette) : (x.back = v("back", b.back, {
                        ...
                        "stroke-width": 0,
                        stroke: "none"
                    }))) : z ? (x.lighterHalf = v("lighterHalf", b.lighterHalf, {"stroke-width": 0}), x.darkerHalf = v("darkerHalf", b.darkerHalf, {"stroke-width": 0}), x.borderElement = v("borderElement", b.silhuette, {
                        fill: m,
                        stroke: "none"
                    })) : (x.front = v("front", b.front, {"stroke-width": 0}), x.centerLight = v("centerLight", b.centerLight, {"stroke-width": 0}), x.centerLight1 = v("centerLight1", b.centerLight1, {"stroke-width": 0}), x.toptop = v("toptop", b.top, {"stroke-width": 0}), x.topLight = v("topLight", b.topLight, {"stroke-width": 0}), x.topLight1 =
                        v("topLight1", b.topLight1, {"stroke-width": 0}));
                    return x
                }
            }(), utils: function (c) {
                function b() {
                    ...
                    this.mergeWith = function (a) {
                        var h, q, p = c.slice(0);
                        if (!(a instanceof Array)) if (a instanceof b) a = a.getAll(); else return;
                        for (h in a) q = a[h], p[h] || (p[h] = q);
                        return p
                    };
                ...
                a.prototype.distribute = function (a) {
                    var h = c, q = !0, p = new b, f = new b, l = new b, g = new b, r = this.flags, m, d, t, x, v, z = 0,
                        A = h.components.data;
                    if (a) {
                        if (0 < A.length - this.distributionLength) for (d in this.nonDistributedMatrix) for (h =
                                                                                                                  this.nonDistributedMatrix[d], x = 1; x < h.length; x++) v = h[x], v.dontPlot = !0, v.displayValue = n
                    } else if (0 < A.length - 2 * this.distributionLength) for (d in this.nonDistributedMatrix) for (h = this.nonDistributedMatrix[d], x = 1; x < h.length - 1; x++) v = h[x], v.dontPlot = !0, v.displayValue = n;
                    if (A.length > this.distributionLength && !a) {
                        r.exhaustion = !0;
                        for (d in this.nonDistributedMatrix) for (h = this.nonDistributedMatrix[d], x = 0, a = h.length; x < a; x++) v = h[x], v.dontPlot ? q ? m = l : m = g : (q ? m = p : m = f, m.getEffectiveLength() > parseInt(d, 10) ? v.distributionFactor =
                        ...
                        for (t in this.nonDistributedMatrix) for (h = this.nonDistributedMatrix[t], x = 0, a = h.length; x < a; x++) v = h[x], v.dontPlot ? m = l : (m = p, m.getEffectiveLength() > parseInt(t, 10) ? v.distributionFactor = m.getEffectiveLength() - 1 - t : v.distributionFactor = 0), m.set(z++, v);
                        this.distributedMatrix = p.mergeWith(l)
                    }
                };
                a.prototype.getDistributedResult = function () {
                    ...
                    return {forceMatrix: this.forcePushObj, suggestion: a, matrix: b}
                };
                return {
                    DistributionMatrix: a, setContext: function (b) {
                        c = b
                        ...
                        p = 0;
                        for (f = h.length; p < f; p++) l = h[p], g = l[0], m = l[1], r = l[2], x = q(l[3]), l = l[4] || d, a[m] = r(b[g], x), l(a)
                        ...
                        var a, h, q = 0;
                        a = 0;
                        for (h = c.length; a < h; a++) q += parseFloat(c[a][b], 10);
                        return q
                    }
                }
                ...
                h = f.duration;
                var g = f.dummyObj, m = f.animObj, f = f.animType, r = p.conf, x = r.slicingDistance / 2, d = 0, A = 0,
                    w = p.graphics.plotItems, y = w.length, e, G, H, W, F;
                if (!r.sliceLock) for (r.sliceLock = 1, a && z.call(a.trackerObj, l, c, "dataplotclick"), q = a.sliced = void 0 !== q && null !== q ? q : !a.sliced, W = -x, F = function () {
                    return function () {
                        r.sliceLock = 0;
                        b.raiseEvent("SlicingEnd",
                            {slicedState: q, data: p.getPlotData(H)}, l.chartInstance)
                    }
                }, d = 0; d < y; d += 1) c = w[d], c !== a ? G = c.sliced = !1 : (G = !0, H = d), c.graphic && (e = c.dy, e = -e, q && (c.x < a.x ? (e += W, A += 1) : c.x == a.x ? A ? d == y - 1 && (e += .5 * x) : e += .5 * -x : e += x), c.graphic.attr({transform: "t0," + c.dy}), c.dy += e, e = {transform: "...t0," + e}, G && b.raiseEvent("SlicingStart", {
                    slicedState: !q,
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-funnel",
        function () {
            var b = this.hcLib, k = b.pluckNumber, d = b.BLANKSTRING, a = b.setLineHeight, n = b.plotEventHandler,
                L = b.schedular, D = b.preDefStr, u = D.configStr, e = D.animationObjStr, C = D.POSITION_START,
                N = D.POSITION_END, D = D.POSITION_MIDDLE,
                J = {right: N, left: C, middle: D, start: C, end: N, center: D, undefined: d, BLANK: d};
            E.register("component", ["dataset", "Funnel", {
                type: "funnel", LABEL_PLACEMENT_ITERATOR_INDEX_START: 1, configure: function () {
                    var b = this.chart, a = b.components.numberFormatter, d = this.utils(this).sortObjArrByKey,
                        e = b.jsonData ?
                            b.jsonData.chart : {}, b = this.JSONData.data, u, c, F;
                    if (this._checkValidData(b)) {
                        u = 0;
                        for (F = b.length; u < F; u++) (c = b[u]) && void 0 !== c.value && (c.value = a.getCleanValue(c.value, !0));
                    ...
                    var b = this.chart, a = this.conf, d = b.jsonData ? b.jsonData.chart : {},
                        e = this.utils(this).copyProperties;
                    ...
                    a.streamLinedData || b.splice(0, 0, {displayValue: d, y: a.sumValue})
                    ...
                    var a = this.conf, d = this.chart.components.numberFormatter, e, u, c, F = {},
                        g = a.streamLinedData, H = a.percentOfPrevious;
                    F.highestValue = Number.NEGATIVE_INFINITY;
                    F.refreshedData = [];
                    a = F.sumValue = F.countPoint = 0;
                    for (e = b.length; a < e; a++) u = b[a], u.vline || (u.cleanValue = c = Math.abs(d.getCleanValue(u.value,
                    ...
                    this._configure();
                    var a = this, d = a.chart, e = d.graphics, u = d.getJobList(), k = d.config, c = a.conf,
                        F = a.utils(a), g = a.trackerArgs = [], H = F.getSumValueOfObjArrByKey,
                        B = F.DistributionMatrix, f = a.calculatePositionCoordinate, r = k.marginTop,
                        y = k.marginBottom, F = a.components.data,
                        W, p, ia, v = e.datalabelsGroup, l = c.streamLinedData, ra, D = 2;
                    W = F.length;
                    var m = c.maxValue = F[0].y;
                    ia = c.minValue = F[W - 1].y;
                    var h = ra = 0, w = c.lineHeight, q = Math.floor, e = Math.min, z, A = a.graphics.plotItems, x = [],
                        na;
                    ...
                    if (c.sumValue && (a.preDrawingSpaceManagement(), a.hide(a.graphics.plotItems), a.rolloverResponseSetter = function (c, a) {
                    ...
                    }, k.canvasTop += k.marginTop - r, k.effCanvasHeight = ra = k.canvasHeight - (k.marginTop + k.marginBottom) + (r + y), k.effCanvasWidth = r = k.width - (k.marginLeft + k.marginRight), p = c.drawingRadius = r / D, c.x = p + k.canvasLeft, D = c.slicingDistance, y = D / 2, !(l && 2 > W))) {
                        ...
                        H.alternate = 2;
                        ia = new B(q(ra / w));
                        for (B = 0; B < W; B++) p = F[B], !l && 0 === B || !l && B === W - 1 ? ia.forcePush(p, B) : (ra = p.y * m, h += p.y * m, ra = h - ra + ra / 2, ra = q(ra / w), ia.push(p, ra));
                        l = ia.getDistributedResult();
                        F.length = 0;
                        if (void 0 === l.matrix[1]) [].push.apply(F, l.matrix[0]); else for (h = l.matrix[0], w = l.matrix[1], W = Math.max(h.length, w.length), B = 0; B < W; B++) ra = h[B], q = w[B], F.push(ra ? ra : q);
                        h = Object.keys(l.forceMatrix);
                        if (0 <
                            h.length) for (z in l.forceMatrix) [].splice.apply(F, [parseInt(z, 10), 0].concat(l.forceMatrix[z]));
                        switch (l.suggestion) {
                            case H["default"]:
                                f.call(a, F, !1);
                                break;
                        ...
                        if (k = c.noOfGap) c.perGapDistance = e(1.5 * y, D / k), c.distanceAvailed = y;
                        v.trackTooltip(!0);
                        B = F.length;
                        ...
                        for (; B--;) x.push(a.drawIndividualPlot(F[B],
                            B));
                    ...
                    var G = this.conf, k = this.graphics.plotItems, n = a.y, c = a.displayValue, F = G.isSliced,
                        g = a.labelAline, H = a.appliedStyle,
                        B = a.style, f = this.components.data, r = this.chart, y = r.graphics.trackerGroup,
                        W = r.components.paper, p = !!a.link, ia = G.distanceAvailed, v = r.components.legend,
                        r = r.get(u, e).duration, l = this.labelDrawingConfig, F = F ? 1 : a.isSliced, B = {
                            text: c,
                            ishot: !0,
                            direction: d,
                            cursor: p ? "pointer" : d,
                    ...
                    if (null !== n && void 0 !== n && a.shapeArgs) return (g = k[b]) ? (a.plot = g, a.shapeArgs.graphics = g.graphic, a.shapeArgs.animationDuration = r, g.graphic = this.pyramidFunnelShape(a.shapeArgs).attr({
                        fill: a.color,
                        "stroke-width": a.borderWidth, stroke: a.borderColor
                    ...
                    }, g.dy = 0, G.noOfGap && (ia && (g._startTranslateY = n = "t0," + ia, g.dy = g.distanceAvailed = ia, g.graphic.attr({transform: n}), k.transform = n), G.slicingGapPosition[a.x] && (G.distanceAvailed -= G.perGapDistance)), g && (g.point = a), g;
                    l[b] = {args: B, css: H, point: a}
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-pyramid", function () {
        var b = this, k = b.hcLib, d = k.BLANKSTRING, a = k.pluckNumber, n = k.preDefStr, L = n.configStr,
            D = n.animationObjStr, u = n.POSITION_START, e = n.POSITION_END, C = n.POSITION_MIDDLE, n = b.window,
            N = /msie/i.test(n.navigator.userAgent) && !n.opera ? .002 : 1E-6, J = k.plotEventHandler,
            K = k.schedular, I = {right: e, left: u, middle: C, start: u, end: e, center: C, undefined: d, BLANK: d};
        E.register("component", ["dataset", "Pyramid", {
            type: "pyramid", LABEL_PLACEMENT_ITERATOR_INDEX_START: 0, configure: function () {
                this._checkValidData(this.JSONData.data) && this.addLegend()
            }, configureSpecifics: function () {
                var b = this.chart, d = this.conf, e = b.jsonData ? b.jsonData.chart : {},
                    c = this.utils(this).copyProperties;
                ...
                this._configure();
                var a = this, b = a.chart, d = b.getJobList(), c = b.config, e = a.conf,
                    g = a.utils(a).DistributionMatrix, H = a.trackerArgs = [], u = a.calculatePositionCoordinate,
                    f = c.marginTop, r = c.marginBottom, y = a.components.data, W, p, ia,
                    v = b.graphics.datalabelsGroup, l, n = 2, D = y.length, m, h = m = 0, w = e.lineHeight,
                    q = Math.floor, z = Math.min, A, x = a.graphics.plotItems, na = [], ta;
                if (e.sumValue) {
                    a.labelDrawingConfig = a.labelDrawingConfig ||
                        [];
                    a.labelDrawingConfig.length = 0;
                    ...
                    A = new g(q(W / w));
                    g = 0;
                    for (W = D; g < W; g++) p = y[g], m = p.y * ia, h += p.y * ia, m = h - m + m / 2, m = q(m / w), A.push(p, m);
                    h = A.getDistributedResult();
                    y.length = 0;
                    if (void 0 === h.matrix[1]) [].push.apply(y, h.matrix[0]); else for (w = h.matrix[0], q = h.matrix[1], W = Math.max(w.length, q.length), g = 0; g < W; g++) m = w[g], ia = q[g], y.push(m ? m : ia);
                    switch (h.suggestion) {
                        case l["default"]:
                            u.call(a, y, !1);
                            break;
                    ...
                    if (c = e.noOfGap) e.perGapDistance = z(1.5 * r, n / c), e.distanceAvailed = r;
                    v.trackTooltip(!0);
                    g = y.length;
                    ...
                    for (; g--;) na.push(a.drawIndividualPlot(y[g], g));
                    ...
                    e.alreadyPlotted = !0
                                                      ...
                                                      d) {
                var e = this.conf, c = e.is2d, F = e.x, g = this.graphics.plotItems || [], H = this.chart, B = H.config,
                    f = B.canvasTop, r = e.unitHeight, y = e.labelDistance, W = e.showLabelsAtCenter,
                    p = .3 * B.style.fontSize, ia = e.yScale, v = e.blankSpace, l = e.lastRadius,
                    k = H.linkedItems.smartLabel, n, m, h, w = a.length - 1, q = !1, z = 0, A, x, na = e.lineHeight,
                    ta = 0;
                n = {
                    flag: !1, point: void 0, sLabel: void 0, setAll: function (a, c, b) {
                        this.flag = a;
                        this.point = c;
                        this.sLabel = b
                    }
                ...
                var t = {
                    point: void 0, sLabel: void 0, set: function (a, c) {
                        return function (b, h) {
                            var q, p;
                            b.dontPlot || (this.point &&
                            this.sLabel ? (q = a(this.point, this.sLabel), p = a(b, h), c(q, p) && (this.point = b, this.sLabel = h)) : (this.point = b, this.sLabel = h))
                        }
                    }
                ...
                B = 0;
                for (n = a.length; B < n; B++) if (m = a[B]) m.x = B, g[B] && (m.isSliced = g[B].sliced ||
                ...
                var e = this.conf, c = this.graphics.plotItems, u = a.y, g = a.displayValue, H = e.isSliced,
                    B = this.chart, f =
                        this.components.data, r = B.graphics.trackerGroup, y, W = B.components.paper, p = !!a.link,
                    ia = e.distanceAvailed;
                y = a.labelAline;
                var v = a.appliedStyle, l = a.style, k = B.components.legend, B = B.get(L, D).duration,
                    n = this.labelDrawingConfig, l = v && v.color || l && l.color || this._chartLevelAttr.color,
                    H = H ? 1 : a.isSliced, l = {
                        text: g,
                        ishot: !0,
                        direction: d,
                ...
                if (null !== u && void 0 !== u && a.shapeArgs) return (y = c[b]) ? (a.plot = y, a.shapeArgs.graphics = y.graphic, a.shapeArgs.animationDuration = B, y.graphic =
                ...
                }, y.dy = 0, e.noOfGap && (ia && (y._startTranslateY = u = "t0," + ia, y.dy = y.distanceAvailed = ia, y.graphic.attr({transform: u}), c.transform = u), e.slicingGapPosition[a.x] && (e.distanceAvailed -= e.perGapDistance)), y.point = a, y;
                n[b] = {args: l, css: v, point: a}
            }, getTooltipMacroStub: function (a) {
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-hlineargauge", function () {
        var b = this, k = b.hcLib, d = k.pluckNumber, a = k.pluck, n = k.COMMASTRING, L = k.extend2, D = k.BLANKSTRING,
            u = k.getValidValue, e = k.parseUnsafeString, C = k.parseTooltext,
            N = k.graphics.convertColor, J = k.POSITION_MIDDLE, K = k.preDefStr, I = K.configStr, G = K.animationObjStr,
            Z = K.POSITION_TOP, S = K.POSITION_BOTTOM, c = K.POSITION_MIDDLE, F = K.POSITION_START, K = K.POSITION_END,
            g = k.plotEventHandler, H = b.window, B = void 0 !== H.document.documentElement.ontouchstart, k = Math,
            f = k.max, r = k.min,
            y = {right: K, left: F, middle: c, start: F, end: K, center: c, undefined: D, BLANK: D};
        E.register("component", ["dataset", "hlineargauge", {
            pIndex: 2, customConfigFn: "_createDatasets", init: function (a) {
                this.pointerArr = a;
                this.idMap =
                    {};
                this.configure()
            }, configure: function () {
                var c = this.chart, b = c.jsonData, f = b.chart, g = c.components, l = g.numberFormatter,
                    g = g.colorManager, r = this.config || (this.config = {}),
                    y = this.components || (this.components = {}),
                    m = (b = b.pointers && b.pointers.pointer) && b.length || 1, h, w, q, z, A, x, H, B, t, pa, k,
                    c = c.config.style, F, G, I, K, J, M, L, E, fa, sa, ha, da, X, ba;
                ...
                r.startAngle = 90 * {top: 1, right: 0, left: 2, bottom: 3}[z ? Z : S];
                B = y.data || (y.data = []);
                for (z = 0; z < m; z++) w = B[z] || (y.data[z] = {}), w = w.config || (w.config = {}), h = b && b[z] || {}, w.itemValue = q = l.getCleanValue(h.value), w.formatedVal = x = l.dataLabels(q), w.setDisplayValue = H = u(e(h.displayvalue)), w.setToolText = A = u(e(h.tooltext)), w.id = a(h.id, "pointer_" + z), w.showHoverEffect = q = d(h.showhovereffect,
                    pa), w.showBorder = G = d(h.showborder, f.showplotborder, 1), w.borderWidth = E = G ? d(h.borderthickness, ba) : 0, (w.showValue = t = d(h.showvalue, r.showValue)) ? void 0 !== H ? (w.displayValue = H, w.isLabelString = !0) : w.displayValue = u(x, D) : w.displayValue = D, w.sides = H = d(h.sides, c), 3 > H && (w.sides = 3), w.radius = H = d(h.radius, f.pointerradius, 10), void 0 !== A ? (w.toolText = C(A, [1, 2], {formattedValue: x}, h, f), w.isTooltextString = !0) : w.toolText = null === x ? !1 : x, w.tempToolText = w.toolText, w.bgAlpha = t = d(h.alpha, h.bgalpha, f.pointerbgalpha, 100), w.bgColor =
                    ...
                    H + 2), h = !!d(h.showhoveranimation, f.showhoveranimation, 1), w.hoverAttr = fa = {}, w.outAttr = sa = {}, E !== M && (fa["stroke-width"] = M, sa["stroke-width"] = E), sa.fill = X, K = (E = /\{/.test(K)) ? g.parseColorMix(k, K)[0] : K, fa.fill = N(K, d(I, t)), M && (sa.stroke = F, E = /\{/.test(J), fa.stroke = N(E ? g.parseColorMix(A, J)[0] : J, d(G, x))), L && (h ? (ha = {r: L}, da = {r: H}) : (fa.r = L, sa.r = H))), w.rolloverProperties = {
                    enabled: q,
                    hoverAttr: fa,
                    hoverAnimAttr: ha,
                    outAttr: sa,
                ...
                var c = this.chart, b = this.components, f = c.config,
                    l = this.config, g = c.linkedItems.smartLabel, r = f.canvasWidth, m, h = f.dataLabelStyle,
                    e = f.style.trendStyle, q = c.jsonData, z = q.trendpoints && q.trendpoints.point,
                    A = d(parseInt(h.lineHeight, 10), 12), q = l.valuePadding, x = l.valueInsideGauge, y, H = y = 0,
                    t = 0, u = 0, B = 0, k = 0, n = 0, F = c.components.scale.config.spaceTaken, C = 0,
                    G = this.pointerArr && this.pointerArr.pointer && this.pointerArr.pointer.length,
                    I = l.pointerOnOpp, b = b.data;
                z && c._configueTrendPoints();
                g.useEllipsesOnOverflow(f.useEllipsesWhenOverflow);
                for (g.setStyle(h); C < G; C += 1) c =
                    b[C].config, y = q + c.radius * (3 >= c.sides ? .5 : c.sides % 2 ? 1.1 - 1 / c.sides : 1), u = Math.max(u, y), c.showValue && c.displayValue !== D && (c.isLabelString ? (m = g.getSmartText(c.displayValue, r, a - u), c.displayValue = m.text, m.tooltext && (c.originalText = m.tooltext)) : m = g.getOriSize(c.displayValue), c.displayValue === D && (m = {height: A})), y = m && 0 < m.height && !x ? m.height + y : y, y > a && (y = a), I ? (3 === l.axisPosition && (k = Math.max(F.bottom, k), y = Math.max(F.bottom, y)), H = Math.max(H, y)) : (1 === l.axisPosition && (n = Math.max(F.top, n), y = Math.max(F.top, y)), t = Math.max(y,
                    t)), l.align = J;
                ...
                if (z) {
                    ...
                    C = 0;
                    for (G = f.length; C < G; C += 1) (r = f[C]) && r.displayValue !== D && (e = q + .5 * r.markerRadius, B = Math.max(e, B), m = g.getOriSize(r.displayValue), 0 < m.height && (y = m.height + e), y > a && (y = a), r.showOnTop ? (1 === l.axisPosition && (n = Math.max(F.top, n), y = Math.max(F.top, y)), t = Math.max(t, y)) : (3 === l.axisPosition && (k = Math.max(F.bottom, k), y = Math.max(F.bottom, y)), H = Math.max(y, H)));
                    l.currentTrendPadding = B
                }
                return {top: t - n, bottom: H - k}
            }, draw: function (a, c) {
                var f =
                        this, r = f.idMap, l = f.chart, e = l.components, y = l.config, m = l.graphics,
                    h = m.datalabelsGroup, w = m.tempGroup, q = e.paper, z = e.scale,
                    A = f.pointerArr && f.pointerArr.pointer, e = y.canvasWidth, y = y.canvasHeight, x = f.config,
                    y = x.pointerOnOpp ? y : 0, u = x.showPointerShadow, k = x.showTooltip, t = z.config.axisRange.min,
                    n = z.config.axisRange.max, F = (n - t) / e, A = A && A.length || 1, C, K, Q, J;
                C = z.config.prevAxisMinMax || (z.config.prevAxisMinMax = {});
                var N = f.components.data, M = l.get(I, G), L = M.animObj, Z = M.dummyObj, fa = M.animType,
                    M = (a || M).duration, S = {
                        pageX: 0,
                        pageY: 0
                    }, ha = function (a, c) {
                        ...
                        if (!1 !== this.config.editMode) {
                            ...
                            b.raiseEvent("RealTimeUpdateComplete", {
                                ...
                                updateObject: {values: [a.updatedValStr]},
                                prevData: K.values,
                                source: "editMode",
                                url: null
                            }, h);
                        ...
                        var b = c[2],
                            h = B && (B && a.sourceEvent && a.sourceEvent.touches && a.sourceEvent.touches[0] || a) || S,
                            q = z.getLimit(), p = q.min, q = q.max, g = d(this.itemValue, p),
                            r = g - (this.dragStartX - b) * F, l = 0, m = [], x = [];
                        if (!1 !== this.editMode) {
                            this.drag = !0;
                            for (r < p ? r = p : r > q && (r = q); l < this.index; l += 1) m.push(D), x.push(D);
                            m.push({value: r});
                            x.push(r);
                            g !== r && f.updateData({data: m}, {duration: 0}, !0) && (this.updatedValStr = x.join("|"), this.dragStartX = b || a.pageX || h.pageX)
                        }
                ...
                if (C.min !== Q.min || C.max !== Q.max) l._drawAxis(), l._drawCanvas();
                C && (C.min = Q.min, C.max = Q.max);
                for (; A--;) C = N[A].config, U = N[A].graphics || (N[A].graphics = {}), aa = C.rolloverProperties || {}, J = x.startAngle, r[C.id] = {
                    index: A,
                    config: C
                }, J += .2, Q = u ? {opacity: Math.max(C.bgAlpha, C.borderAlpha) / 100} : !1, V = C.dataLink, E = {
                    index: A,
                    link: V,
                    value: C.itemValue,
                    displayValue: C.displayValue,
                    ...
                    oa), ba.attr({polypath: [C.sides, 0, y || 0, C.radius, J, 0, w]}), ba.show(), ba.drag(X, ha, da, C, C, N[A])), c || (ba.attr({
                    fill: C.fillColor,
                    ...
                    cursor: D,
                    _cursor: D
                }), C._startAngle = J, C.editMode ? (C.index = A, C.editMode = !0) : C.editMode = !1, ba.attr({ishot: !0})), k ? ba.tooltip(C.toolText, null, null, !0) : ba.tooltip(D), ba.animateWith(Z,
                    L, {
                ...
                var a = this.removeDataArr, c = a.length, b, f, r, g,
                    d = this.pool || (this.pool = {pointer: [], pointerValue: []});
                for (g = 0; g < c; g++) b = a[g].graphics, r = b.pointer, f = b.pointerValue, d.pointer[g] =
                ...
                var f = this.chart, r = f.config, g = f.components, l = g.numberFormatter, e = g.scale, H = g.paper,
                    m = f.graphics.datalabelsGroup, h = e.config.axisRange.min, w = e.config.axisRange.max,
                    q = this.config, e = q.textDirection, z = g.colorRange && g.colorRange.getColorRangeArr(h, w),
                    g = q.colorRangeStyle || {}, A = q.showvalue, x,
                    u = f.jsonData.trendpoints && f.jsonData.trendpoints.point, B = r.trendPointConfig,
                    t = r.canvasWidth, k = r.canvasHeight, n = r.marginRight, F = q.pointerOnOpp;
                x = q.valueInsideGauge;
                var C = q.showGaugeLabels, K = r.dataLabelStyle, J = f.get(I, G), L = J.animObj, M = J.dummyObj,
                    Z = J.animType, S = J.duration, fa, E, ha, da, X, ba, U, V;
                U = !1;
                var f = f.linkedItems.smartLabel, aa, la,
                    oa = d(parseInt(K.fontHeight, 10), parseInt(K.lineHeight, 10), 12),
                    O = q.currentValuePadding + .5 * oa, J = q.currentTrendPadding + .5 * oa, P,
                    q = q.currentTrendPadding;
                ha = {
                ...
                var Y = this.pointerArr && this.pointerArr.pointer, T, K = this.components, qa = K.data,
                    wa = K.dataLabels || (K.dataLabels = []), ja = K.trendLabels || (K.trendLabels = []);
                ...
                ha = this.getPointerLabelXY = function (a, b, q, f, r) {
                    ...
                    P = (a - h) * t / (w - h);
                    P + r > t + n && (P = t - r + n);
                    return {x: P, y: b, align: c}
                };
                da = function (a, c) {
                    return {
                        x: (a - h + (c - a) /
                            2) * t / (w - h), y: k / 2, width: (c - a) * t / (w - h), height: k
                    }
                };
                if (Y && Y.length) for (r = Y.length; r--;) if (T = qa[r].config, 0 !== A && T.displayValue !== D && (aa = f.getOriSize(T.displayValue), T.setWidth && (aa = f.getSmartText(T.displayValue, T.setWidth, aa.height, !0)), X = this.getPointerLabelXY(T.itemValue, x, F, aa.height / 2, aa.width / 2), T.isLabelString)) {
                    U = !1;
                    for (V = 1; !U;) {
                        ba = Y[r + V];
                        if (!ba) break;
                ...
                f.setStyle(g);
                if (z && C) for (r = 0, b = z.length; r < b; r += 1) A = wa[r] || (K.dataLabels[r] = {}), A = A.graphics || (A.graphics = {}), x = z[r], F = a(x.label, x.name), X = da(x.minvalue, x.maxvalue), aa = X.width - 4 > la && X.height - 4 > oa ? f.getSmartText(F, X.width - 4, X.height - 4) : f.getSmartText(F, X.width, X.height), F = {
                    "text-anchor": c,
                    "vertical-align": c,
                    x: X.x,
                    y: X.y,
                    ...
                    x = A.value = H.text(F, g, m); else r = 0;
                for (; A = wa && wa[r++];) A.graphics.value.hide();
                if (u) for (r = 0, b = B.length; r < b; r += 1) {
                    ...
                    0;
                for (; z = ja && ja[r++];) z.graphics.value.hide()
            }, drawPointerValues: function (a) {
                var c = this.chart, b = c.graphics.datalabelsGroup, f = c.components.paper, r = this.components.data,
                    g = this.config, d = g.pointerOnOpp, m = g.valueInsideGauge, g = g.textDirection, h,
                    e = c.linkedItems.smartLabel, q = this.pointerArr && this.pointerArr.pointer,
                    z = c.config.dataLabelStyle, q = q && q.length, A, x = c.get(I, G), H = x.animObj, u = x.dummyObj,
                    t = x.animType;
                a = (a || x).duration;
                var B = c.config, c = B.marginLeft, x = {
                    fontFamily: z.fontFamily, fontSize: z.fontSize, lineHeight: z.lineHeight,
                    fontWeight: z.fontWeight, fontStyle: z.fontStyle
                }, k, n, F = this.pool, C;
                for (e.useEllipsesOnOverflow(B.useEllipsesWhenOverflow); q--;) C = !1, B = r[q].graphics, A = r[q].config, k = A.displayValue, h = A.showValue, 0 !== h && k !== D ? (n = e.getOriSize(k), h = n.width / 2, n = this.getPointerLabelXY(A.itemValue, m, d, n.height / 2, h), k = {
                ...
                var a = this.config, c = this.chart.jsonData,
                    b = this.components.data || this.pointerArr && this.pointerArr.pointer || c.dials && c.dials.dial,
                    c = (c = c.colorrange) && c.color, g = b && b.length, d, e, y, m = a.upperLimit, h = a.lowerLimit,
                    w, q,
                    z = 0;
                q = 0;
                var A = void 0 === a.gaugeMax ? -Infinity : a.gaugeMax,
                    x = void 0 === a.gaugeMin ? Infinity : a.gaugeMin;
                for (d = 0; d < g; d++) w = b[d].value || b[d].config && b[d].config.itemValue, w !== D && void 0 !== w && (y = A = f(A, Number(w)), e = x = r(x, Number(w)));
                g = c && c.length;
                for (d = 0; d < g; d++) q = Number(c[d].maxvalue), b = Number(c[d].minvalue), m && q > m && (q = m), h && b < h && (b = h), z = A < q ? A : !1, A = f(A, q), q = x > b ? x : !1, x = r(x, b);
                a.gaugeMax = A;
                a.gaugeMin = x;
                !1 !== z && (a.gaugeMax = z);
                !1 !== q && (a.gaugeMin = q);
                return {forceMin: e !== x, forceMax: y !== A, max: A, min: x}
            }, updateData: function (a,
                                     c, b) {
                if (a === this.lastUpdatedObj) return !1;
                var f = this.chart, r = f.components.numberFormatter, g = this.components.data, d,
                    m = this.components.data, m = m && m.length || 0, h, y, q = null, z = [], A, x, H;
                a = a.data;
                x = c || f.get(I, G);
                if (m) {
                    for (; m--;) if (h = {}, H = {}, y = g[m].config, d = a[m]) A = d.value, f = d.tooltext, c = d.label, d = d.showlabel, void 0 !== A && A !== D ? (h.value = H.value = A, q = H.displayvalue = H.tooltext = r.dataLabels(H.value), H.hasNewData = !0) : H.value = y.formatedVal, c && (H.displayvalue = c, H.hasNewData = !0), "0" == d && (H.displayvalue = D, H.hasNewData =
                        !0), f && (f = u(e(f)), H.hasNewData = !0), H.hasNewData && (z[m] = H, L(y, {
                        itemValue: H.value,
                        displayValue: "0" !== d ? H.displayvalue || D : D,
                        toolText: void 0 !== f ? C(f, [1, 2], {formattedValue: q}, h) : y.setToolText ? y.tempToolText : q
                    }));
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-bullet", function () {
        var b = this.hcLib, k = b.preDefStr, d = b.BLANKSTRING, a = b.pluck, n = b.getValidValue, L = b.COMMASTRING,
            D = b.plotEventHandler, u = k.showHoverEffectStr, e =
                k.configStr, C = k.animationObjStr, N = b.getColorCodeString, J = k.ROUND, K = k.miterStr,
            I = b.HUNDREDSTRING, G = Math, Z = G.max, S = G.min, c = G.abs, F = k.colors.FFFFFF,
            g = b.graphics.convertColor, H = b.toRaphaelColor, B = b.COMMASPACE, f = b.getFirstValue,
            r = b.graphics.getDarkColor, y = this.window, G = void 0 !== y.document.documentElement.ontouchstart,
            W = b.CLICK_THRESHOLD_PIXELS,
            p = "rgba(192,192,192," + (/msie/i.test(y.navigator.userAgent) && !y.opera ? .002 : 1E-6) + ")",
            ia = {"true": void 0, "false": "crisp"}, v = k.POSITION_START, l = k.POSITION_TOP, ra = k.POSITION_MIDDLE,
        ...
        E.register("component", ["dataset", "bullet", {
            init: function (a) {
                ...
                var c = this.chart, f = this.config, r = this.JSONData,
                    d = c.jsonData.chart, l = c.components.colorManager, m, p = f.plotColor = l.getColor(Da),
                    e = h(r.dashed, d.plotborderdashed);
                ...
                var l = this.chart, m = this.config, p = this.JSONData, e = c || p.data, v = e && e.length,
                    t = l.config.categories, t = t && t.length, v = c && c.data.length || S(t, v), y = l.jsonData.chart,
                    t = l.components.colorManager, w = m.showplotborder, u = m.showPlotBorderOnHover, k = m.plotColor,
                    F = b.parseUnsafeString, C = F(a(y.tooltipsepchar, B)), W = h(y.seriesnameintooltip,
                    1), D = b.parseTooltext, G, I, ia, K, ra, J, N = m.plotBorderThickness, L = m.isRoundEdges,
                    U = m.showHoverEffect, V = m.plotFillAngle, Da, E = m.plotBorderAlpha, oa,
                    O = m.plotBorderDashStyle, P, Y, T, qa, wa, ja, ka, Fa, Ia, ea, va, ga, Ha = b.getDashStyle,
                    Ca = this.components.data, Ja = l.isBar, Na = l.is3D, xa = -Infinity, ca = Infinity,
                    Ga = l.components.numberFormatter, Oa = function (a) {
                        m.showTooltip ? null === G ? a = !1 : void 0 !== a ? (K = [1, 2, 3, 4, 5, 6, 7, 26, 27], I = {
                            formattedValue: G,
                            targetValue: T.target,
                            targetDataValue: T.toolTipValueTarget
                        }, a = D(a, K, I, P, y, p)) : (W && (ia =
                            f(p && p.seriesname)), a = ia ? ia + C : d, a += T.label ? T.label + C : d) : a = !1;
                        return a
                    };
                Ca || (Ca = this.components.data = []);
                for (l = 0; l < v; l++) P = c ? c && c.data[l] : e[l], T = (k = Ca[l]) && k.config, k || (k = Ca[l] = {}), k.config || (T = Ca[l].config = {}), T.showValue = h(P.showvalue, m.showValues), T.valuePadding = h(y.valuepadding, 2), T.setValue = Y = Ga.getCleanValue(P.value), T.target = k = Ga.getCleanValue(P.target), T.setLink = a(P.link), T.toolTipValue = oa = Ga.dataLabels(Y), T.toolTipValueTarget = Ga.dataLabels(k), T.setDisplayValue = qa = F(P.displayvalue), T.displayValue =
                    ...
                    fill: Na ? [H(qa[0]), !m.use3DLighting] :
                        H(qa[0]), stroke: H(qa[1]), "stroke-width": u ? Da || 1 : Da, "stroke-dasharray": ea
                ...
                var c = this.config, b = this.components.data, f = this.chart, r = f.components.caption.config,
                    g = f.config, f = f.linkedItems.smartLabel, m = g.dataLabelStyle,
                    l = h(parseInt(m.lineHeight, 10), 12), p = c.valuePadding,
                    e = 0, y = 0, b = (b = b[y]) && b.config;
                f.useEllipsesOnOverflow(g.useEllipsesWhenOverflow);
                for (f.setStyle(m); 1 > y; y += 1) c.showValue && (g = f.getOriSize(b.toolTipValue), b.toolTipValue === d && (g = {height: l}), 0 < g.height && (e = g.height + p), e > a && (e = a));
                r.widgetValueHeight = e;
                c.heightUsed = e;
                return {top: 0, bottom: e}
            }, _manageSpaceHorizontal: function (a) {
                var c = this.config, b = this.components.data, f = this.chart, r = f.config,
                    f = f.linkedItems.smartLabel, g = r.dataLabelStyle, m = h(parseInt(g.lineHeight, 10), 12),
                    l = c.valuePadding, p = 0, e = 0, b = (b = b[e]) &&
                    b.config;
                f.useEllipsesOnOverflow(r.useEllipsesWhenOverflow);
                for (f.setStyle(g); 1 > e; e += 1) b && b.displayValue !== d && void 0 !== b.displayValue && c.showValue && (r = f.getOriSize(b.displayValue), b.displayValue === d && (r = {height: m}), 0 < r.height && (p = r.width + l + 2), p > a && (p = a));
                c.widthUsed = p;
                return {top: 0, right: p}
            }, updateData: function (a, c, b) {
                var f = this.config, h = f.maxValue, d = f.prevMin, r = this.chart, g = this.groupManager || this,
                    m = r.components.scale;
                this._setConfigure(a, c);
                this.setMaxMin();
                if (f.maxValue !== h || f.minValue !== d) this.maxminFlag =
                    !0;
                b && (r._setAxisLimits(), m.draw(), g.draw())
            }, setMaxMin: function () {
                var a = this.components.data, c = this.config, b, f, h = a.length, d = -Infinity, r = Infinity;
                for (b = 0; b < h; b++) a[b] && (f = a[b].config, d = Z(d, f.setValue, f.target), r = S(r, f.setValue, f.target));
                c.maxValue = d;
                c.minValue = r
            }, draw: function () {
                var c = this.chart, f = c.components, d = c.jsonData.chart, r = c.config, m = f.paper, l = f.canvas,
                    p = l.graphics, y = l.config, l = p.canvasElement, v = r.canvasLeft, w = r.canvasRight,
                    u = r.canvasTop, k = r.canvasBottom, B = r.canvasWidth, n = r.canvasHeight,
                    F = c.graphics.datasetGroup, W, D = f.scale, G = D.getLimit().min, D = D.getLimit().max,
                    I = c.isHorizontal, ia = c.get(e, C), K = ia.animType, ra = ia.animObj, J = ia.dummyObj,
                    ia = ia.duration, Da, V, E = c.components.colorManager, S, oa, O, P, Y, T, qa, wa;
                Da = I ? 270 : 180;
                ...
                y = f && f.length;
                if (l) for (p = l.colorRangeElems.length; p > y; --p) l.colorRangeElems[p - 1].hide(), l.colorRangeElems[p - 1].shadow({opacity: 0}); else p.canvasElement = l =
                    {}, l.colorRangeElems = [];
                for (p = 0; p < y; p += 1) P = f[p], Y = P.minvalue - G, T = P.maxvalue - G, Y = I ? I ? {
                    x: v + Y * B / (D - G),
                    y: u,
                    width: (T - Y) * B / (D - G),
                    height: n
                    ...
                    x: Y.x, y: Y.y, width: Y.width, height: Y.height, r: 0, "stroke-width": d,
                    stroke: T, fill: H({FCcolor: {color: qa.toString(), ratio: c, alpha: wa, angle: Da}})
                }, l.colorRangeElems[p] ? (l.colorRangeElems[p].show(), W = {
                    "stroke-width": d,
                    stroke: T,
                    fill: H({FCcolor: {color: qa.toString(), ratio: c, alpha: wa, angle: Da}})
                ...
                var f = this, h = f.JSONData, r = f.chart.jsonData.chart, g = f.config, y = f.chart.config.categories,
                    k = h.data, t = y && y.length, B = k && k.length, n, F, y = f.visible, W = f.chart,
                    G = W.getJobList(), I = W.config, J = I.canvasLeft, M = I.canvasRight, N = I.canvasTop,
                    L = I.canvasBottom, Da = I.canvasHeight, E = I.canvasWidth, Z = W.components.paper,
                    da = W.components.scale, X = W.graphics.datasetGroup, ba, U, V, aa = W.graphics,
                    la = b.parseUnsafeString, oa = b.getValidValue, O = b.Raphael,
                    P = g.showTooltip, Y = W.get(e, C), T = Y.animType, qa = Y.animObj, wa = Y.dummyObj, Y = Y.duration,
                    ja, ka, Fa, Ia = f.components.data, ea, va, ga, Ha = da.max, Ca = da.min,
                    Ha = da.yBasePos = da.getAxisPosition(0 >= Ha && 0 > Ca ? Ha : 0 < Ha && 0 <= Ca ? Ca : 0),
                    Ja = Ca = 0, Na = g.showShadow, xa = g.plotBorderThickness, ca = g.plotRadius,
                    Ga = f.graphics.container, Oa = f.graphics.trackerContainer, Ka = f.graphics.targetContainer;
                ga = f.graphics.trackerTargetContainer;
                var Ea = f.graphics.dataLabelContainer, La = f.graphics.shadowContainer,
                    Ma = f.graphics.shadowTargetContainer;
                V = aa.trackerGroup;
                var Qa, Ra, Sa = !0, Pa = !1;
                Fa = aa.datalabelsGroup;
                var aa = W.config.dataLabelStyle, Wa = g.heightUsed, Ta = g.lowerLimit, Xa, Ya = g.showHoverEffect,
                    cb = function (a) {
                        D.call(this, W, a)
                    }, db = function (a) {
                        return function (c) {
                ...
                S(t, B);
                for (t = 0; 1 > t; t++) if (n = k[t], ga = (B = Ia[t]) && B.config, Xa = B.trackerConfig = {}, ea = ga.setValue, 0 > ea && (Pa = !0), va = ga.setLink, Qa = ga.colorArr, Ma = !1, B.graphics || (Ia[t].graphics = {}), X = ga.displayValue, oa(la(a(n.tooltext, h.plottooltext, r.plottooltext))), W.isHorizontal) {
                    ...
                    Xa.eventArgs = {link: va, value: ea, displayValue: X, toolText: Fa ? Fa : ""};
                    Y || (Ja = ja);
                    F = {
                        x: ba,
                        y: U,
                    ...
                    if (null !== ea) {
                        if (B.graphics.element ?
                            (B.graphics.element.show(), F = {
                                ...
                                "stroke-linejoin": K,
                                visibility: y
                            }), ga.elemCreated = !1) : (ea = B.graphics.element = Z.rect(F, Ga), ea.animateWith(wa, qa, {width: ja || 1}, Y, T), Y && (Sa = !1), ga.elemCreated = !0), ea.shadow({opacity: Na}, La).data("BBox", V), va || P) ka < m && (U -= (m - ka) / 2, ka = m), Xa.attr = {
                            x: ba, y: U, width: ja, height: ka, r: ca, cursor: va ? "pointer" :
                                d, stroke: p, "stroke-width": xa, fill: p, ishot: !0, visibility: y
                        }
                    } else B.graphics.element && B.graphics.element.hide(), B.graphics.hotElement && B.graphics.hotElement.hide();
                    ga.target ? (oa(la(a(n.tooltext, h.targettooltext, r.targettooltext))), Fa = ga.toolTextTarget === d ? ga.toolTipValueTarget : ga.toolTextTarget, ka = g.targetFillPercent / 100 * Da, n = ba = da.getAxisPosition(ga.target), U = (N + L) / 2 - ka / 2, ka = U + ka, n = ["M", n, U, "L", ba, ka], F = {
                        ...
                        ishot: !0,
                        "shape-rendering": ia[!1]
                    }, ea.animateWith(wa, qa, F, Y, T)) : (ea = B.graphics.targetElement = Z.path(n, Ka).attr(F), Ma = !0), Ma && ea.click(cb).hover(db(ea), eb(ea)), ea.shadow({opacity: Na}, La).data("BBox", V).data("eventArgs", void 0).data("groupId", void 0).data(u, Ya).data("setRolloverAttr", ga.tagetHoverAttr).data("setRolloutAttr",
                    ...
                    X !== d && void 0 !== X && g.showValue ? (F = {
                        ...
                        direction: ga.textDirection,
                        "text-bound": [aa.backgroundColor, aa.borderColor, aa.borderThickness, aa.borderPadding, aa.borderRadius, aa.borderDash]
                    })) : B.graphics.label = Z.text(F, Ea), X = B.graphics.label.getBBox(), 0 > X.x + I.marginLeft && (X = X.width - I.marginLeft, I.width < X && (X = I.width - I.marginLeft), F = {x: X / 2}, B.graphics.label.animateWith(wa, qa, F, Y, T))) : B.graphics.label && B.graphics.label.hide() && B.graphics.label.attr({"text-bound": []})
                } else {
                    V =
                    ...
                    Ra = ga.plotBorderDashStyle;
                    Xa.eventArgs = {
                        link: va, value: ea, displayValue: X,
                        toolText: Fa
                    };
                    Y || (Ha = U, Ca = ka);
                    F = {
                    ...
                    if (null !== ea) {
                        if (B.graphics.element ? (B.graphics.element.show(), F = {
                            ...
                            y: U,
                            height: ka || 1
                        }, Y, T), Y && (Sa = !1), ga.elemCreated = !0), ea.shadow({opacity: Na}, La).data("BBox", V), va || P) ka < m && (U -= (m - ka) / 2, ka = m), Xa.attr = {
                            x: ba,
                            y: U,
                            width: ja,
                            height: ka,
                    ...
                    d ? ga.toolTipValueTarget : ga.toolTextTarget, ka = g.targetFillPercent / 100 * E, n = (J + M) / 2 - ka / 2, ba = n + ka, U = ka = da.getAxisPosition(ga.target), n = ["M", n, U, "L", ba, ka], F = {
                        ...
                        (ea = B.graphics.targetElement = Z.path(n, Ka).attr(F), Ma = !0), Ma && ea.click(cb).hover(db(ea), eb(ea)), ea.shadow({opacity: Na}, La).data("BBox", V).data("eventArgs", void 0).data("groupId", void 0).data(u, Ya).data("setRolloverAttr", ga.tagetHoverAttr).data("setRolloutAttr", ga.targetOutAttr), P ? ea.tooltip(Fa) : ea.tooltip(!1)) : B.graphics.targetElement && B.graphics.targetElement.hide();
                    Ma = parseInt(aa.lineHeight, 10);
                    ...
                    X !== d && void 0 !== X && g.showValue ? (F = {
                        ...
                        text: X, "text-anchor": ra, "vertical-align": ra, fill: aa.color, direction: ga.textDirection,
                        "text-bound": [aa.backgroundColor, aa.borderColor, aa.borderThickness, aa.borderPadding, aa.borderRadius, aa.borderDash]
                    })) : B.graphics.label = Z.text(F, Ea), X = B.graphics.label.getBBox(), 0 > X.x + I.marginLeft && (X = X.width - I.marginLeft, I.width < X && (X = I.width - I.marginLeft), F = {x: X / 2}, B.graphics.label.animateWith(wa, qa, F, Y, T))) : B.graphics.label && B.graphics.label.hide() && B.graphics.label.attr({"text-bound": []})
                }
                ...
                var a =
                        this.chart, c = this.components, b = c.pool, f = a.config.plothovereffect, h = a.components.paper,
                    d = this.graphics.trackerContainer, r, g, l, p, m, e, y = function (c) {
                        D.call(this, a, c)
                    }, v = function (c) {
                        return function (b) {
                            var f = this.getData();
                ...
                for (var a = this.config, c = this.pointerArr && this.pointerArr.pointer, b = this.chart.jsonData.colorrange, b = b && b.color, c = c && c.length, f = a.upperLimit, h = a.lowerLimit, r, d, g = a.maxValue, l = a.minValue, c = b && b.length, a = 0; a < c; a++) r = Number(b[a].maxvalue), d = Number(b[a].minvalue), f && r > f && (r = f), h && d < h && (d = h), g = Z(g, r), l = S(l, d);
                return {forceMin: !0, forceMax: !0, max: g, min: l}
            }
        }, "hlineargauge"])
    }]);
    E.register("module", ["private", "modules.renderer.js-dataset-led",
        function () {
            var b = this.hcLib, k = b.BLANKSTRING, d = b.pluck, a = b.pluckNumber, n = b.plotEventHandler,
                L = b.getColorCodeString, D = b.graphics.getDarkColor, u = b.graphics.getLightColor,
                e = b.graphics.convertColor, C = b.preDefStr, N = C.colors.c000000, J = C.configStr,
                K = C.animationObjStr, I = C.showHoverEffectStr, G = C.POSITION_MIDDLE, Z = b.COMMASTRING,
                C = this.window,
                S = "rgba(192,192,192," + (/msie/i.test(C.navigator.userAgent) && !C.opera ? .002 : 1E-6) + ")",
                C = Math, c = C.round, F = C.max, g = b.regex.dropHash, H = b.HASHSTRING, B = b.toRaphaelColor,
                f = b.HUNDREDSTRING;
            E.register("component", ["dataset", "led", {
                init: function (c) {
                    ...
                    var r = this.chart, y = this.config, k = r.components, p = r.jsonData.chart, C = r.config,
                        v = r.graphics, l = k.paper, G = k.canvas, Da = G.graphics, m = G.config, h = r.get(J, K),
                        G = h.animType, w = h.animObj,
                        q = h.dummyObj, h = h.duration, z = Da.canvasBorderElement, A = Da.canvasElement,
                        x = Da.canvasElementPath, na = Da.canvasHotElement, ta = C.canvasLeft, t = C.canvasRight,
                        pa = C.canvasTop, ma = C.canvasBottom, R = C.canvasWidth, E = C.canvasHeight,
                        v = v.datasetGroup, Q = k.scale, ya = Q.getLimit().min, ua = Q.getLimit().max,
                        M = a(r.jsonData.chart.reverseaxis, r.isAxisReverse), Ba = r.isHorizontal,
                        za = function (a, c) {
                            if (M && !Ba) return {
                                x: ta,
                                y: pa + a * E / (ua - ya),
                            ...
                            if (M || Ba) {
                                if (M && Ba) return {
                                    x: ta + (R - c * R / (ua - ya)), y: pa, width: (c - a) *
                                    R / (ua - ya), height: E
                                };
                                if (!M && Ba) return {
                                    x: ta + a * R / (ua - ya),
                        ...
                        }, fa, sa, ha, da = r.components.colorManager, X, ba, U, V, aa, la, oa, O, P, Y, T, qa, wa, ja,
                        ka, Fa, Ia, ea, va, ga, Ha, Ca, Ja;
                    ...
                    var Na, xa, ca, Ga = y.showHoverEffect, Oa = function (a) {
                            ...
                            return function () {
                                h = this;
                                if (0 !== h.data(I)) for (c = 0, b = a.length; c < b; c += 1) f = a[c], f.attr(h.data("setRolloverAttr")[c])
                            }
                        },
                        Ea = function (a) {
                            var c = 0, b, f, h;
                            return function () {
                                h = this;
                                if (0 !== h.data(I)) for (c = 0, b = a.length; c < b; c += 1) f = a[c], f.attr(h.data("setRolloutAttr")[c])
                            }
                        }, La = [], Ma = [], Qa = this.graphics.trackerContainer, Q = r.graphics.trackerGroup, Ra = 0,
                        Sa, Pa, Wa = !1;
                    ...
                    if (qa || wa) for (V =
                                           0, aa = ha.length; V < aa; V += 1) if (xa >= ha[V].minvalue && xa <= ha[V].maxvalue) {
                    ...
                    Pa = M ? pa : ma;
                    V = 0;
                    for (aa = ha && ha.length; V < aa; V += 1) U = ha[V], la = za(U.minvalue - ya, U.maxvalue - ya), oa = c((U.maxvalue - ya) / Ia), O = oa - Ra, Ra = oa, oa = O * m, Ba || M ? !Ba && M ? (la.height = oa - ja, la.y = Pa, Pa += oa) : Ba && !M ? (la.width = oa - ja, la.x = Sa, Sa += oa) : Ba && M && (la.width = oa - ja, la.x = Sa - la.width, Sa -= oa) : (la.height = oa - ja, la.y = Pa - la.height, Pa -= oa), U.x = la.x, U.y = la.y,
                        ...
                        "stroke-width": 0,
                        stroke: O,
                        fill: B({FCcolor: {color: oa, ratio: sa, alpha: Y, angle: 180}})
                    ...
                    }), Ma.push({"stroke-width": 0, fill: B({FCcolor: {color: d(oa, N), alpha: a(U.alpha, 100)}})});
                    if (ha &&
                        0 === ha.length) for (V = 0, aa = A.colorRangeElems.length; V < aa; V++) A.colorRangeElems[V].hide();
                    Ja = {link: p, value: xa};
                    P = {x: ta, y: pa, width: R, height: E, "stroke-width": 0, fill: S, ishot: !0};
                    ...
                    Ja = [];
                    P = {
                        path: ["M", va, ga, "L", Ha, ga, Ha, ea, va, ea, "Z"], stroke: e(Q, X), "stroke-width": ba,
                        "stroke-linecap": "butt"
                    };
                    z ? (z.animateWith(q, w, {path: ["M", va, ga, "L", Ha, ga, Ha, ea, va, ea, "Z"]}, h, G), z.attr({
                        stroke: e(Q, X),
                        "stroke-width": ba
                    })) : Da.canvasBorderElement = l.path(P, v).shadow({apply: k}).toBack();
                    for (V = 1; V < Ca; V += 1) Ba ? (Ja.push("M", y, ka, "L", y, ka + E), y += m) : (Ja.push("M", y, ka, "L", y + R, ka), ka += m);
                    P = {path: Ja, stroke: e(Fa, 100), "stroke-width": ja, "stroke-linecap": "butt"};
                    x ? (x.animateWith(q, w, {path: Ja}, h, G), x.attr({
                        stroke: e(Fa, 100),
                        "stroke-width": ja
                    ...
                    var b = this.config, f = this.components.data, d = this.chart, g = d.config, B = g.canvasLeft,
                        v = g.canvasTop, l = g.canvasHeight, H = g.canvasWidth, u = d.components.paper,
                        m = d.graphics.datasetGroup, h = this.graphics.container, w, q = d.components.numberFormatter,
                        z = a(this.chart.jsonData.chart.reverseaxis, d.isaxisreverse), A = d.isHorizontal,
                        x = d.get(J, K), n = x.animType, F = x.animObj, t = x.dummyObj, x = x.duration,
                        f = f[0], C = f.graphics, D = f && f.config, I = this.graphics.dataLabelContainer,
                        N = d.graphics.datalabelsGroup, Q = d.config.dataLabelStyle, C = b.heightUsed,
                        L = b.initAnimation, E;
                    ...
                    z && !A ? (z = {
                        ...
                        height: l,
                        r: 0
                    }, x, n), m.attr({"stroke-width": 0, fill: e(w, 50)})) : (m = f.graphics.element = u.rect(z,
                        h), m.animateWith(t, F, {x: B + q, width: N}, x, n))) : z && A && (z = {
                        x: B,
                        y: v,
                        width: x && L ? H : N,
                        height: l,
                        ...
                        "stroke-width": 0,
                        fill: e(w, 50)
                    })) : (m = f.graphics.element = u.rect(z, h), m.animateWith(t, F, {width: N}, x, n))) : (z = {
                        x: B,
                        y: v,
                        width: H,
                        height: x && L ? l : E,
                    ...
                    0 > b.x + g.marginLeft && (b = b.width - g.marginLeft, g.width < b && (b = g.width - g.marginLeft), z = {x: b / 2}, C.label.animateWith(t, F, z, x, n))) : C.label && (C.label = C.label.remove())
                }
            }, "bullet"])
        }]);
    E.register("module", ["private", "modules.renderer.js-dataset-thermometer", function () {
        var b = this.hcLib, k = b.pluckNumber, d = b.pluck, a = b.COMMASTRING, n = b.BLANKSTRING, L = b.getValidValue,
            D = b.parseTooltext, u = b.graphics.convertColor, e = b.HUNDREDSTRING, C = b.graphics.getDarkColor,
            N = b.graphics.getLightColor, J = b.preDefStr, K = J.configStr, I = J.animationObjStr,
            G = J.POSITION_TOP, Z = J.POSITION_MIDDLE, S = J.gaugeFillColorStr, c = J.gaugeBorderColorStr,
            F = b.plotEventHandler, g = b.toRaphaelColor, b = this.window,
            H = "rgba(192,192,192," + (/msie/i.test(b.navigator.userAgent) && !b.opera ? .002 : 1E-6) + ")";
        E.register("component", ["dataset", "thermometer", {
            init: function (a) {
                this.configure();
                this.setValue(a && a.data && a.data[0])
            }, setValue: function (a, c) {
                var b = this.config, g = this.chart, e = g.jsonData.chart, g = g.components.numberFormatter,
                    p = a.value;
                b.value = p = g.getCleanValue(p);
                null !== p ? (g = b.formattedValue =
                    g.dataLabels(b.value), b.displayValue = b.showValue ? a.label || L(g, n) : n, b.toolText = b.showTooltip ? void 0 !== e.plottooltext ? D(d(a.tooltext, e.plottooltext), [1, 2], {formattedValue: g}, {}, e) : d(a.tooltext, null === g ? n : g) : n) : (b.displayValue = n, b.toolText = n, b.formattedValue = null);
                c && this.draw()
            }, configure: function () {
                var b = this.chart, f = b.jsonData, g = f.chart, y = this.config || (this.config = {}),
                    H = b.components.colorManager, p = b.config, n, v = k(g.showhovereffect), l;
                ...
                var a = this.chart.config, c = a.canvasWidth, b = a.canvasHeight, g = a.canvasLeft, d = a.canvasRight,
                    p = a.canvasTop, e = a.xDefined, v = a.yDefined,
                    l = a.rDefined, H = a.hDefined, u = a.thmOriginX, m = a.thmOriginY, h = a.thmBulbRadius,
                    w = a.thmHeight, q;
                q = a.origW;
                ...
                return {top: z, bottom: A + (p + b - m), left: x + g, right: n}
            }, draw: function () {
                var c =
                        this.config, b = this.chart, d = b.graphics.datalabelsGroup, e = b.get("graphics", "trackerGroup"),
                    n = this.graphics || (this.graphics = {}), p = b.get("components", "scale"),
                    D = b.get("graphics", "datasetGroup"), v = b.get(K), l = b.get("components", "paper"),
                    ra = v.canvasLeft, J = v.canvasTop, m = v.canvasHeight, h = v.effectiveR || 10, w = .643 * h,
                    q = v.use3DLighting, z = ra + w, A = J - w, x = A + w, L = x + m, ta = L + .766 * h,
                    t = k(c.value, p.getLimit().min), pa = p.getPixel(t), p = .33 * w, t = A + p, E = .9 * w, R = w - p,
                    S = h + E - w, Q = z - w, ya = z + w, ua = z - R, R = z + R, M = z - E, Ba = z + E,
                    za = parseInt(z - .6 * w,
                        10), w = z + w / 2, fa = ta - Math.abs(Math.sqrt(S * S - E * E)), sa = n.container,
                    ha = n.fluid, da = n.topLightGlow, X = n.topLight, ba = n.label, U = n.dataLabelContainer,
                    ba = n.canvasBorderElement, E = n.bulbBorderLight, V = n.bulbTopLight, aa = n.bulbCenterLight,
                    la = n.trackerContainer, oa = n.cylLeftLight, O = n.cylRightLight, P = n.cylLeftLight1,
                    Y = n.cylRightLight1, la = n.hotElement, T = C(c.gaugeFillColor, q ? 70 : 80),
                    qa = c.gaugeFillAlpha, wa = c.gaugeContainerColor, ja = C(wa, 80), wa = N(wa, 80),
                    ka = c.gaugeBorderThickness, Fa = c.gaugeBorderColor, Ia = c.showHoverEffect, ea =
                        c.plotFillHoverAlpha, va = c.plotFillHoverColor, ga = b.get(K, I), Ha = ga.animType,
                    Ca = ga.animObj, Ja = ga.dummyObj, Na = ga.duration, xa = ga && ga.duration, ca = v.canvasRight,
                    Ga = v.canvasBottom, Oa = v.canvasWidth, Ka = b.config.dataLabelStyle, ga = function () {
                ...
                Ma || (Ma = c.fluidAttr = {});
                Ia && (Ma.hover = {fill: u(C(va, q ? 70 : 80), ea)});
                Ma.out = {fill: u(T, qa)};
                ...
                v.gaugeRadius = .5 * Oa;
                v = {value: c.value, displayValue: c.displayValue, toolText: c.toolText};
                sa ? xa ? (d = e = "animate", La = ga) : d = e = "attr" : (sa = n.container = l.group("thermometer", D), ba = n.canvasBorderElement = l.path(sa), ha = n.fluid = l.path(sa).attr({"stroke-width": 0}), X = n.topLight = l.path(sa).attr({"stroke-width": 1}), da = n.topLightGlow = l.path(sa).attr({"stroke-width": 0}),
                    E = n.bulbBorderLight = l.path(sa).attr({
                        "stroke-width": 0,
                        stroke: "#00FF00"
                    }), V = n.bulbTopLight = l.path(sa).attr({"stroke-width": 0}), aa = n.bulbCenterLight = l.path(sa).attr({"stroke-width": 0}), oa = n.cylLeftLight = l.path(sa).attr({"stroke-width": 0}), O = n.cylRightLight = l.path(sa).attr({"stroke-width": 0}), P = n.cylLeftLight1 = l.path(sa).attr({"stroke-width": 0}), Y = n.cylRightLight1 = l.path(sa).attr({"stroke-width": 0}), la = n.trackerContainer = l.group("col-hot", e), la = n.hotElement = l.path({
                    stroke: H,
                    fill: H,
                    ishot: !0
                }, la).click(function (a) {
                ...
                }), U = n.dataLabelContainer = l.group("datalabel", d), xa ? (e = "animate", La = ga, ha.attr({path: ["M", M, fa, "A", S, S, 0, 1, 0, Ba, fa, "L", Ba, fa, M, fa, "Z"]})) : e = "attr", d = "attr");
                Ea(ha, e, {path: ["M", M, fa, "A", S, S, 0, 1, 0, Ba, fa, "L", Ba, pa, M, pa, "Z"]}, La).attr(Ma.out);
                Ea(ba, d, {path: qa}).attr({"stroke-width": ka, stroke: Fa});
                Ea(X, d, {path: ["M", M, x, "L", Ba, x]}).attr({stroke: u(T, 40)});
                Ea(la, d, {path: qa}).tooltip(c.toolText);
                la.data("eventArgs", v);
                ...
                }).attr({text: c.displayValue}) : (ba = n.label = l.text({
                    text: c.displayValue,
                    x: z,
                    y: ta + h + (c.valuePadding || 0),
                    "text-anchor": Z,
                ...
                q ? (Ea(da.show(), d, {path: ["M", M, x, "L", Ba, x, Ba, t, M, t, "Z"]}).attr({
                    fill: g({
                        FCcolor: {
                            color: T + a + T,
                            alpha: "40,0",
                ...
                }), l = ["M", Q, L, "A", h, h, 0, 0, 1, ya, L, "A", h, h, 0, 0, 0, Q, L, "A", h, h, 0, 1, 0, ya, L, "Z"], Ea(E.show(), d, {path: l}).attr({
                    fill: g({
                        FCcolor: {
                            cx: .5,
                            cy: .5,
                ...
                }), Ea(V.show(), d, {path: l}).attr({
                    fill: g({
                        FCcolor: {
                            cx: .3,
                            cy: .1, r: "100%", color: wa + a + ja, alpha: "60,0", ratio: "0,30", radialGradient: !0
                        }
                    })
                }), Ea(aa.show(), d, {path: l}).attr({
                    fill: g({
                        FCcolor: {
                            cx: .25,
                            cy: .7,
                ...
                }), Ea(oa.show(), d, {path: ["M", z, A, "L", ua, A, "A", p, p, 0, 0, 0, Q, t, "L", Q, L, z, L, "Z"]}).attr({
                    fill: g({
                        FCcolor: {
                            color: wa + a + ja,
                            alpha: "50,0",
                ...
                }), Ea(O.show(), d, {path: ["M", Q, A, "L", R, A, "A", p, p, 0, 0, 1, ya, t, "L", ya, L, Q, L, "Z"]}).attr({
                    fill: g({
                        FCcolor: {
                            color: wa + a + ja + a + ja, alpha: "50,0,0", ratio: "0,40,60",
                            angle: 180
                        }
                    })
                }), Ea(P.show(), d, {path: ["M", za, t, "L", Q, t, Q, L, za, L, "Z"]}).attr({
                    fill: g({
                        FCcolor: {
                            color: wa + a + ja,
                            alpha: "60,0",
                ...
                }), Ea(Y.show(), d, {path: ["M", za - .01, t, "L", w, t, w, L, za - .01, L, "Z"]}).attr({
                    fill: g({
                        FCcolor: {
                            color: wa + a + ja,
                            alpha: "60,0",
                ...
                a.maxValue = b;
                a.minValue = c;
                return {forceMin: !0, forceMax: !0, max: b, min: c}
            },
            updateData: function (a, c, b) {
                c = this.config;
                var g = c.maxValue, d = c.prevMin, p = c.value, e = this.chart, v = this.groupManager || this,
                    l = e.components.scale;
                this.setValue(a.data[0]);
                c.maxValue = p;
                c.minValue = p;
                if (c.maxValue !== g || c.minValue !== d) this.maxminFlag = !0;
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-cylinder", function () {
        var b = this.hcLib, k = b.preDefStr, d = b.COMMASTRING, a = b.plotEventHandler, n = k.configStr,
            L = k.animationObjStr, D = Math, u = D.max, e = D.min, C = b.graphics.convertColor, N = b.toRaphaelColor,
            J = b.graphics.getDarkColor, D = this.window,
            K = "rgba(192,192,192," + (/msie/i.test(D.navigator.userAgent) && !D.opera ? .002 : 1E-6) + ")",
            I = k.POSITION_TOP, G = k.POSITION_MIDDLE, Z = b.pluckNumber, S = b.graphics.getLightColor;
        E.register("component", ["dataset", "cylinder", {
            _manageSpace: function () {
                var a = this.chart.config, b = a.canvasWidth, g = a.canvasHeight, d = a.canvasLeft, n = a.canvasTop,
                    f = a.canvasRight, r = a.xDefined, y = a.yDefined, k = a.rDefined,
                    p = a.hDefined, C = a.gaugeOriginX, v = a.gaugeOriginY, l = a.gaugeRadius, D = a.gaugeHeight,
                    G = a.gaugeYScale, m;
                m = a.origW;
                ...
                w = w + G + (n + g - v);
                return {top: h, bottom: w + 8, left: q + d, right: z}
            }, draw: function () {
                var c = this.config,
                    b = this.chart, g = this.graphics || (this.graphics = {}), e = b.graphics, k = e.datalabelsGroup,
                    f = e.trackerGroup, r = e.datasetGroup, e = g.fluidTop, y = g.fluid, D = g.cylinterTop,
                    p = g.frontLight1, ia = g.frontLight, v = g.front, l = g.back, ra = g.btnBorderLight,
                    E = g.btnBorder1, m = g.btnBorder, h = g.label, w = g.dataLabelContainer, h = g.trackerContainer,
                    h = g.hotElement, q = b.components, z = q.scale, A = b.config, q = q.paper, x = A.canvasLeft,
                    na = A.canvasTop, ta = A.canvasHeight, t = A.effectiveR || 40, pa = Z(c.value, z.getLimit().min),
                    ma = z.getPixel(pa), z = x + t, pa = b.config.dataLabelStyle,
                    R = c.gaugeFillColor, Aa = J(R, 70), Q = S(R, 70), ya = J(Aa, 90), ua = A.gaugeFillAlpha,
                    M = c.gaugeContainerColor, R = J(M, 80), Ba = J(M, 90), za = S(M, 80), fa = g.container,
                    M = t * A.gaugeYScale, sa = t - 1.5, ha = na + ta, da = z - t, X = z + t, ba = da + 1.5,
                    U = X - 1.5, V = da - 2, aa = X + 2, la = t + 2, oa = M + 2, O = ha + 4, P = O + .001, Y = .85 * t,
                    T = z - Y, qa = z + Y, Y = Math.sqrt((1 - Y * Y / (t * t)) * M * M), wa = na + Y, ja = ha + Y,
                    Y = na - 1, ka = A.use3DLighting, Fa = c.showHoverEffect, Ia = c.plotFillHoverAlpha,
                    ea = c.plotFillHoverColor, va = b.get(n, L), ga = va.animType, Ha = va.animObj, Ca = va.dummyObj,
                    Ja = va.duration, Na = va && va.duration,
                    va = function () {
                        b._animCallBack && b._animCallBack()
                    }, xa = function (a, c, b, f) {
                ...
                A.gaugeRadius = .5 * Ea;
                Ga || (Ga = c.fluidAttr = {});
                A = {value: c.value, displayValue: c.displayValue, toolText: c.toolText};
                fa ? Na ? (k = f = "animate", ca = va) : k = f = "attr" : (fa = g.container = q.group("thermometer",
                    r), m = g.btnBorder = q.path(fa).attr({"stroke-width": 4}), E = g.btnBorder1 = q.path(fa).attr({"stroke-width": 4}), ra = g.btnBorderLight = q.path(fa).attr({"stroke-width": 0}), l = g.back = q.path(fa).attr({"stroke-width": 1}), y = g.fluid = q.path(fa).attr({"stroke-width": 0}), e = g.fluidTop = q.path(fa).attr({"stroke-width": 2}), v = g.front = q.path(fa).attr({"stroke-width": 1}), ia = g.frontLight = q.path(fa).attr({"stroke-width": 0}), p = g.frontLight1 = q.path(fa).attr({"stroke-width": 0}), D = g.cylinterTop = q.path(fa).attr({"stroke-width": 2}),
                ...
                }), e.attr({path: ["M", ba, ha, "A", sa, M, 0, 0, 0, U, ha, "L", U, ha, "A", sa, M, 0, 0, 0, ba, ha, "Z"]})) : f = "attr", k = "attr");
                ...
                }), xa(ia, k, {path: ["M", da, ha, "A", t, M, 1, 0, 0, T, ja, "L", T, wa, "A", t, M, 0, 0, 1, da, na, "Z"]}), p.show().attr({
                    fill: N({
                        FCcolor: {
                            color: Q,
                            alpha: "40,0",
                ...
                }), xa(p, k, {path: ["M", qa, ja, "A", t, M, 0, 0, 0, X, ha, "L", X, na, "A", t, M, 1, 0, 0, qa, wa, "Z"]})) : (r = za + d + R + d + R + d + R + d + R + d + R + d + R + d + za, Ba = x = C(Aa, ua), ya = C(ya), Q = R + d + R + d + R + d + R + d + R + d + R + d + R + d + R, ia.hide(), p.hide());
                Ga.bodyOut = {fill: x};
                Ga.topOut = {stroke: ya, fill: Ba};
                Fa && (p = J(ea, 70), ia = S(ea, 70), T = J(p, 90), ka ? (Ga.bodyHover = {
                    fill: N({
                        FCcolor: {
                            cx: .5,
                            cy: 0, r: "100%", color: ia + d + p, alpha: Ia + d + Ia, ratio: "0,100", radialGradient: !0
                        }
                    })
                }, Ga.topHover = {
                    stroke: C(ia, Ia),
                ...
                }) : (Ga.bodyHover = {fill: C(p, Ia)}, Ga.topHover = {stroke: C(T), fill: C(p, Ia)}));
                y.attr(Ga.bodyOut);
                e.attr(Ga.topOut);
                xa(y, f, {path: ["M", da, ha, "A", t, u(M, 1), 0, 0, 0, X, ha, "L", X, ma, "A", t, u(M, 1), 0, 0, 1, da, ma, "Z"]}, ca);
                xa(e, f, {path: ["M", ba, ma, "A", sa, M, 0, 0, 0, U, ma, "L", U, ma, "A", sa, M, 0, 0, 0, ba, ma, "Z"]});
                m.attr({
                    stroke: C(R,
                        80)
                });
                xa(m, k, {path: ["M", V, O, "A", la, oa, 0, 0, 0, aa, O, "L", aa, P, "A", la, oa, 0, 0, 0, V, P, "Z"]});
                E.attr({stroke: La});
                xa(E, k, {path: ["M", da, O, "A", t, M, 0, 0, 0, X, O, "L", X, P, "A", t, M, 0, 0, 0, da, P, "Z"]});
                ra.attr({
                    fill: N({
                        FCcolor: {
                ...
                xa(ra, k, {path: ["M", da, ha, "A", t, M, 0, 0, 0, X, ha, "A", t, M, 0, 0, 0, da, ha, "Z"]});
                l.attr({
                    stroke: La,
                    fill: N({
                        FCcolor: {
                ...
                xa(l, k, {path: ["M", da, ha, "A", t, M, 0, 0, 0, X, ha, "L", X, na, "A", t, M, 0, 0, 0, da, na, "Z"]});
                v.attr({
                    stroke: La,
                    fill: N({
                        FCcolor: {
                ...
                xa(v, k, {path: ["M", da, ha, "A", t, M, 0, 0, 0, X, ha, "L", X, na, "A", t, M, 0, 0, 1, da, na, "Z"]});
                D.attr({stroke: C(R, 40)});
                xa(D, k, {path: ["M", da, Y, "A", t, M, 0, 0, 0, X, Y, "L", X, Y, "A", t, M, 0, 0, 0, da, Y, "Z"]});
                xa(h, k, {path: ["M", da, ha, da, O + 4, "A", t, M, 0, 0, 0, X, O + 4, "L", X, ha, X, na, "A", t, M, 0, 0, 0, da, na, "Z"]}).tooltip(c.toolText);
                h.data("eventArgs",
                    A);
                c.showValue ? (h = g.label) ? (h.show().attr({text: c.displayValue}), xa(h, k, {
                    x: z,
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-angulargauge", function () {
        var b = this, k = b.hcLib, d = k.Raphael, a = k.BLANKSTRING, n = k.pluck, L = k.toPrecision,
            D = k.getValidValue, u = k.pluckNumber, e = k.hasSVG, C = k.getFirstValue, N = k.graphics.convertColor,
            J = k.preDefStr, K = J.configStr, I = J.animationObjStr, G = k.getDashStyle, Z = k.parseTooltext,
            S = k.COMMASTRING, c = k.ZEROSTRING, F = k.parseUnsafeString, g = b.window, J = Math, H = J.abs,
            B = J.atan2, J = J.PI, f = 2 * J, r = J / 180, y = k.toRaphaelColor, W =
            void 0 !== g.document.documentElement.ontouchstart, p = k.getPosition, ia = k.plotEventHandler,
            v = function (a) {
                ...
                return function (a, c, b) {
                    ...
                    if ("string" === typeof a || void 0 === a) g = "angle" == a ? g._Attr[a] : g._attr(a); else for (f in a) c = a[f], "angle" === f ? (l[f] = c, y = c * r, l.tooltipPos[0] = l.cx + l.toolTipRadius * Math.cos(y), l.tooltipPos[1] =
                        l.cy + l.toolTipRadius * Math.sin(y), l.prevValue = c, b && b.duration ? g.animate({transform: "R" + c + S + p + S + e}, b.duration, "easeIn") : g.attr({transform: "R" + c + S + p + S + e})) : g._attr(f, c);
                    return g
                }
            };
        E.register("component", ["dataset", "angulargauge", {
            type: "angulargauge", pIndex: 2, customConfigFn: "_createDatasets", init: function () {
                this.components = this.components || {};
                this.idMap = {};
                this.configure()
            }, configure: function () {
                var b = this.chart, f = b.config, g = b.jsonData, d = g.chart, p = g.pointers || g.dials,
                    y = p.pointer || p.dial, x = this.components.data ||
                    (this.components.data = []), g = b.components, H = g.scale, g = g.colorManager,
                    F = this.config || (this.config = {}), t = u(d.gaugescaleangle, 180), B = u(d.gaugestartangle),
                    I = u(d.gaugeendangle), W = v(B), K = e ? .001 : .01, ia = v(I), J, L, M, E;
                M = f.displayValueCount = 0;
                for (E = y.length; M < E; M += 1) x[M] = x[M] || (x[M] = {}), x[M].basewidth = y[M].basewidth, x[M].color = y[M].color, x[M].alpha = y[M].alpha, x[M].bgcolor = y[M].bgcolor, x[M].borderalpha = y[M].borderalpha, x[M].bordercolor = y[M].bordercolor, x[M].borderthickness = y[M].borderthickness, x[M].editmode = y[M].editmode,
                ...
                if (360 < t || -360 > t) t = 0 < t ? 360 : -360;
                if (360 <
                    I || -360 > I) I %= 360;
                if (360 < B || -360 > B) B %= 360;
                if (W && ia) {
                    if (t = B - I, 360 < t || -360 > t) t %= 360, I = B - t
                } else if (W) {
                    if (I = B - t, 360 < I || -360 > I) I %= 360, B += 0 < I ? -360 : 360
                } else if (ia) {
                    if (B = I + t, 360 < B || -360 > B) B %= 360, I += 0 < B ? -360 : 360
                } else 360 === t ? (B = 180, I = -180) : -360 === t ? I = B = -180 : (B = 90 + t / 2, I = B - t);
                360 === Math.abs(t) && (t += 0 < t ? -K : K, I = B - t);
                I = 360 - I;
                B = 360 - B;
                if (360 < B || 360 < I) B -= 360, I -= 360;
                ...
                f = f.dataLabels.style = {
                    ...
                    borderThickness: u(d.valueborderthickness,
                        1),
                    borderPadding: u(d.valueborderpadding, 2),
                    borderRadius: u(d.valueborderradius, 0),
                    backgroundColor: d.valuebgcolor ? N(d.valuebgcolor, u(d.valuebgalpha, d.valuealpha, 100)) : a,
                    borderDash: u(d.valueborderdashed, 0) ? G(u(d.valueborderdashlen, 4), u(d.valueborderdashgap, 2), u(d.valueborderthickness, 1)) : a
                };
                l(f)
            }, draw: function (c) {
                var d = this, l = d.chart, e = d.idMap, k = l.config, A = l.jsonData.chart, x = d.components.data,
                    C = d.config, G = d.graphics, t = l.components, J = t.numberFormatter, ra = t.paper,
                    E = t.colorManager, S = t.scale, Q = Number(C.gaugeOriginX),
                    ya = Number(C.gaugeOriginY), ua = C.gaugeStartAngle, M = C.gaugeEndAngle, Ba = C.showShadow,
                    za = k.showtooltip, fa = S.config.axisRange, sa = fa.min, ha = fa.max, da = G.pointGroup,
                    X = G.dataLabelGroup, ba = ha - sa, U = M - ua, V = ba / U, aa, la = u(A.showhovereffect),
                    oa = d.showValue = u(A.showvalue, A.showrealtimevalue, 0), O = 0, P = k.dataLabels.style, Y = {
                    ...
                    I), ka = ja.duration, Fa = ja.dummyObj, Ia = ja.animObj, ea = ja.animType, va = 0, ga = 0, Ha, Ca,
                    Ja, Na = {}, xa = S.config.prevAxisMinMax || (S.config.prevAxisMinMax = {}), ca, Ga, Oa, Ka, Ea, La,
                    Ma, Qa, Ra = x && x.length, Sa, Pa, Wa, Ta = {pageX: 0, pageY: 0}, Xa = Da(ua, M), Ya,
                    cb = function (a, c) {
                    ...
                    db = function () {
                        ...
                        var g = x[this.pos],
                            l = W && (W && c.sourceEvent && c.sourceEvent.touches && c.sourceEvent.touches[0] || c) || Ta,
                            p, r, m;
                        p =
                            b[2];
                        r = b[3];
                        ...
                        if (g.editMode) {
                            ...
                            r = [];
                            m = 0;
                            for (e = g.config.index; m < e; m += 1) r.push(a);
                            r.push({value: p, animation: {duration: 0, transposeAnimDuration: 0, initAnimDuration: 0}});
                            g.config.y !== p && d.updateData({data: r}, !0) && (g.updatedValStr = r.join("|"), g.dragStartX = Q || c.pageX || l.pageX)
                        }
                    }, $a, Hb, Za, kb, lb, rb, sb, tb, ub, mb, vb, Ib, fb, Ua, nb, Va, wb, xb, ob, yb, zb, Ab, Bb, Cb, Db,
                    ab, gb, pb, Jb, Eb, Kb, bb, Lb, Ob, hb, Mb, ib, Nb, Fb, jb, Gb, qb;
                hb = C.pivotRadius;
                ...
                if (xa.min !== Na.min || xa.max !== Na.max) l._drawCanvas(), l._drawAxis();
                ...
                for (; O < Ra; O += 1) {
                    ...
                    fb = ca.config;
                    ca.config.index = O;
                    e[ca.id] = {index: O, config: ca.config};
                    qb = !1;
                    void 0 !== ca.id && (C.dataById[ca.id] = {index: O, point: ca});
                    ...
                    fb.formatedVal = nb;
                    wb && v(xb);
                    ob = (ob = D(F(n(ca.tooltext, ca.hovertext)))) ? Z(ob, [1, 2], {formattedValue: nb},
                        ca, A) : Va;
                    yb = n(ca.color, ca.bgcolor, E.getColor("dialColor"));
                    zb = u(ca.alpha, ca.bgalpha, 100);
                    Ab = y({FCcolor: {color: yb, alpha: zb, angle: 90}});
                    ...
                    if (0 !== gb && (gb || ca.borderhovercolor ||
                        ...
                        if (Eb = u(ca.borderhoverthickness, A.dialborderhoverthickness, ab)) Ja.stroke = Db, Kb = /\{/.test(pb), Ca.stroke = N(Kb ? E.parseColorMix(Bb, pb)[0] : pb, Jb);
                        ...
                        Ha = {FCcolor: {color: bb, alpha: Lb, angle: 90}};
                        Ca.fill = y(Ha)
                    }
                    ...
                    Hb = {link: ca.link, value: Ua, displayValue: Nb, toolText: ib};
                    G.pointersTpath[O] ? Ka ? (G.pointersPath[O].animateWith(Fa, Ia, {path: kb}, ka, ea), G.pointersTpath[O]._attr({
                        trianglepath: [0, 0, 0,
                            0, 0, 0, 0, 0, 0]
                    })) : (G.pointersTpath[O].animateWith(Fa, Ia, {trianglepath: [Ga, Qa, -La, Ma, -La, -Ma, 0, Ea, Ea]}, ka, ea), G.pointersPath[O]._attr({path: "M00"})) : (Ka ? (G.pointersPath[O] = ra.path(kb, da), G.pointersTpath[O] = ra.trianglepath(0, 0, 0, 0, 0, 0, 0, 0, 0, da)) : (G.pointersPath[O] = ra.path(["M", 0, 0], da), G.pointersTpath[O] = ra.trianglepath(Ga, Qa, -La, Ma, -La, -Ma, 0, Ea, Ea, da)), qb = !0);
                    ...
                    Pa._attr({fill: Ab, stroke: Db, ishot: !0, "stroke-width": ab}).data("eventArgs", Hb);
                    (Oa || Ka || ab) && Pa.shadow({apply: Ba});
                    Pa._Attr = {tooltipPos: ca.tooltipPos, cx: Q, cy: ya, toolTipRadius: Ga - La, color: ca.color};
                    qb && (Sa = ua / r, Pa.attr({angle: Sa}));
                    ca.index = O;
                    ca.editMode = aa;
                    Pa.css({
                    ...
                    qb && (G.pointersPath[O].drag(eb, cb, db, {pos: O}, {pos: O},
                        {pos: O}).click(vb), G.pointersTpath[O].drag(eb, cb, db, {pos: O}, {pos: O}, {pos: O}).click(vb));
                    fb.y = Ua;
                    Ua >= sa && Ua <= ha && (Ib = (Ua - sa) / ba * U, Sa = (ua + Ib) / r, Pa.attr({angle: Sa}, null, c), za && ib !== a ? (Pa.tooltip(ib), Pa.trackTooltip(!0)) : Pa.trackTooltip(!1));
                    ga += 1;
                ...
                O = ga;
                for (Ra = G.pointersPath.length; O < Ra; O += 1) G.pointersPath[O].attr({path: ["M", 0, 0]}), G.pointersTpath[O].attr({trianglepath: [0, 0, 0, 0, 0, 0, 0, 0, 0]});
                O =
                    va;
                for (Ra = G.dataLabel.length; O < Ra; O += 1) G.dataLabel[O].attr({text: a, "text-bound": []})
            }, updateData: function (a, c) {
                if (a === this.lastUpdatedObj) return !1;
                var b = this.chart, f = this.components.data, d, g, l = (g = this.components.data) && g.length || 0, p,
                    r;
                a = a.data;
                if (l) {
                    for (; l--;) if (d = a[l]) r = d.animation || b.get(K, I), p = d.value, g = d.tooltext, d = d.label, f[l].value = u(p, f[l].value, 0), f[l].tooltext = n(g, f[l].value), f[l].displayvalue = d;
    ...
    E.register("module", ["private",
        "modules.renderer.js-dataset-bulb", function () {
            var b = this.hcLib, k = b.pluckNumber, d = b.pluck, a = b.COMMASTRING, n = b.COMMASPACE, L = b.BLANKSTRING,
                D = b.extend2, u = b.toRaphaelColor, e = b.schedular, C = b.getValidValue, N = b.graphics.convertColor,
                J = b.graphics.getDarkColor, K = b.graphics.getLightColor, I = b.preDefStr, G = b.parseConfiguration,
                Z = b.parseUnsafeString, S = I.configStr, c = I.animationObjStr, F = I.POSITION_TOP,
                g = I.POSITION_MIDDLE, H = I.showHoverEffectStr, B = I.visibleStr, f = I.ROUND, r = b.plotEventHandler,
                y = Math.min, I = this.window,
                W = "rgba(192,192,192," + (/msie/i.test(I.navigator.userAgent) && !I.opera ? .002 : 1E-6) + ")";
            E.register("component", ["dataset", "bulb", {
                pIndex: 2, customConfigFn: "_createDatasets", _manageSpace: function (a) {
                    var c = this.config, b = this.components.data, f = this.chart, d = f.config,
                        g = f.linkedItems.smartLabel, r = d.dataLabelStyle, f = k(parseInt(r.lineHeight, 10), 12),
                        h = d.valuepadding, e = 0, b = (b = b[0]) && b.config;
                    g.useEllipsesOnOverflow(d.useEllipsesWhenOverflow);
                    g.setStyle(r);
                    b && b.displayValue !== L && !d.placevaluesinside && c.showValue &&
                    (d = g.getOriSize(b.displayValue), b.displayValue === L && (d = {height: f}), 0 < d.height && (e = d.height + h), e > a && (e = a));
                    c.heightUsed = e;
                    return {top: 0, bottom: e}
                }, configure: function () {
                    ...
                    b.animation = a ? {duration: 1E3 * k(g.animationduration, 1)} : !1;
                    b.showValue = k(g.showvalue, 1);
                    this._setConfigure()
                }, _setConfigure: function (c) {
                    var f = this.chart, g = this.config, l = f.config, r = this.JSONData, e = c || r.data,
                        m = e && e.length, m = c && c.data.length || m, h = f.jsonData.chart,
                        y = f.components.colorManager, q = k(h.showtooltip, 1), H = b.parseUnsafeString;
                    H(d(h.tooltipsepchar,
                        n));
                    var F = b.parseTooltext, x, B, G = l.showhovereffect, t = this.components.data, D, I, W,
                        L = k(h.is3d, 1), E, Z = f.components.numberFormatter, S, M, Ba, za, fa, sa, ha, da, X, ba, U,
                        V, aa, la, oa, O = function (c, b, f) {
                            return f ? {
                                FCcolor: {
                                    cx: .4,
                                    cy: .4,
                    ...
                    for (E = 0; E < m; E++) D = c ? c && c.data[E] : e[E], I = (x = t[E]) && x.config, x || (x = t[E] = {}), x.config || (I = t[E].config = {}), I.setValue = x = Z.getCleanValue(D.value) || 0, x = Z.dataLabels(x),
                    ...
                    U && (U = h.gaugeborderhovercolor || h.gaugeborderhoveralpha || 0 === h.gaugeborderhoveralpha || h.gaugeborderhoverthickness || 0 === h.gaugeborderhoverthickness ? 1 : l.showgaugeborder), V = d(h.gaugeborderhovercolor, "{dark-10}"), aa = k(h.gaugeborderhoveralpha), la = U ? k(h.gaugeborderhoverthickness, da || 1) : 0, oa = !!k(h.is3donhover, L), k(h.showhoveranimation, 1), U = {}, P = {}, da !== la && (U["stroke-width"] = la, P["stroke-width"] = da), P.fill = u(sa), X = (sa = /\{/.test(X)) ? y.parseColorMix(M.code, X)[0] : d(X, M.code), U.fill = u(O(X, k(ba, Ba), oa)), la && (P.stroke =
                        ha, M = /\{/.test(V), U.stroke = N(M ? y.parseColorMix(fa ? X : B, V)[0] : V, k(aa, za)))), I.setTooltext = b.getValidValue(H(d(D.tooltext, r.plottooltext, h.plottooltext))), B = q ? void 0 !== I.setTooltext ? F(I.setTooltext, [1, 2], {formattedValue: x}, D, h) : g.useColorNameAsValue ? S : null === x ? !1 : x : !1, D = void 0 !== W ? W : D.label || (g.useColorNameAsValue ? S : x), I.toolText = B, I.displayValue = D, I.rolloverProperties = {
                        enabled: G,
                        hoverAttr: U,
                    ...
                    var a = this.components.data, d = this.chart, r = this.config, l = d.getJobList(), n = d.get(S, c),
                        H = n.animType, m = n.animObj, h = n.dummyObj, n = n.duration, w = d.config, q = w.canvasLeft,
                        k = w.canvasTop, C = w.canvasHeight, x = w.canvasWidth, G = d.components.paper,
                        D = d.graphics.datasetGroup, t = this.graphics.container, I = this.graphics.trackerContainer,
                        K = d.graphics, J = K.trackerGroup,
                        E, N = a[0], a = N && N.config, Z = w.gaugeoriginx;
                    E = w.gaugeoriginy;
                    var ua = w.gaugeradius, M = w.hasgaugeoriginx, Ba = w.hasgaugeoriginy, za = w.hasgaugeradius,
                        fa = this.graphics.dataLabelContainer, d = d.config.dataLabelStyle, K = K.datalabelsGroup;
                    t || (t = this.graphics.container = G.group("bulb", D));
                    ...
                    D = a.toolText;
                    I.eventArgs = {
                        value: J, displayValue: a.displayValue,
                        toolText: D ? D : ""
                    };
                    ...
                    (E = N.graphics.element) ? (N.graphics.element.animateWith(h, m, {
                        ...
                        fill: u(a.fillColor),
                        ishot: !0
                    })) : (E = N.graphics.element = G.circle(C, t), E.animateWith(h, m, {r: x}, n, H));
                    I.attr = {
                        cx: k,
                        cy: q,
                        r: x,
                    ...
                    })) : t.label = G.text(C, fa), t.label.tooltip(D)) : t.label && t.label.hide() && t.label.attr({"text-bound": []});
                    l.trackerDrawID.push(e.addJob(this.drawTracker.bind(this),
                        b.priorityList.tracker))
                }, drawTracker: function () {
                    var a = this.chart, c = a.config.plothovereffect, b = a.components.paper,
                        f = this.graphics.trackerContainer, d, g, e, h, y, q = function (c) {
                            r.call(this, a, c)
                        }, n = function (c) {
                            return function (b) {
                                var f = this.getData();
    ...
    E.register("module", ["private", "modules.renderer.js-dataset-progressgauge", function () {
        var b = this.hcLib, k = b.BLANKSTRING, d = b.pluck, a = b.getValidValue, n = b.pluckNumber, L = b.getFirstValue,
            D = b.graphics.getLightColor, u = b.graphics.convertColor, e = b.preDefStr, C = e.colors.FFFFFF,
            N = e.visibleStr, J = e.ROUND, K = b.parseUnsafeString, e = this.window,
            I = "rgba(192,192,192," + (/msie/i.test(e.navigator.userAgent) && !e.opera ? .002 : 1E-6) + ")", e = Math,
            G = e.max, Z = e.min, S = b.regex.dropHash, c = b.HASHSTRING,
            F = b.toRaphaelColor, g = b.HUNDREDSTRING, H = b.COMMASPACE, B = b.COMMASTRING;
        E.register("component", ["dataset", "progressgauge", {
            type: "doughnut2d", configure: function () {
                var a = this.chart, c = this.config, e = this.JSONData, H = a.config, p = a.jsonData.chart,
                    k = a.components.colorManager, v,
                    l = c.plotColor = k.getPlotColor(this.index || this.positionIndex),
                    u = n(e.dashed, p.plotborderdashed);
                n(p.useplotgradientcolor, 1);
                var F, m, h, w = b.getDashStyle, q = a.isBar, B = a.is3D, D = a.isStacked, x = {},
                    x = x.dataObj || (x.dataObj = {}), x = x.chart || (x.chart = {});
                ...
                c.animation = u ? {duration: 1E3 * n(p.animationduration, 1)} : !1;
                ...
                var e = this.chart, u =
                        this.config, p = this.JSONData, C = c || p.data, v = C && C.length, l = e.config.categories,
                    I = e.singleseries, l = l && l.length, v = c && c.data.length || Z(l, v), l = e.jsonData.chart,
                    K = e.components.colorManager, m = u.showPlotBorder,
                    h = u.plotColor = K.getPlotColor(this.index || this.positionIndex), w = n(l.showtooltip, 1),
                    q = b.parseUnsafeString, z = q(l.yaxisname), A = q(l.xaxisname), x = q(d(l.tooltipsepchar, H)),
                    J = n(l.seriesnameintooltip, 1), E = b.parseTooltext, t, N, S, R, Aa, Q, ya,
                    ua = u.plotBorderThickness, M = u.isRoundEdges, Ba = u.showHoverEffect, za = u.plotFillAngle,
                    fa, sa, ha, da = u.plotBorderDashStyle, X, ba, U, V, aa, la, oa, O, P, Y = b.getDashStyle,
                    T = this.components.data, qa = e.isBar, wa = e.is3D, ja, ka = u.maxValue || -Infinity,
                    Fa = u.minValue || Infinity, Ia = this.chart.components.numberFormatter, ea;
                T || (T = this.components.data = []);
                for (ja = 0; ja < v; ja++) c ? (Q = c && c.data[ja], ea = void 0 !== g ? g + ja : T.length - v + ja, N = T[ea]) : (N = T[ja], Q = C[ja]), e = N && N.config, N || (N = T[ja] = {}), N.config || (e = T[ja].config = {}), e.visible = n(Q.visible, !0), e.showValue = n(Q.showvalue, u.showValues), e.setValue = N = Ia.getCleanValue(Q.value),
                    ...
                    w ? null === t ? Q = !1 : void 0 !== h ? (R = [1, 2, 3, 4, 5, 6, 7], N = {
                        ...
                        formattedValue: t,
                        label: N
                    }, Q = E(h, R, N, Q, l, p)) : (J && (S = L(p && p.seriesname)), Q = S ? S + x : k, Q += N ? N + x : k) : Q = !1, e.toolText = Q, e.setTooltext = Q, Aa && (za = Aa), ea++;
                u.maxValue = ka;
                u.minValue = Fa
            }, init: function (a) {
                var c = this.chart;
                ...
                for (e = 0; e < v.length; e += 1) u = v[e], g = u.config, l = d[e].label ? d[e].label : "Type " + (e + 1), u = {
                    FCcolor: {
                        color: g.plotColor,
                        angle: 0,
                        ratio: "0",
                ...
                var b =
                        a.components.data[c.configuration.index], d = a.config, g = b.graphics, e = b.config.visible,
                    v = this.config, l = c.config, n = c.graphics, H = v.itemHiddenStyle.color, v = v.itemStyle.color,
                    m = l.fillColor, l = l.strokeColor;
                ...
                e ? (d.animation.duration && d.transposeAnimation || (g.gaugeBackground.hide(), g.gaugeMeter.hide(), g.hotElement.hide()), n.legendItemSymbol && n.legendItemSymbol.attr({
                        fill: H,
                        stroke: H
                    }), n.legendItemText && n.legendItemText.attr({fill: u(H)}), n.legendIconLine && n.legendIconLine.attr({stroke: H})) :
                    (g.gaugeBackground.show(), g.gaugeMeter.show(), g.hotElement.show(), n.legendItemSymbol && n.legendItemSymbol.attr({
                        fill: m,
                        stroke: l
                    }), n.legendItemText && n.legendItemText.attr({fill: u(v)}), n.legendIconLine && n.legendIconLine.attr({stroke: m}));
                a.draw()
            }, draw: function () {
                var c = this, b = c.JSONData, g = c.config, e = c.chart.jsonData.chart, p = c.components.data,
                    n = c.components.data, v = c.chart, l = v.components.paper, H = v.config, B = H.canvasLeft,
                    m = H.canvasTop, h = H.canvasHeight, w = H.canvasWidth, q = v.graphics.datasetGroup,
                    H = c.graphics.gaugeBackgroundContainer,
                    C = c.graphics.gaugeMeterContainer, D = c.graphics.trackerContainer, x = v.graphics.trackerGroup,
                    G = c.components.data.length || 0, E, t, L, S, R, Aa, Q, ya, ua, M, Ba, za = g.animation.duration,
                    fa = g.transposeAnimation, g = g.transposeAnimDuration;
                Aa = 0;
                var sa = function () {
                    var a = c.components.data, b, d = c.components.data.length, g;
                    for (E = 0; E < d; E++) b = a[E].config, g = a[E].graphics, b.visible || g.hotElement.hide()
                };
                ...
                for (E = 0; E < G; E++) t = p[E], L = (q = n[E]) && q.config, L.visible && (Aa += 1);
                q = Z(h / 2, w / 2);
                v = x = .2 * Z(v.config.canvasWidth, v.config.canvasHeight);
                Aa = (q - Aa - v) / Aa;
                B += .5 * w;
                m += .5 * h;
                for (E = 0; E < G; E++) if (t = p[E], L = (q = n[E]) && q.config, (w = L.visible) || za) q.graphics || (n[E].graphics = {}), S = L.setValue, h = L.setLink, t = a(K(d(t.tooltext, b.plottooltext, e.plottooltext))), t = L.toolText + (t ? k : L.toolTipValue), R = L.colorArr, Ba = E, M = {
                    index: E,
                    link: h,
                    value: S,
                    ...
                    "stroke-width": 0
                }, fa ? (L = w ? [B, m, Q, ya, 0, ua] : [B, m, Q, Q, 0, ua], q.graphics.gaugeBackground.animate({ringpath: L}, g, "easeIn")) : q.graphics.gaugeBackground.attr(L)) : q.graphics.gaugeBackground = l.ringpath(B, m, Q, ya, 0, ua, H).attr({
                    fill: u(L.plotColor, L.plotBackgroundFillAlpha),
                    "stroke-width": 0
                }),
                    ...
                    "stroke-width": Aa,
                    "stroke-linecap": J
                }), za && q.graphics.gaugeMeter.animate({arcpath: Q},
                    za, "easeIn")), L = {
                    arcpath: Q,
                    cursor: h ? "pointer" : k,
                    stroke: I,
                ...
                u = {
                    ...
                    "text-bound": m.bgOval ? "none" : [F({color: m.bgColor, alpha: m.bgAlpha}), F({
                        color: m.borderColor,
                        alpha: m.borderAlpha
                ...
                l ? b.graphics.label.animate({opacity: 1}, 100, "easeIn") : b.graphics.label.animate({opacity: 0}, 100, "easeOut")
                ...
                this._setConfigure(a, c);
                this.setMaxMin();
                if (d.maxValue !== g || d.minValue !== e) this.maxminFlag = !0;
                ...
                c = c || 1;
                a = a || 0;
                if (a + c === g.length) this.endPosition = !0; else if (0 === a || void 0 === a) this.endPosition = !1;
                g[a] && (g[a].config.visible = 0);
                b && this.draw();
                d.removeDataArr = e = e.concat(g.splice(a, c));
                b = e.length;
                for (a = 0; a < b; a++) if (e[a]) {
                    c = e[a].config;
                    if (c.setValue === n.maxValue || c.setValue === n.minValue) l = this.maxminFlag = !0;
                    if (l) break
                }
                l && this.setMaxMin()
            }, manageSpace: function () {
    ...
    E.register("module", ["private", "modules.renderer.js-realtimecolumn",
        function () {
            var b = this, k = b.hcLib, d = !k.CREDIT_REGEX.test(b.window.location.hostname), a = k.BLANKSTRING,
                n = k.COMMASPACE, E = Math.max, D = k.regex.dropHash, u = k.HASHSTRING, e = k.graphics.convertColor,
                C = k.preDefStr, N = C.animationObjStr, J = C.visibleStr, K = C.configStr, I = k.pluck,
                G = k.pluckNumber, Z = k.schedular, S = k.priorityList, C = k.chartAPI;
            C("realtimecolumn", {
                showRTvalue: !0,
                canvasPadding: !0,
                isRealTime: !0,
                ...
                applicableDSList: {realtimecolumn: !0},
                transposeAxis: !0,
                rtManageSpace: !0,
                _realTimeConfigure: function () {
                    var c = this.config, b = c.animationObj, c = c.realTimeConfig || (c.realTimeConfig = {}), d, e, k,
                        f;
                    d = this.jsonData;
                    var r = d.chart;
                ...
                _setRealTimeCategories: function () {
                    var a = this.components.xAxis[0], b = [], d = this.config.realTimeConfig,
                        e = d && d.clear ? void 0 : this.jsonData.categories && this.jsonData.categories[0] && this.jsonData.categories[0].category,
                        n = a.getCategoryLen(), d = d.numDisplaySets,
                        n = a.getCategoryLen();
                ...
                _realTimeValuePositioning: function (a) {
                    ...
                    n = this.config;
                    var u = n.realTimeConfig || (n.realTimeConfig = {}), f = u.realTimeValuePadding,
                        b = b.xAxis[0].config, r = b.trend.trendStyle, b = u.style = {
                ...
                _drawRealTimeValue: function () {
                    var c = this.components, b = this.config, d = c.dataset, e = c.paper,
                        n = this.linkedItems.smartLabel, f = b.realTimeConfig, r = f.realtimeValueSeparator,
                        u = d.length, k = a, p = this.get(K, N), C = p.animObj, v = p.dummyObj, p = p.duration,
                        l = f.canvasBottom, D = f.height,
                        G = b.canvasLeft, m = b.canvasRight, h = f.style || {},
                        c = c.realTimeValue || (c.realTimeValue = {}), w = c.graphics, q = this.graphics,
                        z = q.parentGroup, A = q.realTimeValueGroup, x;
                    f.clear && c.graphics && c.graphics.attr({text: a});
                    if (A) {
                        for (f = 0; f < u; f++) q = d[f].components.data, q = (q = q[q.length - 1]) && q.config.displayValue, k += q ? void 0 === q ? a : q + r : a;
                        ...
                        w.attr({text: k, fill: h.color});
                        w && !x && (w.show(), w.animateWith(v, C, b, p))
                    } else q.realTimeValueGroup = e.group("realTimeValue", z).insertBefore(q.datalabelsGroup)
                },
                ...
                _getData: function () {
                    var a = this.components, b = a.dataset, a = a.xAxis && a.xAxis[0] || a.scale, d, e, n, f = [],
                        r = 0, u, k;
                    if (b) {
                        d = b.length;
                        for (e = 0; e < d; e++) r = E(r, b[e].components.data.length);
                        for (e = 0; e < r; e++) for (k = f[e] = [], k[0] = a.getLabel(e).label, n = 1; n <= d; n++) u = b[n - 1].components.data[e], k[n] = u && u.config.setValue;
                        return f
                    }
                },
                _setData: function (c, b) {
                    var d = a;
                    if (c && c.toString || c === a || 0 === c) d = "value=" + c.toString();
                    if (b && b.toString || b === a) d = d + "&label=" + b.toString();
                    d && this.feedData(d)
                },
                _stopUpdate: function (a) {
                    var d = this.config.realTimeConfig,
                        g = this.linkedItems.timers && this.linkedItems.timers.setTimeout.loadData,
                        e = this.chartInstance, n = e.__state;
                    clearTimeout(n._toRealtime);
                    n._rtAjaxObj && n._rtAjaxObj.abort();
                    n._rtPaused = !0;
                    g && clearTimeout(g);
                    d.clearIntervalFlag = !1;
                    b.raiseEvent("realimeUpdateStopped", {source: a}, e)
                },
                ...
                _getDataJSON: function () {
                    return this.config.realTimeConfig.legacyUpdateObj || {values: []}
                },
                _setRTdata: function () {
                    var a = this.components.dataset, b, d, e, n, f, r;
                    for (b = a.length; b--;) e = a[b], e = e.components, d = e.removeDataArr || [], n = d.length, f = e.data, r = f.length, d = [].concat(d, f.slice(n, r)), e.dataRT = d
                },
                eiMethods: {
                    feedData: function () {
                        var a =
                            this.apiInstance, b = a.getJobList(), d = arguments[1], e, n;
                        if (a.chartInstance.args.asyncRender || d) e = arguments[0], b.eiMethods.push(Z.addJob(function () {
                            n = a.feedData.call(a, e);
                            "function" === typeof d && d(n)
                        }, S.postRender)); else return a.feedData.apply(a, arguments)
                    }, setData: function () {
    ...
    E.register("module", ["private", "modules.renderer.js-realtimestackedcolumn", function () {
        ...
        b("realtimestackedcolumn",
            {}, b.realtimecolumn, {isstacked: !0, enablemousetracking: !0})
    }]);
    E.register("module", ["private", "modules.renderer.js-gaugebase", function () {
        var b = this.hcLib, k = !b.CREDIT_REGEX.test(this.window.location.hostname), d = b.chartAPI, a = b.extend2,
            b = a({}, b.defaultGaugePaletteOptions);
        d("gaugebase", {
            creaditLabel: k,
            ...
            realTimeUpdate: function (a) {
                ...
                var u = this.config.realTimeConfig = this.config.realTimeConfig || (this.config.realTimeConfig = {}), e,
                    k, E;
                if (b) {
                    E = d[0];
                    d = E.data;
                    k = 0;
                    for (e = d.length; k < e; k++) d[k].label = a[k] && a[k].label;
                    b[0].updateData(E);
    ...
    E.register("module", ["private", "modules.renderer.js-axisgaugebase",
        function () {
            ...
            k("axisgaugebase", {
                ...
                _feedAxesRawData: function () {
                    var n = this.components, u = n.colorManager, e = this.jsonData, k = e.chart,
                        E = b.chartPaletteStr.chart2D,
                        J = a(k.ticksbelowgauge), K = a(k.ticksonright),
                        J = a(k.axisontop, void 0 !== k.axisonleft ? !a(k.axisonleft) : void 0, void 0 !== J ? !J : void 0, void 0 !== K ? K : void 0, this.isAxisOpposite),
                        K = a(k.reverseaxis, this.isAxisReverse), I = a(k.showtickmarks, 1), G = a(k.showtickvalues),
                        I = G || void 0 === G ? I || void 0 !== G ? !0 : !1 : !1, u = {
                ...
                _setAxisLimits: function () {
                    ...
                    this.colorRange && e.setAxisConfig({
                        lowerlimit: a(d.lowerlimit, b.forceMin ? b.min : void 0), upperlimit: a(d.upperlimit,
                            b.forceMax ? b.max : void 0)
                    });
                    e.setDataLimit(b.max, b.min)
                },
                _spaceManager: function () {
                    var b, d = this.config, e = this.components, k = e.dataset[0], e = e.scale, n = this.jsonData.chart,
                        E = a(n.showborder, this.is3D ? 0 : 1), K = this.isHorizontal, I = d.minChartWidth,
                        G = d.minChartHeight, n = d.borderWidth = E ? a(n.borderthickness, 1) : 0, L;
                    d.canvasWidth - 2 * n < I && (b = (d.canvasWidth - I) / 2);
                    d.canvasHeight - 2 * n < G && (L = (d.canvasHeight - G) / 2);
                    this._allocateSpace({top: L || n, bottom: L || n, left: b || n, right: b || n});
                    ...
                    e.setAxisConfig({drawPlotlines: this.drawPlotlines, drawPlotBands: this.drawPlotBands})
                },
                _postSpaceManagement: function () {
                    var a = this.config, b = this.components.scale;
                    this.isHorizontal ? b.setAxisDimention({axisLength: a.canvasWidth}) :
                        b.setAxisDimention({axisLength: a.canvasHeight})
                },
                _getDataJSON: function () {
                    var a = 0, b, d, k = [], E = [], L = [], K = this.components.dataset[0].components.data;
                    for (b = K && K.length ? K.length : 0; a < b; a += 1) d = K[a].config, k.push(d.itemValue), E.push(d.formatedVal || n), L.push(d.toolText || n);
                    return {values: k, labels: E, toolTexts: L}
                }
            }, k.gaugebase)
        }]);
    E.register("module", ["private", "modules.renderer.js-funnelpyramidbase", function () {
        var b = this.hcLib, k = b.chartAPI, d = b.preDefStr, a = b.Raphael, n = d.configStr, E = d.ROUND,
            D = d.animationObjStr;
        k("funnelpyramidbase", {
            showRTvalue: !1,
            canvasPadding: !1,
            ...
            _updateVisuals: function () {
                var b = this.config, d = this.linkedItems.container, k = this.components,
                    N = k.legend, J = k.paper, K = k.tooltip, I = this.chartInstance, G = this.get(n, D),
                    Z = G.animType, S = G.dummyObj, c = G.animObj, G = G.duration, F;
    ...
    E.register("module", ["private", "modules.renderer.js-pyramid", function () {
        ...
        b("pyramid", {
            ...
            applicableDSList: {pyramid: !0},
            useSortedData: !1
        }, b.funnelpyramidbase)
    }]);
    E.register("module",
        ["private", "modules.renderer.js-vled", function () {
            var b = this.hcLib, k = b.pluckNumber, d = !b.CREDIT_REGEX.test(this.window.location.hostname),
                b = b.chartAPI;
            b("vled", {
                showRTvalue: !1,
                canvasPadding: !1,
                ...
                colorRange: !0,
                applicableDSList: {led: !0},
                _getData: function () {
                    var a = this.components.dataset;
                    if (a && (a = a[0].components.data) && a[0]) return a = a[0].config, k(a.setValue, a.itemValue)
                },
                _createDatasets: function () {
                    var a = this.components, b = this.jsonData, d = b.value, k = b.target, u = this.defaultDatasetType,
                        e, C, b = [];
                    a.dataset || (a.dataset = []);
                    b.push({value: d, target: k});
                    d = {data: b};
    ...
    E.register("module", ["private",
        "modules.renderer.js-vbullet", function () {
            var b = this.hcLib, k = b.pluck, d = b.pluckNumber, a = b.chartAPI, n = b.pluckFontSize,
                L = !b.CREDIT_REGEX.test(this.window.location.hostname);
            a("vbullet", {
                ...
                _feedAxesRawData: function () {
                    var a = this.components,
                        u = a.colorManager, e = this.jsonData.chart, C = b.chartPaletteStr.chart2D,
                        E = d(e.ticksbelowgraph, 1),
                        E = d(e.ticksonright, e.axisontop, void 0 !== e.axisonleft ? !d(e.axisonleft) : void 0, !E, this.isAxisOpposite),
                        u = {
    ...
    E.register("module", ["private", "modules.renderer.js-hlineargauge", function () {
        var b = this.hcLib, k = b.pluck, d = b.getValidValue, a = b.BLANKSTRING, n = b.getDashStyle,
            L = b.getFirstValue, D = b.parseUnsafeString, u = b.preDefStr, e = u.animationObjStr, C = u.configStr,
            N = b.pluckNumber, J = b.getFirstDefinedValue, K = b.graphics.convertColor, I = b.getColorCodeString,
            G = b.COMMASTRING, Z = Math.max, S = b.toRaphaelColor, c = b.priorityList, F = b.schedular,
            g = u.POSITION_TOP, H = u.POSITION_BOTTOM,
        ...
        B("hlineargauge", {
            ...
            isRealTime: !0,
            colorRange: !0,
            applicableDSList: {hlineargauge: !0},
            rtParserModify: !0,
            _drawCanvas: function () {
                var a = this.components, b = this.config, c = this.graphics.datasetGroup,
                    d = b.canvasWidth, p = b.canvasHeight, n = b.canvasTop, v = b.canvasLeft, l = a.scale,
                    u = l.config.axisRange.min, F = l.config.axisRange.max, m = this.jsonData, l = m.chart,
                    h = m.trendpoints && m.trendpoints.point, m = N(l.showgaugeborder, 1),
                    w = J(l.colorrangefillmix, l.gaugefillmix, "{light-10},{dark-20},{light-50},{light-85}"),
                    q = J(l.colorrangefillratio, l.gaugefillratio, l.gaugefillratio, "0,8,84,8"),
                    B = k(l.colorrangebordercolor, l.gaugebordercolor, "{dark-20}"),
                    A = N(l.colorrangeborderalpha, l.gaugeborderalpha, 100), x = m ? N(l.colorrangeborderthickness,
                    l.gaugeborderthickness, 1) : 0, D = a.colorRange && a.colorRange.getColorRangeArr(u, F),
                    E = N(l.showshadow, 1), t, L, ma, R, Aa = a.paper, Q = a.colorManager, ya, ua, M,
                    l = this.get(C, e), Ba = l.duration, za = l.dummyObj, fa = l.animObj, sa = l.animType,
                    ha = {top: 1, bottom: 3}, da = l = 0, m = 0, a = a.canvas.graphics;
                ...
                a.outerRect.attr({x: 0, y: 0, width: d, height: p, stroke: "none", r: 0});
                t = function (a, b) {
                    return {x: a * d / (F - u), y: 0, width: (b - a) * d / (F - u), height: p}
                };
                a.colorRangeElems || (a.colorRangeElems = []);
                c = 0;
                for (v = D && D.length; c < v; c += 1) ma = D[c], R = t(ma.minvalue - u, ma.maxvalue - u), ma.x = R.x, ma.y = R.y, ma.width = R.width, ma.height = R.height, L = ma.code, L = K(I(k(ma.bordercolor, L), B), N(ma.borderalpha, A)), ya = Q.parseColorMix(ma.code, w), ua = Q.parseAlphaList(ma.alpha, ya.length), M = N(ma.borderAlpha, A), ma =
                    ...
                    stroke: L,
                    fill: S({FCcolor: {color: ya.toString(), ratio: q, alpha: ua, angle: 270}})
                }), R.animateWith(za, fa, M, Ba, sa), R.shadow({apply: E, opacity: ma / 100}), R.show();
                for (; a.colorRangeElems[c];) a.colorRangeElems[c].shadow(!1), a.colorRangeElems[c].hide(), c++;
                if (h) for (b = b.trendPointConfig, a.trendObjElems || (a.trendObjElems =
                    []), a.trendZoneElems || (a.trendZoneElems = []), a.marker || (a.marker = []), c = 0, v = b.length; c < v; c += 1) h = b[c], R = t(h.startValue - u, h.endValue - u), h.isTrendZone ? ((w = a.trendZoneElems[l]) || (w = a.trendZoneElems[l] = Aa.rect({height: 0 < R.height ? R.height : 0}, n)), w.attr({
                    fill: S({
                        FCcolor: {
                            color: h.color,
                            alpha: h.alpha
                    ...
                    }), w.animateWith(za, fa, {path: ["M", R.x, R.y, "L", R.x, R.y + R.height]}, Ba, sa).tooltip(h.tooltext), w.show(), da++), h.useMarker && (h.showOnTop ? (q = H, w = 0) : (q = g, w = p), B = 90 * ha[q], (q = a.marker[m]) || (a.marker[m] = q = Aa.polypath(n)), q.attr({
                    fill: h.markerColor,
                    stroke: h.markerBorderColor
                }), q.animateWith(za, fa, {
                    polypath: [3, R.x, w, h.markerRadius, B, 0],
                    "stroke-width": 1
                }, Ba, sa).shadow({apply: E}).tooltip(h.tooltext), q.show(), m++);
                if (E = a.trendObjElems) for (; E[da];) E[da].hide(),
                    da++;
                if (E = a.trendZoneElems) for (; E[l];) E[l].hide(), l++;
                if (q = a.marker) for (; q[m];) q[m].hide(), q[m].shadow(!1), m++
            },
            _configueTrendPoints: function () {
                var c = this.jsonData, g = this.config, e = g.style, u = c.trendpoints && c.trendpoints.point, p,
                    H = this.components, v = H.scale.config, l = v.axisRange, F = l.max, B = l.min,
                    v = v.scaleFactor || 1, m = H.colorManager, h, w, q, G = g.trendPointConfig = [], c = c.chart,
                    A = u.length;
                e.trendStyle = {fontFamily: e.outCanfontFamily, color: e.outCancolor, fontSize: e.outCanfontSize};
                for (p = 0; p < A; p++) e = u[p], h = N(e.startvalue,
            ...
            _getData: function (a, b) {
                ...
                if (d) if ("function" === typeof b) k.eiMethods.push(F.addJob(function () {
                    b(n())
                }, c.postRender));
                else return n()
            },
            ...
            _getDataForId: function (a, b) {
                ...
                if ("function" === typeof b) g.eiMethods.push(F.addJob(function () {
                    b(d && d[a] && d[a].config.itemValue || null)
                }, c.postRender)); else return d && d[a] && d[a].config.itemValue || null
            },
    ...
    E.register("module", ["private", "modules.renderer.js-hbullet", function () {
        var b = this.hcLib, k = b.pluck, d = b.pluckNumber, a = b.parseUnsafeString,
            n = !b.CREDIT_REGEX.test(this.window.location.hostname), E = b.chartAPI, D = b.BLANKSTRING, b = b.preDefStr,
            u = b.POSITION_START, e = b.POSITION_END, C = b.POSITION_BOTTOM, N = b.POSITION_MIDDLE, b = Math,
            J = b.ceil, K = b.max;
        E("hbullet", {
            ...
            _RTmanageSpace: function () {
                var a = this.config, b = this.components, d = b.scale,
                    b = b.dataset[0]._manageSpaceHorizontal(.7 * a.oriCanvasWidth);
                this._allocateSpace({right: b.right - a.labelSpace.right});
                d.setAxisDimention({axisLength: a.canvasWidth});
                a.labelSpace = b
            },
            _spaceManager: function () {
                var a, b = this.config, e = this.components, k = e.dataset[0], c = e.scale, n = this.jsonData.chart,
                    g = d(n.showborder, this.is3D ? 0 : 1), u, B = b.minChartWidth,
                ...
                this._allocateSpace({top: a || n, bottom: a || n, left: u || n, right: u || n});
                a = .7 * b.canvasWidth;
            ...
            _manageCaptionSpacing: function () {
                var b = this.config, n = this.components, C = n.caption, E = n.subCaption, n = C.config, c = E.config,
                    C = C.components, E = E.components, F = this.jsonData.chart, g = this.linkedItems.smartLabel,
                    H = a(F.caption), B = a(F.subcaption), F = d(F.captionpadding, 2), f = b.height, r = 0, y = 0,
                    K = 0, p = .7 * b.width, L = {}, v, l;
            ...
            _manageCaptionPosition: function () {
                var a = this.config, b = this.components, d = b.caption.config, b = b.subCaption.config,
                    e = d.captionPosition, c = K(d.width, b.width), k = a.borderWidth || 0, g = d.captionSubCaptionGap;
                switch (e) {
                    case N:
    ...
    E.register("module", ["private", "modules.renderer.js-thermometer", function () {
        var b = this.hcLib, k = b.chartAPI, d = b.pluck, a = b.pluckNumber,
            n = !b.CREDIT_REGEX.test(this.window.location.hostname), L = b.preDefStr, D = b.HUNDREDSTRING,
            u = b.graphics.convertColor, e = L.gaugeFillColorStr, C = L.gaugeBorderColorStr,
            N = b.graphics.getLightColor,
            J = function (a) {
                return void 0 !== a && null !== a
            }, L = b.extend2;
        k("thermometer", {
            ...
            isAxisReverse: !1,
            isRealTime: !0,
            applicableDSList: {thermometer: !0},
            _getData: function () {
                var a = this.components.dataset;
                if (a && a[0]) return a[0].config.value
            },
            _parseSpecialConfig: function () {
                var b = this.config, k = this.jsonData.chart, n = this.components, E = n.numberFormatter,
                    n = n.colorManager;
            ...
            _createDatasets: function () {
                ...
                var d = {data: [{value: this.jsonData.value}]}, a = a.dataset || (a.dataset = []);
    ...
    E.register("module", ["private", "modules.renderer.js-cylinder",
        function () {
            var b = this.hcLib, k = b.HUNDREDSTRING, d = b.pluck, a = b.pluckNumber, n = b.extend2,
                E = b.graphics.getLightColor, D = b.graphics.convertColor, u = b.chartAPI, e = b.preDefStr,
                C = e.colors.FFFFFF, N = e.gaugeFillColorStr, J = e.gaugeBorderColorStr, K = function (a) {
                    return void 0 !== a && null !== a
                };
            u("cylinder", {
                defaultDatasetType: "cylinder",
                applicableDSList: {cylinder: !0},
                defaultPaletteOptions: function (a, b) {
                    var d;
                    a || (a = {});
                    for (d in b) a[d] = b[d];
                ...
                glasscolor: C,
                _parseSpecialConfig: function () {
                    var b = this.config, e = this.jsonData.chart, n = this.components, u = n.numberFormatter,
                        n = n.colorManager;
                    ...
                    if (50 < b.gaugeYScale || 0 > b.gaugeYScale) b.gaugeYScale = 30;
                    b.gaugeYScale /= 100;
                    b.showGaugeBorder =
    ...
    E.register("module", ["private", "modules.renderer.js-angulargauge", function () {
        var b = this.hcLib, k = b.pluck, d = b.getValidValue, a = b.BLANKSTRING, n = b.preDefStr, L = n.animationObjStr,
            D = n.configStr, u = b.pluckNumber, e = b.graphics.convertColor, C = b.COMMASTRING,
            n = Math, N = n.max, J = n.min, K = n.PI / 180, I = b.toRaphaelColor,
            n = !b.CREDIT_REGEX.test(this.window.location.hostname), G = b.chartAPI, Z = b.extend2, S = b.pluckFontSize;
        G("angulargauge", {
            ...
            rtParserModify: !0,
            applicableDSList: {angulargauge: !0},
            _spaceManager: function () {
                var b, e, g = this.config, k = this.components,
                    n = k.scale.config, f = k.dataset[0];
                b = f.components.data[0];
                var k = k.scale, r = f.chart.jsonData.chart, f = f.config, y = f.scaleFactor, D = 0, p = 0, E = D = 0,
                    v = 0, v = f.pivotRadius, l = g.dataLabels.style.fontSize, D = g.dataLabels.style.lineHeight,
                    E = g.displayValueCount, C = g.borderWidth, G = g.minChartWidth, m = g.minChartHeight, v = 0, h;
                g.canvasWidth - 2 * C < G && (e = (g.canvasWidth - G) / 2);
                g.canvasHeight - 2 * C < m && (h = (g.canvasHeight - m) / 2);
                this._allocateSpace({top: h || C, bottom: h || C, left: e || C, right: e || C});
            ...
            _feedAxesRawData: function () {
                var a = this.components, d = a.colorManager, g = this.jsonData, e = g.chart,
                    n = b.chartPaletteStr.chart2D,
                    f = u(e.axisontop, e.axisonleft, void 0 !== e.ticksbelowgauge ? !e.ticksbelowgauge : void 0, this.isAxisOpposite),
                    r = u(e.reverseaxis,
            ...
            _drawCanvas: function () {
                var a = this.components, b = a.dataset[0], d = b.config, b = b.graphics || (b.graphics = {}),
                    n = a.scale, B = a.colorManager, f = n.config.axisRange, r = a.colorRange,
                    y = this.graphics.datasetGroup, E = this.graphics.datalabelsGroup, a = a.paper,
                    p = d.gaugeOuterRadius, G = d.gaugeInnerRadius, v = d.gaugeFillRatio, l = d.gaugeBorderColor,
                    J = d.gaugeBorderThickness, K = d.gaugeBorderAlpha, m = d.gaugeFillMix, h = d.gaugeOriginX,
                    w = d.gaugeOriginY, q = d.gaugeStartAngle, z = d.showShadow, A = f.min, f = f.max,
                    x = r ? r.getColorRangeArr(A,
                        f) : [], S = this.get(D, L), r = S.duration, A = S.dummyObj, Z = S.animObj, S = S.animType,
                    t = 0, pa = x.length, ma, R, Aa, Q, ya, ua, M = 0;
                b.band = b.band || [];
                b.bandGroup || (b.bandGroup = a.group("bandGroup", y));
                for (b.pointGroup ? b.pointGroup.animateWith(A, Z, {transform: "t" + h + C + w}, r, S) : b.pointGroup = a.group("pointers", E).translate(h, w); t < pa; t += 1) ma = x[t], y = n.getAngle(Math.min(ma.maxvalue, f)), Aa = B.parseColorMix(ma.code, m), Q = B.parseAlphaList(ma.alpha, Aa.length), ya = B.parseRatioList(G / p * 100 + v, Aa.length), ua = ma.bordercolor, R = u(ma.borderAlpha,
                    K), ua = ua && -1 == ua.indexOf("{") ? e(ua, R) : B.parseColorMix(ma.code, k(ua, l))[0], ua = e(ua, R), ma = Q.split(C), ma = N.apply(Math, ma), ma = z ? N(J && R || 0, ma) : 0, R = y, q > y && (q += y, y = q - y, q -= y), b.band[t] ? b.band[t].animateWith(A, Z, {ringpath: [h, w, p, G, q, y]}, r, S) : b.band[t] = a.ringpath(h, w, p, G, q, y, b.bandGroup), b.band[t].attr({
                    fill: I({
                        FCcolor: {
                            cx: h,
                            cy: w,
                    ...
                    }), "stroke-width": J, stroke: ua
                }).shadow({apply: z, opacity: ma / 100}), q = R, M += 1;
                t = M;
                for (pa = b.band.length; t <
                pa; t += 1) b.band[t].attr({ringpath: [0, 0, 0, 0, 0]});
                ...
                b.pivot ? b.pivot.animateWith(A, Z, {
                    ...
                    cy: w,
                    r: d.pivotRadius
                }, r, S) : (b.pivot = a.circle(E), b.pivot.attr({cx: h, cy: w, r: d.pivotRadius}));
                b.pivot.attr({
                    fill: I({FCcolor: n}), "stroke-width": d.pivotBorderThickness,
            ...
            _angularGaugeSpaceManager: function (a,
                                                 b, d, e, k, f, n, u, D, p) {
                var E = void 0 !== k && null !== k, v = void 0 !== f && null !== f, l = void 0 !== n && null !== n,
                    C = 2 * Math.PI, G = Math.PI, m = Math.PI / 2, h = G + m, w;
                k = {radius: k, centerX: f, centerY: n};
                ...
                if (!E || !v || !l) {
                    ...
                    if (a > C || 0 > a) A = 1;
                    if (0 < b) {
                        if (t < m && a > m || a > C + m) x = 1;
                        if (t < G && a > G || a > C + G) q = -1;
                        if (t < h && a > h ||
                            a > C + h) z = -1
                    } else {
                        if (t > m && a < m || a < -h) x = 1;
    ...
    E.register("module", ["private", "modules.renderer.js-bulb", function () {
        ...
        d("bulb", {
            ...
            applicableDSList: {bulb: !0},
            creditLabel: k,
            _createDatasets: function () {
                var a = this.components, b;
                b = this.defaultDatasetType;
                var d = [], k;
                d.push({value: this.jsonData.value});
                k = {data: d};
            ...
            _spaceManager: function () {
                ...
                b = this.config;
                var k = this.components, u = k.legend, k = k.dataset[0], e = k.config, C = this.jsonData.chart,
                    E = a(C.showborder, this.is3D ? 0 : 1), J, K, I = b.minChartWidth, G = b.minChartHeight,
                    C = b.borderWidth = E ? a(C.borderthickness,
                        1) : 0;
                ...
                this._allocateSpace({top: J || C, bottom: J || C, left: K || C, right: K || C});
                this._allocateSpace(this._manageActionBarSpace && this._manageActionBarSpace(.225 * b.availableHeight) || {});
                b = .7 * b.canvasHeight;
    ...
    E.register("module", ["private", "modules.renderer.js-progressgauge", function () {
        ...
        k("progressgauge", {
            ...
            applicableDSList: {progressgauge: !0},
            _createDatasets: function () {
                var b = this.components, a = b.legend, k = this.jsonData, L = k.dataset, D = k.data || L && L[0].data,
                    u = this.defaultDatasetType, e, C, L = this._dataSegregator(D);
                this.config.categories = L.data;
                k = b.dataset || (b.dataset = []);
                if (!D || 0 === D.length) this.setChartMessage(); else if (u && (C = E.get("component", ["dataset", u]))) if (D =
                    ...
                    if (D > C) {
                        if (a) for (u = C; u < D; u++) b[u] && b[u].legendItemId && a.removeItem(b[u].legendItemId);
                        k[0].removeData(C, D - C, !1)
                    }
                    k[0].JSONData = L;
                    k[0].configure()
                } else a = new C, k.push(a), a.chart = this, u && u.addDataSet(a, 0, 0), a.index = 0, a.init(L)
            },
    ...
    E.register("module", ["private", "modules.renderer.js-drawingpad", function () {
        var b = this.hcLib, k = b.Raphael, d = b.preDefStr, a = d.animationObjStr, n = d.configStr, E = d.ROUND,
            d = d.colors.FFFFFF, D = !b.CREDIT_REGEX.test(this.window.location.hostname), b = b.chartAPI;
        b("drawingpad", {
            standaloneInit: !0,
            ...
            bgAlpha: "100",
            draw: function () {
                var b = this.config, d = this.linkedItems.container, C = this.chartInstance, D = this.components,
                    J = D.paper, K = this.get(n, a), I = K.animType, G = K.dummyObj, Z =
    ...
    E.register("module", ["private", "modules.renderer.js-realtimearea", function () {
        ...
        b("realtimearea", {
            ...
            axisPaddingLeft: 0,
            axisPaddingRight: 0,
            applicableDSList: {realtimearea: !0}
        }, b.realtimecolumn, {enablemousetracking: !0}, b.areabase)
    }]);
    E.register("module", ["private", "modules.renderer.js-realtimestackedarea",
        function () {
            ...
            b("realtimestackedarea", {
                defaultDatasetType: "realtimearea",
                applicableDSList: {realtimearea: !0}
            }, b.realtimearea, {isstacked: !0, enablemousetracking: !0})
        }]);
    E.register("module", ["private", "modules.renderer.js-realtimeline", function () {
        ...
        b("realtimeline", {
            ...
            axisPaddingLeft: 0,
            axisPaddingRight: 0,
            applicableDSList: {realtimeline: !0},
            zeroplanethickness: 1,
            zeroplanealpha: 40,
            showzeroplaneontop: 0
        }, b.realtimecolumn, {
            zeroplanethickness: 1,
            zeroplanealpha: 40, showzeroplaneontop: 0, enablemousetracking: !0
        }, b.areabase)
    }]);
