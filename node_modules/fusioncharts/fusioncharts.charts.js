...
(function (B) {
    ...
    B.register("module", ["private", "modules.renderer.js-charts", function () {
        B.register("module", ["private", "modules.renderer.js-column2d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
            a("column2d", {
                    standaloneInit: !0,
        ...
        B.register("module", ["private", "modules.renderer.js-column3d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
            a("column3d", {
            ...
            }, a.sscartesian3d, {showplotborder: 0, enablemousetracking: !0})
        }]);
        B.register("module",
            ["private", "modules.renderer.js-bar2d", function () {
                var a = this.hcLib, b = a.chartAPI, a = !a.CREDIT_REGEX.test(this.window.location.hostname);
                b("bar2d", {
                ...
                }, b.ssbarcartesian, {enablemousetracking: !0})
            }]);
        B.register("module", ["private", "modules.renderer.js-bar3d", function () {
            ...
            a("bar3d", {
                ...
                singleseries: !0,
                defaultZeroPlaneHighlighted: !1
            }, a.ssbarcartesian3d, {showplotborder: 0, enablemousetracking: !0})
        }]);
        B.register("module", ["private", "modules.renderer.js-area2d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
            a("area2d", {
                friendlyName: "Area Chart", standaloneInit: !0,
                creditLabel: b, defaultDatasetType: "area", singleseries: !0, defaultPlotShadow: 0
        ...
        B.register("module", ["private", "modules.renderer.js-line", function () {
            ...
            b("line", {
                ...
                zeroplanealpha: 40, showzeroplaneontop: 0
            }, b.areabase)
        }]);
        B.register("module", ["private", "modules.renderer.js-pareto2d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), m = a.chartAPI, C = a.pluck,
                p = a.pluckNumber, K = a.componentDispose;
            m("pareto2d", {
                defaultDatasetType: "column2d", singleseries: !0, creditLabel: b, _createDatasets: function () {
                    var a = this.components, b = this.jsonData, h = this.is3D, x = a.numberFormatter,
                        l = b.data || b.dataset && b.dataset[0] && b.dataset[0].data, f = l && l.length, q = b.chart,
                        y = this.defaultDatasetType, b = new (B.get("component", ["dataset", "Pareto"])),
                        G = p(q.showcumulativeline, 1), L = [], k, t;
                    if (l) {
                        ...
                        if (G) a && a.setAxisConfig({
                            ...
                            drawTrendLines: !0,
                            drawTrendLabels: !0
                        }), a.show(), f = B.get("component", ["dataset", "line"]), (h = x[1]) ? (y = L.length, l = h.components.data.length, y < l && h.removeData(y, l - y), h.JSONData = {data: L}, b.configure.call(h)) :
                            (h = new f, x.push(h), h.chart = this, h.index = q, b.init(h, L, "line")); else {
                            if (h = x[1]) K.call(h), x.pop();
                            a && (a.setAxisConfig({
                                drawLabels: !1,
                                drawPlotLines: !1,
                                drawAxisName: !1,
                    ...
                    var a = this.components, b = this.jsonData, h = b.dataset, x = a.numberFormatter, a = a.xAxis,
                        b = b.data || h && h[0].data || [], h = [], l, f = b.length, q, y = {}, G = 0, L;
                    for (q = 0; q < f; q++) {
                        l = b[q];
                        L = x.getCleanValue(l.value, !0);
                        if ("true" ===
                            l.vline || "1" === l.vline || 1 === l.vline || !0 === l.vline) y[G] = l; else if (null === L) continue; else l.value = L, h.push(l);
                        G++
                    }
                    h.sort(function (a, f) {
                    ...
                    a[0].setCategory(h)
                }, standaloneInit: !0, hasLegend: !1, isPercentage: !0
        ...
        B.register("module", ["private", "modules.renderer.js-pareto3d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), m = a.chartAPI;
            m("pareto3d", {
                standaloneInit: !0,
                is3D: !0,
        ...
        B.register("module", ["private", "modules.renderer.js-pie2d", function () {
            var a = this, b = a.hcLib, m = b.hasTouch, C = a.window, p = C.document, K = b.BLANKSTRING,
                N = b.pluck, Q = b.pluckNumber, h = b.toRaphaelColor, x = "createTouch" in p,
                l = x && !(C.navigator.maxTouchPoints || C.navigator.msMaxTouchPoints), f = b.each,
                q = b.plotEventHandler, y = b.schedular, G = b.priorityList,
                L = 8 === C.document.documentMode ? "visible" : "", k = Math, t = k.sin, E = k.cos, v = k.round,
                z = k.atan2, Y = k.min, ka = k.max, ea = k.abs, B = k.PI, ia = k.ceil, ra = k.floor, sa = B / 180,
                na = 180 / B, ma = Math.PI, U = ma / 2, ba = 2 * ma, Aa = ma + U, ua = b.graphics.convertColor,
                P = b.POSITION_BOTTOM, fa = b.POSITION_RIGHT, B = b.chartAPI, qa = b.COMMASTRING, wa = b.ZEROSTRING,
                ta = b.ONESTRING,
                b = !b.CREDIT_REGEX.test(C.location.hostname), xa = function (a, r, e, c, d) {
                    return z((r - e[1] - c.top) / d, a - e[0] - c.left)
                };
            B("pie2d", {
                ...
                _plotDragMove: function (f, r) {
                    var e = r[0], c = r[1], d = r[2], n = r[3], g = this.data("plotItem"), ga =
                ...
                _plotDragStart: function (a, r) {
                    var e = r[0], c = r[1], d = this.data("plotItem"), n = d.chart, d = d.seriesData,
                        g = n.components.dataset[0].config, ga = -g.startAngle;
                    ...
                    if (g.enableRotation && !d.isRightClicked) {
                        ...
                        if (g.getBoundingClientRect) g = g.getBoundingClientRect(), n.top = g.top + (C.pageYOffset || p.scrollTop || 0) - (p.clientTop || 0), n.left = g.left + (C.pageXOffset || p.scrollLeft || 0) - (p.clientLeft ||
                            0); else for (; g;) n.left += g.offsetLeft || 0, n.top += g.offsetTop || 0, g !== p.body && g !== p.documentElement && (n.left -= g.scrollLeft || 0, n.top -= g.scrollTop || 0), g = g.offsetParent;
                        d.chartPosition = n;
                ...
                _plotDragEnd: function (f) {
                    var r, e = this.data("plotItem"), c = e.chart, d = c.config, n = d.linkedChartOpened,
                        g = e.seriesData;
                    g.isRightClicked || (d.clicked = !0, c.disposed || n || c._rotate(), !g.isRotating && c._plotGraphicClick.call(e.graphic, f),
                        delete d.clicked, g.isRotating && (setTimeout(function () {
                        g.isRotating = !1
                    }, 0), a.raiseEvent("RotationEnd", {
                        startingAngle: r = c._startingAngle(),
                        changeInAngle: r - g._rotationalStartAngle
                    }, c.chartInstance)))
                },
                _plotRollOver: function (a) {
                    var r = this.plotItem || this.data("plotItem"), e = r.chart, c = e.components.dataset[0].config, d,
                        n;
                ...
                onPlotHover: function (a, r) {
                    var e = a.data("plotItem"), c = e.center, d = e.rolloverProperties || {}, n = r ? d.color : e.color,
                        g = r ? d.borderWidth : e.borderWidth, ga = r ? d.borderColor : e.borderColor;
                    n && (r && (n.cx = c[0], n.cy = c[1], n.r = e.radius), d.enabled && e.graphic.attr({
                        fill: h(n),
                        "stroke-width": g,
                        stroke: ga
                    }))
                ...
                _rotate: function () {
                    var a, r, e = this.components.dataset[0], c = e.config, d = e.components.data, n = this.config,
                        g = c.slicingDistance, e = e.config, ga = ba / e.valueTotal,
                        T = n.canvasLeft + .5 * n.canvasWidth, n = n.canvasTop + .5 * n.canvasHeight,
                        w = c.pieMinRadius, V = .5 * (c.piePlotOptions.innerSize || 0), S, ca, F, f, u;
                    S = (c.startAngle || 0) % ba;
                    for (u = 0; u < d.length; u += 1) F = d[u].config, f = d[u].graphics, a = F.y, null !==
                    a && void 0 !== a && (ca = S, S -= e.singletonCase ? ba : a * ga, a = .5 * (S + ca), F.angle = a, F.transX = E(a) * g, F.transY = t(a) * g, F.slicedTranslation = "t" + E(a) * g + qa + t(a) * g, (r = F._rotateAttrs) || (r = F._rotateAttrs = {
                        ringpath: [],
                        transform: K
                    }), a = r.ringpath, a[0] = T, a[1] = n, a[2] = w, a[3] = V, a[4] = S, a[5] = ca, r.transform = F.sliced ? F.slicedTranslation : K, f.element.attr(r));
                    this.placeDataLabels(!0, d, c)
                },
                getPlotData: function (a, r) {
                    var e = this.components.dataset[0], c = e.components.data[a].config,
                        e = e.config.userData || (e.config.userData = []), d, n;
                    if (e[a]) e =
                        e[a]; else {
                        e = e[a] = {};
                        for (n in c) "object" !== typeof(d = c[n]) && "function" !== typeof d && 0 !== n.indexOf("_") && (e[n] = d);
                        e.value = e.y;
                ...
                _plotGraphicClick: function (f) {
                    var r,
                        e = this.element || this, c = e.plotItem || e.data("plotItem"), d = e.data("eventArgs") || {},
                        n = c.chart, g = c.index, ga = n.components.dataset[0], T = n.config, w = ga.config,
                        V = w.enableMultiSlicing, S = ga.components.data[g], ca = ga.config.labelDrawID, F = S.graphics,
                        S = S.config, b = S.doNotSlice, u;
                    r = S.slicedTranslation;
                    var k = n.get("config", "animationObj"), ga = k.duration || 200, G = k.dummyObj, L = k.animObj,
                        k = k.animType, A = e.data("eventArgs").link, A = A && A.split(/\s*[\-\:]\s*/)[0].toLowerCase();
                    !w.isRotating && f && q.call(e, n, f);
                    if (!(w.isRotating ||
                        w.singletonCase || b)) if ("newchart" === A || "newmap" === A) T.linkedChartOpened = !0, ca && y.removeJob(ca); else if (T.linkedChartOpened = !1, f = !V && n.sliceInOtherPies(g), !(u = S.sliced) || !f) {
                        if (x && !l) {
                            f = (new Date).getTime();
                            if (c.lastSliceTimeStamp && 400 > f - c.lastSliceTimeStamp) return;
                        ...
                        a.raiseEvent("slicingStart", {
                            slicedState: u,
                            dataIndex: "index" in d && d.index, data: n.getPlotData(g, u)
                        }, n.chartInstance);
                        T.animateWith(G, L, {transform: u ? "t0,0" : r}, ga, k, function () {
                        ...
                        w && w.x && ((r = w.data("textPos")) || (r = w.data("textPos", {
                            x: w.x,
                            y: w.y
                        })), w.animateWith(G, L, {x: w.x + (u ? 0 : F)}, ga, k), r.x = w.x + (u ? 0 : F));
                        V && (r = V.slice(0), r[1] += F, r[2] += f, r[4] += F, r[6] += F, c.animateWith(G, L, {path: r}, ga, k), S.connectorPath = r);
                        return e.isSliced = u = S.sliced =
                            !u
                    }
                },
                sliceInOtherPies: function (a) {
                    var r = this.components.dataset[0], e = r.components.data, c = e.length, d = 0, n;
                    for (r.enableMultiSlicing = !0; c--;) c !== a && (n = e[c]).config.sliced && ++d && this._plotGraphicClick.call(n.graphics);
                    r.enableMultiSlicing = !1;
                    return !!d
                },
                placeDataLabels: function () {
                    ...
                    }, e = ["start", "start", "end", "end"], c = [-1, 1, 1, -1], d = [1, 1, -1, -1];
                    return function (n, g, ga, T) {
                        var w = this.config, V = this.components, S = V.dataset[0],
                            ca = V.legend.config, F = ca.symbolWidth, q = ca.align, ca = ca.borderWidth, u = S.graphics,
                            b = S.config, G = w.canvasLeft, y = w.canvasTop, S = w.canvasWidth,
                            A = G + .5 * w.canvasWidth, l = y + .5 * w.canvasHeight, Ba = this.linkedItems.smartLabel,
                            ya = b.dataLabelOptions, v = ya.style, h = Q(ia(parseFloat(v.lineHeight)), 12),
                            N = 1 === g.length ? w.singletonPlaceValue : !1, x = ya.skipOverlapLabels,
                            R = ya.manageLabelOverflow, D = ya.connectorPadding, J;
                        J = T && T.metrics || [A, l, 2 * b.pieMinRadius, b.innerSize || 0];
                        var M = J[1], z = J[0];
                        T = .5 * J[2];
                        var b = [[], [], [], []], A = ga.labelsRadius =
                            T + ya.distance, Z = l = parseInt(v.fontSize, 10), W = Z / 2, D = [D, D, -D, -D];
                        ga = ga.labelsMaxInQuadrant = ra(A / Z);
                        var ya = ya.isSmartLineSlanted, H = J[3] / 2, X, O, K, p, C, m, B, P, ha, Ea, I, oa, la, va, fa;
                        J = Number.POSITIVE_INFINITY;
                        var ja, pa;
                        O = [];
                        K = [];
                        O = this.get("config", "animationObj");
                        var na = n ? 0 : O.duration || 0, qa = O.dummyObj, sa = O.animObj, ua = O.animType,
                            ta = this._plotDragMove, Sa = this._plotDragStart, Ka = this._plotDragEnd,
                            za = this._plotRollOver, aa = this._plotRollOut, wa = V.paper, xa = u.dataLabelContainer,
                            da, Ga;
                        Ba.useEllipsesOnOverflow(w.useEllipsesWhenOverflow);
                        n || Ba.setStyle(v);
                        if (1 == g.length && !H && N) O = g[0], (da = O.config._textAttrs).text && (pa = O.graphics, ja = O.config, I = pa.label, O.slicedTranslation = [G, y], da["text-anchor"] = "middle", da.x = 0, da.y = 0, da.transform = ["t", z, M], I ? I.animateWith(qa, sa, da, na, ua) : I = pa.label = wa.text(da, Ga, xa).drag(ta, Sa, Ka).hover(za, aa), I.x = z, I.data("textPos", {
                            x: z,
                            y: M
                        }).data("plotItem", da.plotItem).data("eventArgs", da.eventArgs), null !== ja.y && void 0 !== ja.y && I.show(), pa.connector && pa.connector.attr({path: []})); else if (N) fa = H + (T - H) / 2, f(g, function (e) {
                            ja =
                                e.config;
                            ...
                            for (n = g.length - 1; 0 <= n; n--) if (O = g[n], ja = O.config, da = ja._textAttrs, da.text = ja.displayValue) pa = O.graphics, null !== ja.y && void 0 !== ja.y && (I = pa.label, (Ea = pa.connector) && Ea.show(), I && I.show()), da.text = ja.displayValue, da.transform = "t0,0", ha = ja.angle % ba, 0 > ha && (ha = ba + ha), V = 0 <= ha && ha < U ? 1 : ha < ma ? 2 : ha < Aa ? 3 : 0, b[V].push({
                                point: O,
                                angle: ha
                            });
                            for (n = g = 4; n--;) {
                                if (x && (V = b[n].length - ga, 0 < V)) for (b[n].sort(a), u = b[n].splice(0, V), V = 0, N = u.length; V < N; V += 1) O = u[V].point, da = O.config._textAttrs,
                            ...
                            for (b[3].reverse(); g--;) {
                                ...
                                N = V - (N - 1) * Z;
                                J = 0;
                                for (n = u.length - 1; 0 <= n; --n, N += Z) if (O = u[n].point, ha = u[n].angle, ja = O.config, da = ja._textAttrs, da.text && (Ga = ja._textCss, pa = O.graphics, O = ja.sliced, I = pa.label, H = ea(V * t(ha)), H < J ? H = J : H > N && (H = N), J = H + Z,
                                ...
                                0 < ja.transY && (m -= Z), da.text = h.text, da.tooltip = h.tooltext), da._y = P, O && (oa = ja.transX, la = ja.transY, p += oa, H += oa, K += oa, B += la, C += oa), da["text-anchor"] = v, da.vAlign = "middle", da.x = C, da.y = m, (h = I && I.data("textPos")) ? I.attr({
                                    x: h.x,
                                    y: h.y
                                }).animateWith(qa, sa, da, na) : I = pa.label = wa.text(da, Ga, xa).drag(ta, Sa, Ka).hover(za, aa), I.x = da._x, I._x = da._x, I.y = da._y, da.tooltip && (I.tooltip(da.tooltip), delete da.tooltip), da.visibility === L && I.show(), I.data("textPos", {
                                    x: C,
                                    y: m
                                }).data("plotItem", da.plotItem).data("eventArgs", da.eventArgs),
                ...
                _spaceManager: function () {
                    var a = this.config, r = this.components, e = r.dataset[0], c = e.components.data, d = e.config,
                        n = r.legend, g = r.colorManager, ga = this.linkedItems.smartLabel, T = d.dataLabelCounter,
                        w = 0, f = this.jsonData.chart, r = Q(f.managelabeloverflow, 0), S = Q(f.slicingdistance),
                        ...
                        u = Q(f.issmartlineslanted, 1), q = T ? Q(f.labeldistance, f.nametbdistance, 5) : ca,
                        k = Q(f.smartlabelclearance, 5), G = a.width, A = a.height,
                        y = (this._manageActionBarSpace(.225 * A) || {}).bottom, G = G - (a.marginRight + a.marginLeft),
                        A = A - (a.marginTop + a.marginBottom) - (y ? y + a.marginBottom : 0), y = Y(A, G),
                        L = N(f.smartlinecolor, g.getColor("plotFillColor")), t = Q(f.smartlinealpha,
                        100), E = Q(f.smartlinethickness, .7), e = d.dataLabelOptions = e._parseDataLabelOptions(),
                        g = e.style, g = T ? Q(parseInt(g.lineHeight, 10), 12) : 0, h = 0 === F ? .15 * y : F,
                        l = 2 * h, v = {bottom: 0, right: 0}, R = d.pieYScale, y = d.pieSliceDepth;
                    e.connectorWidth = E;
                    ...
                    if (1 !== T) for (; T--;) ga.setStyle(c[T].config.style || a.dataLabelStyle), n = ga.getOriSize(c[T].config.displayValue), w = ka(w, n.width);
                ...
                _stubRadius: function (a, r, e, c, d, n, g) {
                    var ga = this.components.dataset[0], f = ga.config, w = Q(this.jsonData.chart.slicingdistance),
                        ga = f.dataLabelOptions || (f.dataLabelOptions = ga._parseDataLabelOptions()), V = 0,
                        V = Y(a / 2 - r - d, e / 2 - n) - c;
                ...
                _startingAngle: function (a, r) {
                    var e, c = this.components.dataset[0].config, d = (e = c.startAngle) * -na + (0 > -1 * e ? 360 : 0);
                ...
                eiMethods: {
                    isPlotItemSliced: function (a) {
                        var r, e, c, d = this.apiInstance;
                        return d && d.components.dataset && (c = d.components.dataset[0]) && (r = c.components.data) && r.length && r[a] && (e = r[a].config) && e.sliced
                    }, addData: function () {
                        var a, r = this.apiInstance;
                        return r && r.components.dataset && (a = r.components.dataset[0]) && a.addData.apply(a, arguments)
                    }, removeData: function () {
                        var a, r = this.apiInstance;
                        return r &&
                        ...
                        var a, r = this.apiInstance;
                        return r && r.components.dataset && (a = r.components.dataset[0]) && a.updateData.apply(a, arguments)
                    }, slicePlotItem: function (a, r, e) {
                        var c, d, n, g, ga, f = !!r, w = this.apiInstance, V = w.chartInstance.args.asyncRender,
                            S = w.getJobList();
                        ...
                        }, G.postRender)); else return w && w.components.dataset && (c = w.components.dataset[0]) && (d = c.components.data) && (g = d.length) && d[a = c.config.reversePlotOrder ? g - a - 1 : a] && (n = d[a].config) && ((f !== n.sliced || void 0 === r) && w._plotGraphicClick.call(d[a].graphics.element) || n.sliced)
                    }, centerLabel: function (a, r) {
                        var e = this.apiInstance, c = e.getJobList(), d = function () {
                            var c = e.components.dataset[0],
                                d = c.config, ga = d.piePlotOptions.innerSize, f = d.pieCenter, w = f[0], f = f[1],
                                d = d.centerLabelConfig, V;
                            if ("object" !== typeof r) r = d; else for (V in d) void 0 === r[V] && (r[V] = d[V]);
                            r.label = a;
                        ...
                        var c = this.apiInstance, d = c.chartInstance.args.asyncRender, n = c.getJobList(), g;
                        if (e || d) n.eiMethods.push(y.addJob(function () {
                            g = c._startingAngle(a,
                                r);
                            "function" === typeof e && e(g)
                        }, G.postRender)); else return c._startingAngle(a, r)
                    }
                }
            }, B.guageBase, {
        ...
        B.register("module", ["private", "modules.renderer.js-pie3d", function () {
            ...
            var b = this, m = b.hcLib, C = m.Raphael, p = m.hasTouch, K = b.window, N = m.getPosition, Q = m.pluck,
                h = m.pluckNumber, x = m.each, l = m.plotEventHandler, f = 8 === K.document.documentMode ? "visible" :
                "", q = Math, y = q.sin, G = q.cos, L = q.round, k = q.atan2, t = q.min, E = q.max, v = q.abs, z = q.PI,
                B = q.ceil, ka = q.floor, ea = Math.PI, va = ea / 2, ia = 2 * ea, ra = ea + va, sa = m.chartAPI,
                na = !m.CREDIT_REGEX.test(K.location.hostname), ma = function (r, e, c, d, n) {
                    return k((e - c[1] - d.top) / n, r - c[0] - d.left)
                }, U = m.graphics.getDarkColor, ba = m.graphics.getLightColor, Aa = m.getFirstValue,
                ua = m.graphics.convertColor, P = m.COMMASTRING, fa = m.toRaphaelColor, qa = m.hasSVG,
                wa = function (r, e) {
                    for (var c = [], d = 0, n = r.length; d < n; d++) c[d] = e.call(r[d], r[d], d, r);
                    return c
                }, ta = function (r,
                                  e) {
                    var c = e ? 360 : ia;
            ...
            sa("pie3d", {
                ...
                fireGroupEvent: !0,
                creditLabel: na,
                getPointColor: function (r) {
                    return r
                },
                _configureManager: function () {
                    var r = this.components.dataset[0], e = r.config, c = r.components, r = c.Pie3DManager, c = c.data;
                    r && r.configure(e.pieSliceDepth, 1 === c.length, e.use3DLighting, !1)
                },
                defaultPlotShadow: 0,
                _preDrawCalculate: function () {
                    var r, e, c = this.config, d = 0, n = this.components.dataset[0],
                        g = n.config;
                    r = n.components;
                    e = g.dataLabelOptions;
                    var ga = g.pie3DOptions = n._parsePie3DOptions(), f = Q(g.startAngle, 0) % ia,
                        w = g.managedPieSliceDepth, V = g.slicedOffset = ga.slicedOffset, S = c.canvasWidth,
                        ca = c.canvasHeight, F = [c.canvasLeft + .5 * S, c.canvasTop + .5 * ca - .5 * w], b, u,
                        c = r.data, k, E = t(S, ca), l, A = e.distance;
                    b = g.pieYScale;
                    var v = g.slicedOffsetY || (g.slicedOffsetY = V * g.pieYScale);
                    k = r.Pie3DManager;
                    F.push(2 * g.pieMinRadius, ga.innerSize || 0);
                    F = wa(F, function (e, c) {
                        return (l = /%$/.test(e)) ? [S, ca - w, E, E][c] * parseInt(e, 10) / 100 : e
                    });
                    F[2] /= 2;
                    F[3] /= 2;
                    F.push(F[2] * b);
                    ...
                    F.push(F[5] * b);
                    n.getX = function (e, c) {
                        u = q.asin((e - F[1]) / (F[2] + A));
                        return F[0] + (c ? -1 : 1) * G(u) * (F[2] + A)
                    };
                    g.center = F;
                    x(c, function (e) {
                        d += e.config.y
                    ...
                    for (r = c.length - 1; 0 <= r; --r) e = c[r], e = e.config, f = n, k = d ? e.y / d : 0, n = L(1E3 * (n + k * ia)) / 1E3, n > ga && (n = ga), b = n, e.shapeArgs = {
                        start: L(1E3 * f) / 1E3,
                        end: L(1E3 * b) / 1E3
                    }, e.centerAngle = u = (b + f) / 2 % ia, e.slicedTranslation = [L(G(u) * V), L(y(u) * v)], f = G(u) * F[2], g.radiusY = b = y(u) * F[4], e.tooltipPos = [F[0] + .7 * f, F[1] + b], e.percentage = 100 * k, e.total =
                        d
                },
                placeDataLabels: function () {
                    var r = function (e, c) {
                        ...
                        return e.angle - c.angle
                    }, c = ["start", "start", "end", "end"], d = [-1, 1, 1, -1], n = [1, 1, -1, -1];
                    return function (g) {
                        var a, T, w = this.config, V = this.components, S = V.dataset[0], ca = S.config,
                            F = S.components.data, b = ca.piePlotOptions, u = w.canvasLeft, k = w.canvasTop,
                            l = w.canvasWidth, N = u + .5 * w.canvasWidth, A = k + .5 * w.canvasHeight,
                            K = this.linkedItems.smartLabel, Ba = ca.dataLabelOptions, ya = Ba.style;
                        a = h(B(parseFloat(ya.lineHeight)), 12);
                        a = Aa(Ba.placeInside, !1);
                        var z = Ba.skipOverlapLabels, m = Ba.manageLabelOverflow, p = Ba.connectorPadding,
                            C = Ba.distance, R = Ba.connectorWidth, D = [[], [], [], []], J = parseInt(ya.fontSize, 10),
                            M = J, Q = M / 2, p = [p, p, -p, -p], Z = Ba.isSmartLineSlanted, W, H, X, O, ka, P, Da, Ra,
                            fa, U, ha, Ea, I, oa, la, C = 0 < C,
                            ba = ca.center || (ca.center = [N, A, b.size, b.innerSize || 0]), na = ba[1], ja = ba[0],
                            b = ba[2], N = ba[4], A = ca.labelsRadius, pa = L(100 * ca.labelsRadiusY) / 100,
                            qa = ca.maxLabels, sa = ca.enableSmartLabels, ma = ca.pieSliceDepth / 2;
                        H = this.get("config", "animationObj");
                        var ua = g ? 0 : H.duration, ta = H.dummyObj, wa = H.animObj, xa = H.animType, za, aa,
                            Ta = this._plotDragMove, Fa = this._plotDragStart, da = this._plotDragEnd,
                            Ga = this._plotRollOver, La = this._plotRollOut, Ma = V.paper,
                            Ua = S.graphics.dataLabelContainer;
                        K.useEllipsesOnOverflow(w.useEllipsesWhenOverflow);
                        if (ca.dataLabelCounter) if (g || K.setStyle(ya), 1 == F.length) H = F[0], oa = H.graphics, I = H.config, aa = I._textAttrs, za = I._textCss, ha = oa.label, la = oa.connector, I.slicedTranslation = [u, k], null !== I.y && void 0 !== I.y && (aa.visibility = f, aa["text-anchor"] =
                            "middle", aa.x = ja, aa.y = na + Q - 2, aa._x = ja), ha ? ha.animateWith(ta, wa, aa, ua, xa) : ha = oa.label = Ma.text(aa, za, Ua).drag(Ta, Fa, da).hover(Ga, La), aa._x && (ha.x = aa._x, delete aa.x), ha.data("plotItem", aa.plotItem).data("eventArgs", aa.eventArgs), aa.visibility === f && ha.show(), la && la.hide(); else if (a) x(F, function (e) {
                            oa = e.graphics;
                            I = e.config;
                            aa = I._textAttrs;
                            ha = oa.label;
                            ...
                            x(F, function (e) {
                                ...
                                (U = ia + U), Ea = 0 <= U && U < va ? 1 : U < ea ? 2 : U < ra ? 3 : 0, D[Ea].push({
                                    point: e,
                                    angle: U
                                })
                            });
                            for (V = w = 4; V--;) {
                                if (z && (S = D[V].length - qa, 0 < S)) for (D[V].sort(r), ca = D[V].splice(0, S), S = 0, a = ca.length; S < a; S += 1) H = ca[S].point, oa = H.graphics, oa.label && oa.label.attr("visibility", "hidden"), oa.connector && oa.connector.attr({visibility: "hidden"});
                                D[V].sort(e)
                            }
                            ...
                            for (K.setStyle(ya); w--;) {
                                ...
                                for (V = S.length - 1; 0 <= V; --V, F += M) H = S[V].point, oa = H.graphics, I = H.config, aa = I._textAttrs, za = I._textCss, null !== I.y && aa.text && (U = S[V].angle, X = I.sliced, ha = oa.label, H = v(pa * y(U)), H < ya ? H = ya : H > F && (H = F), ya = H + M, Da = (H + S[V].oriY) / 2, H = ja + n[w] * A * G(q.asin(Da / pa)), Da *= d[w], Da += na, Ra = na + N * y(U), O = ja + b * G(U), (2 > w && H < O || 1 < w && H > O) && (H = O), ka = H + p[w], fa = Da + Q - 2, P = ka + p[w], aa._x = P, m && (W = 1 < w ? P - u : u + l - P, K.setStyle(I.style),
                                    a = h(B(parseFloat(I.style.lineHeight)), 12) + (2 * B(parseFloat(I.style.border), 12) || 0), a = K.getSmartText(I.displayValue, W, a), aa.text = a.text, aa.tooltip = a.tooltext), U < ea && (Da += ma, Ra += ma, fa += ma), aa._y = fa, X && (a = I.transX, X = I.transY, ka += a, H += a, O += a, Ra += X, P += a), aa.visibility = f, aa["text-anchor"] = ca, (a = ha && ha.data("textPos")) && ha.attr({
                                    x: a.x,
                                    y: a.y
                                }), aa.x = P, aa.y = Da, !g && a ? ha.animateWith(ta, wa, aa, ua, xa) : ha ? aa && ha.attr(aa) : ha = oa.label = Ma.text(aa, za, Ua).drag(Ta, Fa, da).hover(Ga, La), ha.data("textPos", {
                                    x: P,
                                    y: Da
                                }).data("plotItem",
                                    aa.plotItem).data("eventArgs", aa.eventArgs), ha.x = aa._x, ha._x = aa._x, ha.y = aa._y, aa.tooltip && (ha.tooltip(aa.tooltip), delete aa.tooltip), C && R && sa && (la = oa.connector, I.connectorPath || (T = !0), I.connectorPath = a = ["M", O, Ra, "L", Z ? H : O, Da, ka, Da], a = {
                                    path: a,
                                    "stroke-width": R,
                                    stroke: Ba.connectorColor || "#606060",
                                    visibility: f
                                }, la && (g || T ? la.attr(a) : la.animateWith(ta, wa, a, ua, xa))))
                            }
                        }
                    }
                }(),
                animate: function () {
                    var r, e, c, d, n = this, a = n.components.dataset[0], f = a.components.data;
                    r = n.graphics.datasetGroup;
                    var T = f.length;
                    e = a.config.alphaAnimation;
                    c = function () {
                        n.disposed || n.disposing || n.placeDataLabels(!1)
                    };
                    var w = n.get("config", "animationObj"), a = w.duration || 0, V = w.dummyObj, S = w.animObj,
                        w = w.animType;
                    if (e) r.attr({opacity: 0}), r.animateWith(V, S, {opacity: 1}, a, w, c); else for (r = 0; r < T; r++) if (e = f[r], c = e.graphics, e = e.config, d = e.shapeArgs, e = 2 * z, c = c.element) c.attr({
                        start: e,
                        end: e
                    }), c = d.start, d = d.end, (void 0).animateWith(V, S, {cx: c - e, cy: d - e}, a, w)
                },
                _rotate: function (a) {
                    var e = this.components.dataset[0], c = e.config, e = e.components, d = e.data, n = c.slicedOffset,
                        g = c.slicedOffsetY,
                        f = c.startAngle, T;
                    ...
                    x(d, function (e) {
                        ...
                        var c = d.shapeArgs, a = c.start += T, c = c.end += T, r = d.angle = ta((a + c) / 2),
                            a = d.sliced, c = G(r), r = y(r), c = d.slicedTranslation = [L(c * n), L(r * g)];
                        d.transX = c[0];
                        d.transY = c[1];
                        d.slicedX = a ? G(T) * n : 0;
                        d.slicedY = a ? y(T) * g : 0;
                ...
                _plotRollOver: function (a) {
                    var e =
                            this.data("plotItem"), c = e.chart, d = c.config, n = c.components.dataset[0],
                        g = n.components.data[e.index], e = g.graphics.element, g = g.config.hoverEffects;
                    n.config.isRotating || (l.call(e, c, a, "DataPlotRollOver"), g.enabled && e.attr(g));
                    d.isHovered = !0
                },
                _plotRollOut: function (a) {
                    var e = this.data("plotItem"), c = e.chart, d = c.config, n = c.components.dataset[0],
                        g = n.components.data[e.index], e = g.config, g = g.graphics.element;
                    n.config.isRotating || (l.call(g, c, a, "DataPlotRollOut"), g.attr({
                        color: e.color.color.split(",")[0], alpha: e._3dAlpha,
                        borderWidth: e.borderWidth, borderColor: e.borderColor
                    }));
                    d.isHovered = !1
                },
                _plotDragStart: function (a, e) {
                    var c = this.data("plotItem"), d = e[0], n = e[1], g = c.chart, c = g.components.dataset[0].config;
                ...
                _plotDragEnd: function (a) {
                    var e = this.data("plotItem"),
                        c = e.index, e = e.chart, d = e.config, n = e.components.dataset[0], g = n.config,
                        n = n.components.Pie3DManager, f = g.startAngle;
                    g.isRightClicked || (g.isRotating ? (setTimeout(function () {
                        g.isRotating = !1
                    }, 0), b.raiseEvent("rotationEnd", {
                        startingAngle: ta(f, !0),
                        changeInAngle: f - g.startingAngleOnDragStart
                    }, e.chartInstance), !d.isHovered && n.colorObjs[c] && n.onPlotHover(c, !1)) : e._plotGraphicClick.call(this, a))
                },
                _plotDragMove: function (a, e) {
                    var c = this.data("plotItem"), d = e[1], n = e[2], g = e[3], f = c.chart,
                ...
                _stubRadius: function (a, e, c, d, n, g, f) {
                    var T = this.components.dataset[0], w = T.config, b = h(T.config.slicingdistance),
                        T = w.dataLabelOptions || (w.dataLabelOptions = T._parseDataLabelOptions()), S = 0,
                        S = w.pieYScale;
                    c -= w.pieSliceDepth;
                ...
                _startingAngle: function (a, e) {
                    var c, d = this.components.dataset[0].config, n = (c = d.startAngle) + (0 > c ? 360 : 0);
            ...
            a.prototype = {
                configure: function (a, e, c, d) {
                    var n = this.linkedItems.chart, g = n.get("components", "paper"),
                    ...
                    this.closeCmdArr = ["Z"];
                    this.colorObjs = []
                }, getArcPath: function (a, e, c, d, n, g, f, T, w, b) {
                    return c == n && d == g ? [] : ["A", f, T, 0, b, w, n, g]
                }, _parseSliceColor: function (a, e, c) {
                    var d, n, g, f, T, w, b, S, ca, F, q, u, k, G, y;
                    y = 3;
                    var A = (d = this.use3DLighting) ? xa : Fa, L = c.radiusYFactor, E = c.cx, t = c.cy, h = c.r,
                        l = h * L, v = c.innerR || 0, N = E + h, K = E - h, D = E + v, J = E - v;
                    e = e || 100;
                    c = e / 2;
                    A[a] && A[a][e] ? A = A[a][e] : (A[a] || (A[a] = {}), A[a][e] || (A[a][e] = {}), A = A[a][e], d ? (d = U(a, 80), n = U(a, 75), w = ba(a, 85), b = ba(a, 70), S = ba(a, 40), ca = ba(a, 50), ba(a, 30), F = ba(a, 65), U(a, 85), g = U(a, 69), f = U(a, 75), T = U(a, 95)) : (y = 10, d = U(a, 90), n = U(a, 87), w = ba(a, 93), b = ba(a, 87), S = ba(a, 80), F = ca = ba(a, 85), ba(a, 80), T = U(a, 85), g = U(a, 75), f = U(a, 80)), q = n + P + w + P + b + P + w + P + n, k = e + P + e + P + e + P + e + P + e, u = n + P + a + P + w + P + a + P + n, G = c + P + c + P + c + P + c + P + c, S = n + P + a + P + S + P + a + P + n, g = f + P + w + P + ca + P + w + P + g, f = "FFFFFF" + P + "FFFFFF" + P + "FFFFFF" + P + "FFFFFF" + P + "FFFFFF", y = 0 + P +
                        ...
                        FCcolor: {
                            gradientUnits: "userSpaceOnUse",
                            y1: 0, y2: 0, color: u, alpha: G, angle: 0, ratio: "0,25,5,5,65"
                        }
                    }, A.backInner = {
                        FCcolor: {
                            gradientUnits: "userSpaceOnUse",
                    ...
                    }, A.bottom = fa(ua(a, c)), A.startSlice = fa(ua(d, e)), A.endSlice = fa(ua(d, e)));
                    ...
                    var e =
                        this.pointElemStore, c = 0, d = e.length, n;
                    if (!this.hasOnePoint) {
                        for (; c < d; c += 1) n = e[c], n = n._confObject, n.start += a, n.end += a, this._setSliceShape(n);
                        this.refreshDrawing()
                    }
                }, removeSlice: function (a) {
                    var e = this.pointElemStore, c = a._confObject.elements, d = this.slicingWallsArr, n;
                    n = e.length;
                    var g;
                    ...
                    var a = this._slicePool || (this._slicePool = []), e = this.slicingWallsArr, c = !1;
                    ...
                    return function () {
                        var e = this.slicingWallsArr, c = 0, d, n = e.length, g, f, T, w,
                            b = this.slicingWallsFrontGroup, S = this.slicingWallsBackGroup;
                        e.sort(a);
                        a:{
                            var ca = e[0] && e[0]._conf.index, F, k;
                            w = ca <= ea;
                            g = 1;
                            for (d = e.length; g < d; g += 1) if (k = e[g]._conf.index, F = k <= ea, F != w || k < ca) break a;
                            g = 0
                        }
                    ...
                    var c =
                            this.getArcPath, d = a.start, n = a.end, g = ta(d), f = ta(n), T, w, b, S, ca, F, k, u, q, L, E,
                        A, t, h, l, v, N, K = this.isDoughnut, p = a.radiusYFactor, R = a.cx, D = a.cy, J = a.r,
                        M = J * p, z = J + (qa ? -1 : 2), Z = M + (qa ? -1 : 2), W = a.innerR || 0, H = W * p,
                        X = this.depth, O = X + D, m = R + J, x = R - J, C = R + W, Q = R - W, ka = D - M,
                        B = ["M", Q, ka, "L", Q, O + M, "Z"], p = a.elements, P, Y, I, U, fa, ba = "path",
                        na = (g + f) / 2, ja = g > f;
                    w = G(g);
                    b = y(g);
                    S = G(f);
                    ...
                    K ? (A = R + W * w, t = D + H * b, v = t + X, h = R + W * S, l = D + H * ca, N = l + X, a.startSlice = ["M", F, k,
                        "L", F, P, A, v, A, t, "Z"], a.endSlice = ["M", Y, I, "L", Y, U, h, N, h, l, "Z"]) : (a.startSlice = ["M", F, k, "L", F, P, R, O, R, D, "Z"], a.endSlice = ["M", Y, I, "L", Y, U, R, O, R, D, "Z"]);
                    qa ? (T = (g > f ? ia : 0) + f - g, a.clipTopPath = K ? [["M", F, k, "A", J, M, 0, T > ea ? 1 : 0, 1, Y, I, "L", h, l, "A", W, H, 0, T > ea ? 1 : 0, 0, A, t, "Z"]] : [["M", F, k, "A", J, M, 0, T > ea ? 1 : 0, 1, Y, I, "L", R, D, "Z"]], a.clipOuterFrontPath1 = [B], a.clipTopBorderPath = [["M", u, q, "A", z, Z, 0, T > ea ? 1 : 0, 1, L, E, "L", Y, I, Y, I + 1, "A", J, M, 0, T > ea ? 1 : 0, 0, F, k + 1, "L", F, k, "Z"]], d != n ? g > f ? g < ea ? (a.clipOuterFrontPath = [["M", m, D, "A", J, M, 0,
                    ...
                    var e = a.thisElement, c = a.showBorderEffect, d = a.elements,
                        n = ua(a.borderColor, h(a.borderAlpha, a.alpha)), g = a.borderWidth, f;
                    a.color && (a = this._parseSliceColor(a.color, a.alpha, a), qa ? (f = {
                        fill: fa(a.top),
                        "stroke-width": 0
                    }, c ? d.topBorder.show().attr({
                        fill: fa(a.topBorder),
                        "stroke-width": 0
                    }) : (d.topBorder.hide(), f.stroke = n, f["stroke-width"] = g), e._attr(f)) : (e._attr({
                        fill: fa(a.top),
                        "stroke-width": 0
                    }), d.topBorder.attr({
                        stroke: n,
                        "stroke-width": g
                    })), d.bottom.attr({fill: fa(a.bottom)}), d.bottomBorder.attr({
                        stroke: n,
                        "stroke-width": g
                    }), d.frontOuter.attr({fill: fa(a.frontOuter)}), d.frontOuter1.attr({fill: fa(a.frontOuter)}), d.backOuter.attr({fill: fa(a.backOuter)}), d.startSlice.attr({
                        fill: fa(a.startSlice),
                        stroke: n,
                        "stroke-width": g
                    }), d.endSlice.attr({
                        fill: fa(a.endSlice),
                        stroke: n,
                        "stroke-width": g
                    }), this.isDoughnut && (d.frontInner.attr({fill: fa(a.frontInner)}), d.backInner.attr({fill: fa(a.backInner)})))
                },
                createSlice: function () {
                    var a = {
                        ...
                        var d, n, g = this, f = g._confObject, w = {}, k = f.elements, b, T, q, ga = f.Pie3DManager, G;
                        "string" === typeof e && void 0 !==
                        c && null !== c && (d = e, e = {}, e[d] = c);
                        if (e && "string" !== typeof e) {
                            for (d in e) if (n = e[d], a[d]) if (f[d] = n, "ishot" === d || "cursor" === d || "transform" === d) w[d] = n, G = !0; else if ("start" === d || "end" === d || "cx" === d || "cy" === d || "radiusYFactor" === d || "r" === d || "innerR" === d) T = !0; else {
                                if ("color" === d || "alpha" === d || "borderColor" === d || "borderAlpha" === d || "borderWidth" === d) q = !0
                            } else g._attr(d, n);
                            T && (ga._setSliceShape(f), ga.refreshDrawing());
                            (q || T) && ga._setSliceCosmetics(f);
                            if (G) {
                                for (b in k) k[b].attr(w);
                                g._attr(w)
                            }
                        } else g = a[e] ? f[e] : g._attr(e);
                        return g
                    }, c = function (a, e) {
                        var c = this._confObject.elements, d;
                        for (d in c) c[d].on(a, e);
                        return this._on(a, e)
                    }, d = function (a, e, c) {
                        var d, n = this._confObject.elements,
                            g = -1 < K.navigator.userAgent.toLowerCase().indexOf("android");
                        for (d in n) g ? "topBorder" !== d && "frontOuter" !== d && "startSlice" !== d && "endSlice" !== d || n[d].drag(a, e, c) : n[d].drag(a, e, c);
                        return this._drag(a, e, c)
                    }, n = function () {
                        var a = this._confObject.elements, e;
                        for (e in a) a[e].hide();
                        return this._hide()
                    }, g = function () {
                        var a = this._confObject.elements, e;
                        ...
                        var a = this._confObject, e = a.elements, c;
                        for (c in e) e[c].destroy();
                        ...
                        var e = this._confObject.elements, c;
                        for (c in e) e[c].tooltip(a);
                    ...
                    return function () {
                        var a = this.renderer, q, F = {elements: {}, Pie3DManager: this}, G = this.slicingWallsArr,
                            u = F.elements, h = qa ? "litepath" : "path";
                        q = a[h](this.topGroup);
                        q._confObject = F;
                        F.thisElement = q;
                        ...
                        this.isDoughnut && (u.frontInner = a[h](this.slicingWallsFrontGroup).attr({"stroke-width": 0}), u.backInner = a[h](this.slicingWallsFrontGroup).attr({"stroke-width": 0}), u.backInner._conf = {
                            si: k,
                            isStart: .5
                        }, u.frontInner._conf = {si: k, isStart: .4}, G.push(u.frontInner, u.backInner));
                        k += 1;
                        return q
                    }
                }()
        ...
        B.register("module", ["private",
            "modules.renderer.js-doughnut2d", function () {
                var a = this, b = a.hcLib, m = a.window, C = !b.CREDIT_REGEX.test(m.location.hostname), p = b.chartAPI,
                    K = b.getFirstColor, N = b.getFirstAlpha, Q = b.hasSVG, h = b.toRaphaelColor, x = b.hashify,
                    l = 8 === m.document.documentMode ? "visible" : "", f = b.graphics.getLightColor, q = Math.floor,
                ...
                p("doughnut2d", {
                        ...
                        getPointColor: function (a, b, k) {
                            ...
                            b = N(b);
                            100 > k &&
                            Q ? (h = y(a, q(100 * (85 - .2 * (100 - k))) / 100), a = f(a, q(100 * (100 - .5 * k)) / 100), b = {
                                FCcolor: {
                                    color: h + "," + a + "," + a + "," + h,
                                    alpha: b + "," + b + "," + b + "," + b,
                                    radialGradient: !0,
                            ...
                            }) : b = {FCcolor: {color: a + "," + a, alpha: b + "," + b, ratio: "0,100"}};
                            return b
                        },
                        drawDoughnutCenterLabel: function (a, f, b, q, y, v, z) {
                            var p = this.components, K = p.dataset[0].config;
                            v = v || K.lastCenterLabelConfig;
                            var p = p.paper, N = this.linkedItems.smartLabel, m = this.graphics, C = m.datasetGroup,
                                Q = v.padding, B = 2 * v.textPadding, na = {
                                    fontFamily: v.font,
                            ...
                            a ? (y.css(na).attr({
                                ...
                                fill: h({FCcolor: {color: v.color, alpha: v.alpha}}),
                                "text-bound": v.bgOval ? "none" : [h({
                                    FCcolor: {
                                        color: v.bgColor,
                                        alpha: v.bgAlpha
                                    }
                                ...
                                }), v.borderThickness, v.textPadding, v.borderRadius]
                            }).tooltip(v.toolText || N.tooltext), v.bgOval && U && U.attr({
                                visibility: l,
                                fill: x(v.bgColor),
                        ...
                        centerLabelRollover: function () {
                            var f = this.chart, b = f.config, k = f.chartInstance, q = k.ref,
                                h = f.components.dataset[0].config.lastCenterLabelConfig, b = {
                                    height: b.height,
                                    width: b.width,
                                    pixelHeight: q.offsetHeight,
                                    pixelWidth: q.offsetWidth,
                                    id: k.id,
                                    renderer: k.args.renderer,
                                    container: f.linkedItems.container,
                                    centerLabelText: h && h.label
                                };
                            this.attr("text") && a.raiseEvent("centerLabelRollover", b,
                                k, this, f.hoverOnCenterLabel)
                        },
                        centerLabelRollout: function () {
                            var f = this.chart, b = f.config, q = f.chartInstance, h = q.ref,
                                y = f.components.dataset[0].config.lastCenterLabelConfig, b = {
                                    height: b.height,
                                    width: b.width,
                                    ...
                                    container: f.linkedItems.container,
                                    centerLabelText: y && y.label
                                };
                            this.attr("text") && a.raiseEvent("centerLabelRollout", b, q, this, f.hoverOffCenterLabel)
                        },
                        centerLabelClick: function () {
                            var f = this.chart, b = f.config, q = f.chartInstance,
                                h = q.ref, y = f.components.dataset[0].config.lastCenterLabelConfig, f = {
                                    height: b.height,
                                    width: b.width,
                                    pixelHeight: h.offsetHeight,
                                    pixelWidth: h.offsetWidth,
                        ...
                        centerLabelChange: function (f) {
                            var b = this.config, q = this.chartInstance, h = q.ref;
        ...
        B.register("module", ["private", "modules.renderer.js-doughnut3d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
            a("doughnut3d", {
                ...
                _configureManager: function () {
                    var a = this.components.dataset[0], b = a.config, p = a.components, a = p.Pie3DManager, p = p.data;
                    a && a.configure(b.pieSliceDepth, 1 === p.length, b.use3DLighting, !0)
                }
            }, a.pie3d)
        }]);
        B.register("module", ["private", "modules.renderer.js-mscolumn2d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
            a("mscolumn2d", {
                standaloneInit: !0,
        ...
        B.register("module", ["private", "modules.renderer.js-mscolumn3d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname),
                a = a.chartAPI;
            a("mscolumn3d", {
                standaloneInit: !0,
                defaultDatasetType: "column3d",
                ...
                creditLabel: b,
                defaultZeroPlaneHighlighted: !1
            }, a.mscartesian3d, {showplotborder: 0, enablemousetracking: !0})
        }]);
        B.register("module", ["private", "modules.renderer.js-msbar2d", function () {
            var a = this.hcLib, b = a.chartAPI, a = !a.CREDIT_REGEX.test(this.window.location.hostname);
            b("msbar2d", {
                standaloneInit: !0, friendlyName: "Multi-series Bar Chart",
                isBar: !0, hasLegend: !0, creditLabel: a, defaultDatasetType: "bar2d", applicableDSList: {bar2d: !0}
        ...
        B.register("module", ["private", "modules.renderer.js-msarea", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
            a("msarea", {
                standaloneInit: !0,
            ...
            }, a.areabase, {enablemousetracking: !0})
        }]);
        B.register("module", ["private",
            "modules.renderer.js-msline", function () {
                var a = this.hcLib, b = a.chartAPI, a = !a.CREDIT_REGEX.test(this.window.location.hostname);
                b("msline", {
                    standaloneInit: !0,
        ...
        B.register("module", ["private", "modules.renderer.js-stackedarea2d", function () {
            var a =
                this.hcLib, b = a.chartAPI, m = !a.CREDIT_REGEX.test(this.window.location.hostname);
            b("stackedarea2d", {
                friendlyName: "Stacked Area Chart",
                showsum: 0,
                creditLabel: m
            }, b.msarea, {plotfillalpha: a.preDefStr.HUNDREDSTRING, isstacked: 1})
        }]);
        B.register("module", ["private", "modules.renderer.js-stackedcolumn2d", function () {
            var a = this.hcLib, b = a.chartAPI, a = !a.CREDIT_REGEX.test(this.window.location.hostname);
            b("stackedcolumn2d", {friendlyName: "Stacked Column Chart", creditLabel: a}, b.mscolumn2d, {isstacked: !0})
        }]);
        B.register("module",
            ["private", "modules.renderer.js-stackedcolumn3d", function () {
                var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), m = a.chartAPI;
                m("stackedcolumn3d", {
                    friendlyName: "3D Stacked Column Chart", creditLabel: b, _mouseEvtHandler: function (b) {
                        var p = b.data.mouseTracker, K = this.config, N = K.canvasLeft, m = K.canvasRight,
                            h = K.canvasBottom, x = K.canvasTop, l = K.datasetOrder || this.components.dataset,
                            f = a.getMouseCoordinate(this.linkedItems.container, b.originalEvent, this), q = f.chartX,
                            f = f.chartY, y, G = this.components,
                            L = "datasetGroup_" + l[0].type, k, t = !1, E = l.length, v, z = p._lastDatasetIndex,
                            B = p._lastPointIndex;
                        ...
                        if (t) for (N = v.events && v.events.length, p._lastDatasetIndex = k.datasetIndex, B = p._lastPointIndex = k.pointIndex, K.drawTrendRegion && G[L]._notifyGroup(!0, b), p = 0; p < N; p += 1) y && y._firePlotEvent && y._firePlotEvent(v.events[p], B, b, k.datasetIndex); else K.drawTrendRegion && G[L]._notifyGroup(!1, b);
        ...
        B.register("module", ["private", "modules.renderer.js-stackedbar2d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
            a("stackedbar2d", {friendlyName: "Stacked Bar Chart", creditLabel: b}, a.msbar2d, {
                maxbarheight: 50,
                enablemousetracking: !0
            }, a.stackedcolumn2d)
        }]);
        B.register("module", ["private", "modules.renderer.js-stackedbar3d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), m = a.chartAPI;
            m("stackedbar3d", {
                friendlyName: "3D Stacked Bar Chart", creditLabel: b, _mouseEvtHandler: function (b) {
                    var p = b.data.mouseTracker, K = this.config, N = K.canvasLeft, m = K.canvasRight,
                        h = K.canvasBottom, x = K.canvasTop, l = K.datasetOrder || this.components.dataset,
                        f = a.getMouseCoordinate(this.linkedItems.container, b.originalEvent, this), q = f.chartX,
                        f = f.chartY, y, G = this.components, L = "datasetGroup_" + l[0].type, k, t = !1, E = l.length,
                        v, z = p._lastDatasetIndex, B = p._lastPointIndex;
                    if (q > N && q < m && f > x && f < h || this.config.plotOverFlow) {
                        for (E = l.length; E-- &&
                        !t;) if (y = l[E], y.valueLook = !0, y && y.visible) {
                            if ((k = y._getHoveredPlot && y._getHoveredPlot(q, f)) && k.hovered) for (N = 0; N <= E; ++N) if (E !== N && k && (m = l[N], (h = m._getHoveredPlot && m._getHoveredPlot(q, f)) && h.pointIndex === k.pointIndex - 1)) {
                                k = h;
                                E = N;
                                y = m;
                                y.valueLook = !0;
                        ...
                        for (E = 0; E < l.length && !t;) {
                            ...
                            if (y && y.visible) {
                                ...
                                (h = m._getHoveredPlot && m._getHoveredPlot(q, f)) && h.pointIndex === k.pointIndex - 1)) {
                                    k = h;
                                    E = N;
                                    y = m;
                                    y.valueLook = !1;
                    ...
                    (!t || v && v.fireOut) && void 0 !== z && (delete p._lastDatasetIndex, delete p._lastPointIndex, l[z] && l[z]._firePlotEvent && l[z]._firePlotEvent("mouseout", B, b));
                    if (t) for (l = v.events && v.events.length, p._lastDatasetIndex = k.datasetIndex, B = p._lastPointIndex = k.pointIndex, K.drawTrendRegion && G[L]._notifyGroup(!0, b),
                                    p = 0; p < l; p += 1) y && y._firePlotEvent && y._firePlotEvent(v.events[p], B, b, k.datasetIndex); else K.drawTrendRegion && G[L]._notifyGroup(!1, b);
                    K.drawTrendRegion && G[L]._getHoveredRegion(q, f, b)
                }
        ...
        B.register("module", ["private", "modules.renderer.js-marimekko", function () {
            var a = this.hcLib, b = a.chartAPI, a = !a.CREDIT_REGEX.test(this.window.location.hostname), m = Math,
                B = m.min, p = m.max;
            b("marimekko", {
                standaloneInit: !0,
                ...
                _setAxisLimits: function () {
                    var a = this.components, b = a.dataset, m = a.yAxis, a = a.xAxis, h, x = b.length, l, f = -Infinity,
                        q = Infinity, y = Infinity, G = -Infinity, L, k, t = {};
                    ...
                    x = E.length;
                    for (l = 0; l < x; l++) b = E[l].getDataLimits(), v(b);
                    -Infinity === f && (f = 0);
                    Infinity === q && (q = 0);
                    m[0].setAxisConfig({isPercent: this.config.isstacked ? this.config.stack100percent : 0});
                    m[0].setDataLimit(f, q);
                    if (-Infinity !== G || Infinity !== y) a[0].config.xaxisrange = {
                        max: G,
                        min: y
                    }, a[0].setDataLimit(G, y);
        ...
        B.register("module", ["private", "modules.renderer.js-msstackedcolumn2d", function () {
            ...
            m("msstackedcolumn2d", {
                ...
                _createDatasets: function () {
                    var a = this.components, b = this.jsonData, m = b.dataset, h = m && m.length || 0, x, l, f,
                        q = this.defaultDatasetType, y = this.applicableDSList, G, L, k, t, E, v, z = b.lineset || [],
                        Y = this.config, ka = Y.dataSetMap, ea = Y.lineSetMap, va = ka && ka.length, ia = a.legend,
                        ra = [], sa = [], na = 0;
                    k = 0;
                    var ma, U = -1, ba, Aa = this.config.catLen, ua = a.xAxis[0], P, fa, qa = a.dataset;
                    if (m || 0 !== z.length) {
                        ...
                        for (b = 0; b < h; b++) {
                            E = m[b];
                            U++;
                            if (E.dataset) for (fa = !0, v = E.dataset &&
                            ...
                            if (E > v) for (k = x, E = E - v + x; k < E; k++) G = ka[b][k], ia.removeItem(G.legendItemId), p.call(G)
                        }
                        if (va > h) for (k = b, E = va - h + b; k < E; k++) for (v = ka[k].length, x = 0; x < v; x++) G = ka[k][x], ia.removeItem(G.legendItemId), p.call(G);
                        Y.dataSetMap = ra;
                        if (this.lineset) {
                            b = 0;
                            ...
                            z = ea && ea.length;
                            if (z > h) for (k = b, E = z - h + b; k < E; k++) G = ea[k], ia.removeItem(G.legendItemId), p.call(G);
                            Y.lineSetMap = sa
                        }
        ...
        B.register("module",
            ["private", "modules.renderer.js-mscombi2d", function () {
                var a = this.hcLib, b = a.chartAPI, m = !a.CREDIT_REGEX.test(this.window.location.hostname),
                    C = a.pluck, p = a.componentDispose;
                b("mscombi2d", {
                        ...
                        _createDatasets: function () {
                            var a = this.components, b = this.jsonData, m = b.dataset, h = m && m.length, x, l,
                                f = this.defaultDatasetType, q = this.applicableDSList;
                            x = this.components.legend;
                            var y = a.xAxis[0], G, L, k, t, E, v = this.config.isstacked, z, Y, ka = [], ea = {},
                                va = this.config, ia = this.config.catLen, ra = va.datasetMap || (va.datasetMap = {
                                    line: [],
                                    area: [],
                                    column: [],
                                    column3d: [],
                            ...
                            b = a.dataset = [];
                            x && x.emptyItems();
                            for (x = 0; x < h; x++) if (E = m[x], t = E.parentyaxis || "", L = (L = this.config.isdual && "s" === t.toLowerCase() ? "line" === this.defaultSecondaryDataset ?
                            ...
                            for (m in ra) if (t = ra[m], f = t[0] && t[0].groupManager, h = t.length, q = void 0 === ea[m] ? 0 : ea[m] + 1, h) for (v && f && f.removeDataSet(0, q, h), a = 0; a < h; a++) f && !v && f.removeDataSet(q, 0, 1), "column" === t[a].type && !0 === this.is3D ? (t[a].visible = !1, t[a].draw()) : p.call(t[a]);
                            va.datasetMap = sa;
        ...
        B.register("module", ["private", "modules.renderer.js-mscombi3d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
            a("mscombi3d", {
                standaloneInit: !0,
                ...
                creditLabel: b,
                defaultPlotShadow: 1,
                applicableDSList: {column3d: !0, line: !0, area: !0},
                _createDatasets: a.mscombi2d
            }, a.mscartesian3d, {showplotborder: 0, enablemousetracking: !0}, a.areabase)
        }]);
        B.register("module", ["private", "modules.renderer.js-mscolumnline3d", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
            a("mscolumnline3d", {
            ...
            }, a.mscombi3d, {use3dlineshift: 1, showplotborder: 0, enablemousetracking: !0}, a.msarea)
        }]);
        B.register("module", ["private", "modules.renderer.js-stackedcolumn2dline", function () {
            var a = this.hcLib, b =
                a.chartAPI, a = !a.CREDIT_REGEX.test(this.window.location.hostname);
            b("stackedcolumn2dline", {
                friendlyName: "Stacked Column and Line Chart",
                defaultDatasetType: "column",
                creditLabel: a,
                applicableDSList: {line: !0, column: !0}
            }, b.mscombi2d, {isstacked: !0, stack100percent: 0, enablemousetracking: !0}, b.msarea)
        }]);
        ...
        B.register("module", ["private", "modules.renderer.js-msstackedcolumn2dlinedy", function () {
            ...
            a("msstackedcolumn2dlinedy",
                ...
                }, a.msdybasecartesian, {isdual: !0, haslineset: !0, isstacked: !0, enablemousetracking: !0}, a.msarea)
        }]);
        B.register("module", ["private", "modules.renderer.js-scrollcolumn2d", function () {
            var a = this, b = a.hcLib, m = b.chartAPI, B = !b.CREDIT_REGEX.test(a.window.location.hostname),
                p = Math, K = p.min, N = p.max, Q = p.floor, h = p.round, x = b.pluckNumber, l = b.Raphael;
            m("scrollcolumn2d", {
                standaloneInit: !0,
                ...
                _swipeX: function (f, b) {
                    var h = this.config, l = this.components, m = l.scrollBar.conf, k = m.scrollRatio, t = m.width - 1,
                        E = m.height - 1, v = h.scrollToEnd, m = h.lastScrollPosition;
                    x(l.canvas.config.canvasBorderWidth, l.xAxis[0].config.lineStartExtension);
                    var l = this.touchCurrPos, p = this.swipeStart, B = f.type,
                        E = h.scrollShowButtons ? K(E, .5 * t) : 0, C = this.config.mousedown, m = void 0 !== m ? m : v;
                    switch (B) {
                        case "touchstart":
                        case "mousedown":
                        ...
                        case "touchend":
                        case "mouseup":
                            C && (this.swipeStart && (a.raiseEvent("scrollEnd", {
                                prevScrollPosition: this.prevScrollPosition,
                                scrollPosition: h.lastScrollPosition
                            }, this.chartInstance), this.swipeStart = !1), h.mousedown = !1)
                    }
                },
                ...
                _setInitialDrawingIndex: function () {
                    var a = this.config, b = this.components, h = b.xAxis[0], l = h._getVisibleConfig(),
                        h = h.getCategoryLen(), m = b.dataset, k, t, E, v = m.length, p;
                ...
                updateManager: function (a) {
                    var b = this.config, l = this.config.viewPortConfig, m = l.scaleX, p = this.graphics.datasetGroup,
                        k = this.graphics.datalabelsGroup, t = this.graphics.trackerGroup,
                        E = b.canvasWidth * (m - 1) * a, v = this.components, z = v.xAxis[0],
                ...
                _filterLabelFn: function (a) {
                    if (a.graphics && a.graphics.label) return a
                },
                ...
                _filterImageFn: function (a) {
                    if (a.graphics && a.graphics.image) return a
                },
                _filterSumFn: function (a) {
                    if (a.graphics && a.element) return a
                },
                _datasetModifyFn: function (a) {
                    var b = a.graphics.element;
                    a.graphics.element = void 0;
                    return b.hide()
                },
                _imageModifyFn: function (a) {
                    var b = a.graphics.image;
                    a.graphics.image = void 0;
                    return b.hide()
                },
                _labelModifyFn: function (a) {
                    var b = a.graphics.label;
                    a.graphics.label = void 0;
                    return b.hide()
                },
                _sumValModifyFn: function (a) {
                    var b = a.element;
                    a.element = void 0;
                    return b.hide()
                },
                _createSumLabelPool: function () {
                    var a = this.components, b, h = a.paper, l;
                    b = a.datasetGroup_scrollcolumn2d;
                    a = b.pool;
                    l = b.graphics && b.graphics.sumLabelContainer;
                    if (!a && l) for (a = b.pool = {sumLabels: [[]]}, b = 0; 2 > b; b++) a.sumLabels[0].push(h.text(l[0]))
                },
                _createDataPool: function () {
                    var a = this.components, b, h = a.dataset, l = h.length, m, k, t, p, v = a.paper;
                    for (m = 0; m < l; m++) {
                        a = h[m];
                        if (!a.drawn) break;
                        b = a.components;
                        ...
                        if (!k) for (k = b.pool = {
                            ...
                            label: [],
                            image: []
                        }, b = 0; 2 > b; b++) k.element.push("column" === a.type ? v.rect(t) : v.polypath(t)), k.label.push(v.text(p))
                    }
                },
                _manageScroll: function () {
                    var a = this.config, b = this.components, l;
                    l = b.xAxis[0]._getVisibleConfig();
                    var m = b.dataset, p = m.length, k, t, E, v = a.scrollMinVal, z = a.scrollMaxVal, x = h(l.minValue),
                        B = h(l.maxValue + 1);
                ...
                _createToolBox: function () {
                    var b = this.components, h = this._scrollBar, l = h.get, p = h.add, x, k, t = b.scrollBar;
                    ...
                    p({isHorizontal: !0}, {
                        scroll: function (b) {
                            return function () {
                                var f = arguments && arguments[0], h = b.components.scrollBar.conf, k = h.scrollTo;
                ...
                _setAxisScale: function () {
                    var a = this.config, b = this.components.xAxis[0].getCategoryLen(), h = this.jsonData,
                        l = a.scrollOptions || (a.scrollOptions = {}), m = this.components.dataset, k = m.length, t, p,
                        v = 0, z;
                    z = a.canvasWidth;
                    var B = a.scrollToEnd, K = a.lastScrollPosition,
                ...
                drawScrollBar: function () {
                    var b = this, h = b.config, m = h.viewPortConfig, p = b.components, B = b.graphics, k = p.paper,
                        t = p.xAxis[0], E = t.config, v = t.config.axisRange,
                        z = h.scrollOptions || (h.scrollOptions = {}), K = v.max, C = v.min, N = z.vxLength,
                        Q = p.scrollBar, v = Q.node, ia = h.scrollToEnd, ra = h.lastScrollPosition, sa = m.scaleX, na,
                        ma, U, ba, Aa;
                    ...
                    !1 !== h.scrollEnabled ? (Q.draw(m - Aa,
                        ia + ra + ma + U - 2, {
                            ...
                            fullCanvasWidth: t,
                            windowedCanvasWidth: N,
                            scrollPosition: ba,
                            parentLayer: z
                        }), !v && function () {
                        var h;
                        l.eve.on("raphael.scroll.start." + Q.node.id, function (k) {
                            h = k;
                            a.raiseEvent("scrollstart", {scrollPosition: k}, b.chartInstance)
                        });
                        l.eve.on("raphael.scroll.end." + Q.node.id, function (k) {
                            a.raiseEvent("scrollend", {prevScrollPosition: h, scrollPosition: k}, b.chartInstance)
                        })
                    }()) : Q && Q.node && Q.node.hide()
                },
                ...
                _setClipping: function () {
                    var a = this.config, b = this.graphics.datasetGroup, h = this.graphics.datalabelsGroup,
                        l = this.graphics.trackerGroup, m = a.viewPortConfig, k = this.graphics.sumLabelsLayer,
                        p = m.scaleX, x = this.get("config", "animationObj"), v = x.duration, B = x.dummyObj,
                        K = x.animObj, x = x.animType, m = m.x, a = a.height,
                        C = this.components.canvas.config.clip["clip-canvas"], C = C && C.slice(0) || [];
        ...
        B.register("module", ["private", "modules.renderer.js-scrollarea2d", function () {
            ...
            m("scrollarea2d", {
                ...
                _setAxisScale: function () {
                    var a = this.config, b =
                            this.components.xAxis[0].getCategoryLen(), m = this.jsonData,
                        h = a.scrollOptions || (a.scrollOptions = {}), x;
                    x = a.lastScrollPosition;
                    var l = a.scrollToEnd, f = a.canvasWidth,
        ...
        B.register("module", ["private", "modules.renderer.js-scrollline2d", function () {
            var a =
                this.hcLib, b = a.chartAPI, a = !a.CREDIT_REGEX.test(this.window.location.hostname);
            b("scrollline2d", {
        ...
        B.register("module", ["private", "modules.renderer.js-scrollstackedcolumn2d", function () {
            var a = this.hcLib,
                b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI;
        ...
        B.register("module", ["private", "modules.renderer.js-bubble", function () {
            var a = this.hcLib, b = !a.CREDIT_REGEX.test(this.window.location.hostname), a = a.chartAPI, m = Math,
                B = m.max, p = m.min;
            a("bubble", {
                friendlyName: "Bubble Chart", standaloneInit: !0, defaultDatasetType: "bubble",
                creditLabel: b, applicableDSList: {bubble: !0}, getDataLimits: function () {
                    var a = this.components.dataset, b, m, h, x = -Infinity, l = Infinity;
                    b = 0;
                    for (h = a.length; b < h; b++) m = a[b], m = m.getDataLimits(), x = B(x, m.zMax || -Infinity), l = p(l, m.zMin || Infinity);
                    x = -Infinity === x ? 0 : x;
                    l = Infinity === l ? 0 : l;
                    return {zMax: x, zMin: l}
                }
            }, a.scatter, {enablemousetracking: !0})
        }])
    }, [3, 2, 2, "sr4"]]);
    B.register("module", ["private", "modules.renderer.js-zoomline", function () {
        var a = this, b = a.hcLib, m = b.hashify, C = a.window, p = C.document, K = C.Image, N = C.MouseEvent,
            Q = /msie/i.test(C.navigator.userAgent) && !C.opera, h = b.chartAPI, x = b.extend2, l = b.addEvent,
            f = b.pluck, q = b.pluckNumber, y = b.getFirstColor, G = b.graphics.convertColor, L = b.bindSelectionEvent,
            k = b.parseUnsafeString, t = b.componentDispose, E = b.Raphael, v = b.toRaphaelColor, z = b.hasTouch,
            Y = b.plotEventHandler, ka = b.getMouseCoordinate, ea = !b.CREDIT_REGEX.test(C.location.hostname),
            va = b.TOUCH_THRESHOLD_PIXELS, ia = b.CLICK_THRESHOLD_PIXELS, ra = z ? va : ia, sa = b.preDefStr.DEFAULT,
            na = "rgba(192,192,192," + (Q ? .002 : 1E-6) + ")", ma = b.schedular,
            U = b.priorityList, ba = Math, Aa = ba.ceil, ua = ba.floor, P = ba.round, fa = ba.max, qa = ba.min,
            wa = ba.cos, ta = ba.sin, xa = C.parseFloat, Fa = C.parseInt, r;
        ...
        h("zoomline", {
            ...
            creditLabel: ea,
            _drawAxis: function () {
                var a = this.components.yAxis || [], c, d;
                c = 0;
                for (d = a.length; c < d; c++) a[c].draw()
            },
            _setCategories: function () {
                var a = this.config, c = this.jsonData, d = this.components.xAxis, n, b, h;
                b = a.cdmchar;
                var f = c.categories && c.categories[0].category || [];
                if ((a.cdm || "string" === typeof f) && f.split) {
                    a = f.split(b);
                    n = [];
                    b = 0;
                    for (h = a.length; b < h; b += 1) n.push({label: a[b]});
            ...
            _createDatasets: function () {
                ...
                a = this.components;
                w = this.jsonData;
                var q = w.dataset, F = q && q.length, p = m.cdmchar,
                    u = m.cdm, r = this.defaultDatasetType, v = this.applicableDSList,
                ...
                for (a = 0; a < F; a++) {
                    k = q[a];
                    if (u && k.data && k.data.split) {
                        h = k.data.split(p);
                        b = [];
                        c = 0;
                        for (d = h.length; c < d; c++) b.push({value: h[c]});
                        k.data = b
                    }
                    c = k.parentyaxis || "";
                ...
                if (l > F) {
                    g = l - F;
                    c = a;
                    for (F = g + a; c < F; c++) t.call(w[c]);
                    w.splice(a, g);
                    m.splice(a, g)
                }
            },
            isWithinCanvas: function (a, c) {
                var d = c.get("config"), n = b.getMouseCoordinate(c.get("linkedItems", "container"), a, c),
                    g = n.chartX,
                    h = n.chartY, f = d.canvasLeft, w = d.canvasTop, k = d.canvasLeft + d.canvasWidth,
            ...
            highlightPoint: function (a, c, d, n, g, h) {
                var f = this, k = f.config, l = f.components, m = f.graphics, q = l.paper, F = m.tracker,
                    p = (l = l.dataset[g]) && l.config;
                g = l && p.zoomedRadius || 0;
                var u = l && p.hoverCosmetics, l = u && u.fill, p = u && u.borderColor, u = u && u.borderThickness,
                    r = {}, r = function (a) {
                ...
                r = Number(a) ? {r: g, fill: l, stroke: p, "stroke-width": u} : {
                    r: g,
                    fill: na,
                    stroke: na,
                    "stroke-width": 0
            ...
            configure: function () {
                var a, c = this.jsonData.chart || {}, d = this.components.colorManager,
                    b = d.getColor("canvasBorderColor"), g;
                c.animation = 0;
                c.showvalues = 0;
                ...
                x(g, {
                    ...
                    crossline: {
                        ...
                        line: {
                            "stroke-width": q(c.crosslinethickness, 1),
                            stroke: y(f(c.crosslinecolor, "#000000")),
                            "stroke-opacity": q(c.crosslinealpha, 20) / 100
                        },
                        labelEnabled: q(c.showcrosslinelabel, c.showcrossline, 1),
                        labelstyle: {
                            fontSize: xa(c.crosslinelabelsize) ? xa(c.crosslinelabelsize) + "px" : a.outCanfontSize,
                            fontFamily: f(c.crosslinelabelfont, a.outCanfontFamily)
                        },
                        valueEnabled: q(c.showcrosslinevalues,
                            c.showcrossline, 1),
                        valuestyle: {
                            fontSize: xa(c.crosslinevaluesize) ? xa(c.crosslinevaluesize) + "px" : a.inCanfontSize,
                            fontFamily: f(c.crosslinevaluefont, a.inCanvasStyle.fontFamily)
                        }
                    },
            ...
            getValuePixel: function (a) {
                ...
                return c.ddsi + ua(a / c.ppp)
            },
            __toolbar: function () {
                var a, c, d, b, g = this, h = g.components,
                    f = h.tb = new (B.register("component", ["toolbox", "toolbox"])), k = f.getDefaultConfiguration(),
                    l, m;
                ...
                return {
                    reInit: function () {
                        ...
                        d.addSymbol(a);
                        return a
                    }, addScroll: function (a, c) {
                        var e = new m(a);
                        c && e.attachEventHandlers(c);
                        return e
                    }, addComponentGroup: function (a, c) {
                        var e;
                        e = new d;
                        e.setConfiguaration({
                            group: {
                                fill: c ? c.fill : G("EBEBEB", 0),
                                borderThickness: c ? q(c.borderThickness, 0) : 0
                            }
                        });
                        return e
                    }, addToolBox: function (a) {
                        var c, e = new b;
                        for (c = 0; c < a.length; c += 1) e.addComponent(a[c]);
                        return e
                    }, setDrawingArea: function (a, c) {
                        a.drawingArea = c;
                        return a
                    }, draw: function (a) {
                        var c, e, d;
            ...
            __preDraw: function () {
                var a, c, d, b, g, h, f, k, l, m = this, p = m.components, F = p.paper, t = m.graphics;
                c = t.imageContainer;
                var u = m.config, v = u.canvasLeft, B = u.canvasWidth;
                a = m.jsonData.chart;
                var y = u.cdm;
                d = p.xAxis[0];
                var A = u.viewPortConfig, z = m.components.canvas.config;
                g = fa(z.canvasPadding, z.canvasPaddingLeft, z.canvasPaddingRight);
                h = p.yAxis[0];
                l = t.datasetGroup;
                var z =
                        u.canvasHeight, C = u.canvasTop, G = m.jsonData.chart,
                    G = u.borderWidth || (u.borderWidth = q(G.showborder, 1) ? q(G.borderthickness, 1) : 0);
                f = u.allowPinMode;
                var K = u.crossline, A = d.getCategoryLen(), N = Fa(q(a.displaystartindex, 1), 10) - 1,
                    P = Fa(q(a.displayendindex, A || 2), 10) - 1, Q = 0, R = p.dataset, D = R.length, p = t.crossline;
                ...
                (0 > N || N >= (A - 1 || 1)) && (N = 0);
                (P <= N || P > (A - 1 || 1)) && (P = A - 1 || 1);
                A = u.viewPortConfig = x(u.viewPortConfig, {
                    amrd: q(a.anchorminrenderdistance, 20),
                    nvl: q(a.numvisiblelabels, 0),
                    cdm: y,
                    oppp: c,
                    oppl: d,
                    dsi: N,
                ...
                if (A.clen) {
                    ...
                    f && (u.viewPortConfig.pinned = !1, f = E.crispBound(0, C - h, 0, z, G), u["clip-pinrect"] = [f.x, C, f.width, f.height], k = (t.zoompin || (t.zoompin = F.group("zoompin"))).insertBefore(l).transform(u._pingrouptransform = ["T",
                        ...
                        ishot: !0
                    }, t.pinrect ? (l.x = 0, l.y = C - h, l.width = a, l.height = z, t.pinrect.attr(l)) : t.pinrect = F.rect(0, C - h, a, z, k).attr(l), l = {
                        ...
                        fill: na,
                        ishot: !0,
                        cursor: E.svg && "ew-resize" || "e-resize"
                    }, t.pintracker ? t.pintracker.attr(l).hide() : t.pintracker = F.rect(t.trackerGroup).attr(l).hide().drag(function (a, c) {
                        var e = c[0], d = b + e + this.__pindragdelta, g = this.__pinboundleft, h =
                            this.__pinboundright, f = this.data("cliprect").slice(0), l = u._ymin;
                        d < g ? d = g : d > h && (d = h);
                        k.transform(["T", d, l]);
                        ...
                        var a = u["clip-pinrect"], c = u._visw;
                    ...
                    G--;
                    L(m, {
                        attr: {stroke: u.zoomPaneStroke, fill: u.zoomPaneFill, strokeWidth: 0},
                        selectionStart: function () {
                        },
                        selectionEnd: function (a) {
                            var c = a.selectionLeft - v;
            ...
            resetZoom: function () {
                var e = this.config.viewPortHistory, c = e[0];
            ...
            eiMethods: {
                zoomOut: function (a) {
                    var c = this.apiInstance, d = c.chartInstance.args.asyncRender, b, g = c.getJobList();
                    if (c) if (d) g.eiMethods.push(ma.addJob(function () {
                        b = c.zoomOut && c.zoomOut();
                        "function" === typeof a && a(b)
                    }, U.postRender)); else return c.zoomOut && c.zoomOut()
                }, scrollTo: h.mscartesian._scrollTo,
                zoomTo: function (a, c, d) {
                    var b = this.apiInstance, g = b.chartInstance.args.asyncRender, h, f = b.getJobList();
                    if (b) if (g || d) f.eiMethods.push(ma.addJob(function () {
                        h = b.zoomRange && b.zoomRange(a, c);
                        "function" === typeof d && d(h)
                    }, U.postRender)); else return b.zoomRange && b.zoomRange(a, c)
                }, resetChart: function () {
                    var a = this.apiInstance, c = a.chartInstance.args.asyncRender, d = a.getJobList(),
                        b = function () {
                ...
                setZoomMode: function (a) {
                    var c = this.apiInstance, d = c.chartInstance.args.asyncRender, b = c.getJobList();
                    c && (d ? b.eiMethods.push(ma.addJob(function () {
                        c.activatePin && c.activatePin(!a)
                    }, U.postRender)) : c.activatePin && c.activatePin(!a))
                }, getViewStartIndex: function (a) {
                    var c = this.apiInstance, d = c.chartInstance.args.asyncRender, b, g = c.getJobList();
                    if (a || d) g.eiMethods.push(ma.addJob(function () {
                        "function" === typeof a && c && (b = c.config.viewPortConfig) && a(b.ddsi)
                    }, U.postRender)); else if (c && (b = c.config.viewPortConfig)) return b.ddsi
                },
                getViewEndIndex: function (a) {
                    var c = this.apiInstance, d = c.chartInstance.args.asyncRender, b, g, h = c.getJobList();
                    if (a || d) h.eiMethods.push(ma.addJob(function () {
                        "function" === typeof a && c && (b = c.config.viewPortConfig) && (g = b.ddei - 1, a((g >= b.clen ? b.clen : g) - 1))
                    }, U.postRender)); else if (c && (b = c.config.viewPortConfig)) return g = b.ddei - 1, (g >= b.clen ? b.clen : g) - 1
                }
            },
            zoomOut: function () {
            ...
            zoomRangePixels: function (e, c) {
                var d = this.config, b = d.viewPortHistory, d = d.viewPortConfig, g = d.ppp, h = d.ddsi, f;
                b.push(d);
                (f = this.zoomTo(h + ua(e / g), h + ua(c / g))) ? a.raiseEvent("zoomedin", f, this.chartInstance) : b.pop()
            },
            zoomRange: function (e, c) {
                var d, b, g = this.config, h = g.viewPortConfig;
                b = this.components.xAxis[0];
                var f = g.viewPortHistory, k;
                f.push(h);
                d = b.getPixel(e);
                b = b.getPixel(c);
                h.x = d;
                ...
                (k = this.zoomTo(+e,
                    +c)) ? a.raiseEvent("zoomedin", k, this.chartInstance) : f.pop()
            },
            zoomTo: function (e, c, d) {
                var b, g;
                b = this.config;
                var h = this.components, f = b.viewPortConfig, k = b.canvasHeight;
                g = b.canvasLeft;
                var l = b.canvasTop, m = b.canvasBottom, p = b.viewPortHistory, q = f.clen,
                ...
                h.scrollBar.node.attr({
                    "scroll-ratio": f.vdl / (q - !!q),
                    "scroll-position": [f.dsi / (q - f.vdl - 1), !0]
                });
                h = {
                    level: p.length + 1,
                    startIndex: e,
                    startLabel: r.getLabel(e).label,
                    endIndex: c,
                    endLabel: r.getLabel(c).label
                };
                a.raiseEvent("zoomed", h, this.chartInstance, [this.chartInstance.id, e, c, h.startLabel, h.endLabel, h.level]);
                return h
            },
            activatePin: function (e) {
                var c = this.config.viewPortConfig, d = this.components.tb.graphics.pinButton;
                if (c.pinned ^
                ...
                return a.attr({
                    disable: {
                        config: {
                            ...
                            disable: {
                                fill: "#FFFFFF", "fill-symbol": "#FFFFFF", "stroke-width": 1,
                                stroke: "#E3E3E3", "stroke-opacity": 1, cursor: "default"
                            },
                            pressed: {
                                fill: "#FFFFFF",
                                "fill-symbol": "#FFFFFF",
                        ...
                        }, "button-disabled": !1, stroke: "#E3E3E3", "stroke-opacity": 1
                    }, enable: {
                        config: {
                            hover: {
                                fill: "#FFFFFF",
                            ...
                            disable: {
                                fill: "#FFFFFF", "fill-symbol": "#FFFFFF", "stroke-width": 1, stroke: "#E3E3E3",
                                "stroke-opacity": 1, cursor: "pointer"
                            },
                            pressed: {
                                fill: "#EFEFEF",
                                "fill-symbol": "#EFEFEF",
                        ...
                        config: {
                            ...
                            pressed: {
                                fill: "#dcdcdc", "fill-symbol": "#FFFFFF",
                                "stroke-width": 1, stroke: "#b7b7b7", cursor: "pointer"
                            }
                        },
                        fill: "#dcdcdc",
                        "fill-symbol": "#FFFFFF",
            ...
            pinRangePixels: function (a, c) {
                var d, b = this.components, g = b.paper, h = this.graphics, f = this.config, k = f.canvasLeft,
                    l = f.viewPortConfig, m = h.zoompin;
                d = h.pinrect;
                var q = f["clip-pinrect"], p = f._pingrouptransform, b = b.dataset, r = c - a, u, t, v,
                    h = h.pintracker;
                if (l && m && d) {
                    if (a === c) return m.hide(), h.hide(), l.pinned = !1;
                    for (v = b.length; v--;) u = b[v], d = u.graphics, t = d.pinline, t || (t =
                        d.pinline = g.path(m)), t.attr({
                        path: d.lineElement.attrs.path,
                        transform: ["T", -f._visx, -f._ymin]
                    }).attr(u.config.pin);
                    q[0] = a + k;
                    q[2] = r;
            ...
            getValue: function (a) {
                var c =
                    this.config, d = this.components, b = c.viewPortConfig;
                a = this.getOriginalPositions(a.x, a.y, a.x, a.y);
                var g = d.xAxis[0].config.axisRange, d = d.yAxis[0].config.axisRange, h = g.min, f = d.max;
                return {
                    x: h + (a[0] - c.canvasLeft) / (c.canvasWidth * b.scaleX / (g.max - h)),
                    y: f - (a[1] - c.canvasTop) / (c.canvasHeight * b.scaleY / (f - d.min))
                }
            },
            getOriginalPositions: function (a, c, d, b) {
                var g = this.config, h = g.viewPortConfig, f = h.scaleX, k = h.scaleY, l = h.x, h = h.y, m = qa(a, d);
                a = fa(a, d);
                d = qa(c, b);
                c = fa(c, b);
            ...
            updateVisual: function (a, c, b, n, g) {
                var h = this.config, f = h.viewPortConfig, k = h.canvasWidth, l = h.canvasHeight,
                    m = h.viewPortHistory.slice(-1)[0] || f, h = h.maxZoomLimit;
                f.x = isNaN(a) ? a = m.x : a;
                f.y = isNaN(c) ? c = m.y : c;
            ...
            toogleDragPan: function (a) {
                var c = this.config.viewPortConfig, b = c.status;
                a && (c.status = "zoom" === b ? "pan" : "zoom")
            },
            resize: function () {
                var a = this.config, c = this.graphics, b = this.components.canvas, h = b.graphics,
                    g = h.canvasBorderElement, h = h.canvasElement, b = b.config.canvasBorderThickness, f = b / 2,
                    k = a.canvasHeight -= b, l = a.canvasWidth -= 2 * b, m = a.canvasLeft += b;
                a.canvasBottom -= b;
                a.canvasRight -= b;
            ...
            updateManager: function (a) {
                var c, b;
                b = this.components;
                var h = b.dataset, g = h.length;
                c = this.config;
                var f =
                        c.allowPinMode, k = c.viewPortConfig, l = c._ypvr, m = c._visw, q = this.components.xAxis[0],
                    p = function () {
                        return q.getPixel.apply(q, arguments)
                    }, r = q.getAxisConfig("labels").style, t, u, v, x, z, A = this.updateButtonVisual,
                    y = b.tb.graphics, G = y.zoomOutButton, E = y.resetButton, y = y.pinButton, K = c.viewPortHistory;
                if (c.legendClicked) for (a = 0; a < g; a += 1) h[a].draw(); else {
                    ...
                    C.jQuery("body").append('<pre id="fc-zoominfo">'), C.jQuery("#fc-zoominfo").css({
                        position: "absolute",
                        left: "10px",
                        top: "0",
                        "pointer-events": "none",
                        ...
                        background: "#ffffff"
                    })), this.debug.text(JSON.stringify(k, 0, 2))) : (this.debug && C.jQuery("#fc-zoominfo").remove(), delete this.debug))
                }
            },
            _drawDataset: function () {
                h.zoomline.updateManager.call(this)
            },
            ...
            _createToolBox: function () {
                var a, c, b, f, g, k, l, m = this, q = m.config;
                l = q.allowPinMode;
                f = m.components;
                ...
                }), k = c.resetButton = (new b("resetIcon", void 0, a.idCount++, a.pId)).attachEventHandlers({
                    click: function () {
                        m.resetZoom()
                    }, tooltext: p && q.btnResetChartTooltext || ""
                }), l && (l = c.pinButton = (new b("pinModeIcon", void 0, a.idCount++, a.pId)).attachEventHandlers({
                    click: function () {
                        m.activatePin(!q.viewPortConfig.pinned)
                    }, tooltext: p && q.btnSwitchToPinModeTooltext || ""
                }), f.addSymbol(l, !0)), f.addSymbol(k, !0), f.addSymbol(g, !0))
            },
            _scrollBar: h.scrollcolumn2d,
            _manageScrollerPosition: h.scrollcolumn2d,
            draw: function () {
                var b, c, d, f, g, k, l, m, q, p, t = this, r = t.config, v = t.graphics || (t.graphics = {});
                k = t.components;
                b = t.jsonData;
                f = b.dataset;
                var u = b.categories && b.categories[0].category, x;
                ...
                f && u && (b++, f = E.crispBound(l - b, m + q + b, p + b + b, r.scrollHeight, b), b--, k = (g = k.scrollBar) && g.node,
                    g.draw(f.x + (c && -1 || b % 2), f.y - (c && 4 || 2), {
                        isHorizontal: !0,
                        width: f.width - (!c && 2 || 0),
                        height: f.height,
                        showButtons: r.scrollShowButtons,
                        scrollRatio: d.vdl / (d.clen - !!d.clen),
                        scrollPosition: [d.dsi / (d.clen - d.vdl - 1), !1],
                        r: c && 2 || 0,
                        parentLayer: x.insertBefore(v.datalabelsGroup)
                    }), !k && function () {
                    var c;
                    E.eve.on("raphael.scroll.start." + g.node.id, function (b) {
                        c = b;
                    ...
                    E.eve.on("raphael.scroll.end." + g.node.id,
                        function (b) {
                            t.graphics.crossline && t.graphics.crossline.disable(!1);
        ...
        B.register("component", ["dataset", "zoomline", {
            _setConfigure: function () {
                var a = this.config, c = this.chart.jsonData.chart, b = this.JSONData;
                ...
                var g = this.chart, h = this.components, h = (h.dataRT ||
                    h.data)[c], k = h.graphics.element, l = b.toolTip, m = d.originalEvent,
                    q = g.components.paper.canvas.style, t = !this.chart.config.useCrossline, p, r;
                ...
                c.transposeanimduration = 0
                                        ...
                                        c, b, h) {
                if (a) {
                    var g = a.config.anchorProps, f = g.borderThickness, k = this.components.data,
                        l = q(a.config.dragTolerance, 0), m, p;
                    m = a._xPos;
                    p = a._yPos;
                    if (null !== p) return a = a.config.hoverEffects, g = Math.max(g.radius, a && a.anchorRadius || 0, ra) + f / 2, b = Math.sqrt(Math.pow(b - m, 2) + Math.pow(h - p, 2)), b <= g || b <= l ? {
                        pointIndex: c,
                        hovered: !0,
                        pointObj: k[c]
                    } : !1
                ...
                var a, c, d = !1, h = !1, g = this, k = g.JSONData, l = g.chart, m = l.components, p = g.config,
                    t = g.index || g.positionIndex, r = l.config, x = l.jsonData.chart, z = g.components, u = z.data,
                    B = u.length, y, C = m.paper, A = m.xAxis[0], G = g.yAxis, E, L, N = l.graphics,
                    P = N.datalabelsGroup, Q = b.parseUnsafeString, U = b.getValidValue, R, D, J, M, ba, Z, W, H, X,
                    O = p.linethickness, Y = g.graphics.container, ea = g.graphics.trackerContainer,
                    na = r.viewPortConfig, ma = N.datasetGroup, ia, ra = p.shadow, ha,
                    sa = g.graphics.dataLabelContainer, I = {}, oa, la, ta = l.is3D, ua = p.use3dlineshift, ja, pa, va,
                    wa = G.getAxisBase(), xa = G.yBasePos = G.getAxisPosition(wa), Aa = A.getAxisPosition(0),
                    Fa = A.getAxisPosition(1) - Aa, Sa, Ka = ta ? 10 : 0, za = ta && ua ? 10 : 0,
                    ...
                    qb = {}, da = l.hasScroll || !1, Ga, La = p.lineDashStyle,
                    Ma = {color: p.linecolor, alpha: p.alpha};
                [v(Ma), La].join(":");
                var Ua, gb, $a, Pa = g.graphics.lineElement, Va = g.visible, hb, ab,
                    Ha = g.pool || (g.pool = {element: []}), ib = {}, bb = {}, jb = {}, kb, cb = [], lb, Ca, Wa, Xa, db,
                    eb, rb = r.showTerminalValidData, Qa = r.viewPortConfig, sb = r.showPeakData,
                    mb = r.maxPeakDataLimit, nb = r.minPeakDataLimit,
                    tb = q(r.useCrossline, 0), Ia = Qa.step, fb = A.getPixel(Qa.step) - Aa < Qa.amrd,
                    ob = function (a, c) {
                        var b = a.graphics;
                        la = a.config;
                        M = la.setValue;
                        ...
                        null === la.setValue || fb || (I.imageUrl ? (oa = new K, oa.onload = g._onAnchorImageLoad(g, c, ba, E, L), oa.onerror = g._onErrorSetter(E, L, c, g), oa.src = I.imageUrl) : (D = b.element, D || (D = Ha.element && Ha.element.length ? b.element = Ha.element.shift() : b.element = C.polypath(Y.anchorGroup)), D.attr({
                            ...
                            polypath: [I.sides, E, L, I.radius, I.startAngle, ab],
                            fill: v({color: I.bgColor, alpha: I.bgAlpha}),
                            stroke: v({color: I.borderColor, alpha: I.borderAlpha}),
                            "stroke-width": I.borderThickness
                        }, D && D.data("setRolloverAttr", X).data("setRolloutAttr", H)), D[M || 0 === M ? "show" : "hide"]()), fa(I.radius, ia && ia.anchorRadius || 0));
                        a._xPos = E;
                        a._yPos = L;
                        [v($a || Ma), va || La].join(":");
                        ...
                        var b = a && a.length, d = a.slice().sort(function (a, c) {
                            return a.config.setValue - c.config.setValue
                        }), e = d && d.pop().config.setValue, g = d.length && d.shift().config.setValue || e, d = 0;
                        if (e > mb || g < nb) for (; d < b;) {
                            D = a[d];
                            e = D.config.setValue;
                            if (e > mb || e < nb) e = c + d, ob(D, e);
                            d += 1
                        }
                    }, Ya = function (c, b) {
                        --c;
                        b += 1;
                        var d;
                        for (y = c; y < b; y += 1) for (d in a = u[y] && u[y].graphics || {}, u[y] && (u[y].config.isRemoving = !0), a) Ha[d] || (Ha[d] = []), a[d] && (Ha[d].push(a[d].hide()),
                            a[d] = void 0)
                    }, Za = na.ddsi || 0, Ja = na.ddei || B, Na = p._oldStartIndex, Oa = p._oldEndIndex, vb = p._oldStep,
                    pb = z.removeDataArr, wb = pb && pb.length;
                ma.line = ma.line || C.group("line", ma);
                ma.lineConnector = ma.lineConnector || C.group("line-connector", ma);
                Y || (Y = g.graphics.container = {
                    lineShadowGroup: C.group("connector-shadow", ma.line),
                    anchorShadowGroup: C.group("anchor-shadow", ma.lineConnector),
                    lineGroup: C.group("line", ma.line),
                    anchorGroup: C.group("anchors", ma.lineConnector)
                }, Y.lineGroup.trackTooltip(!0), Va || (Y.lineShadowGroup.hide(),
                ...
                for (y = p._oldStartIndex = Za; y <= Ja; y += Ia) {
                    ...
                    if (rb) if (0 === y && null === M) {
                        lb = 0;
                        for (Ca = c = y; Ca < B;) if (null !== u[Ca].config.setValue || d ? d = !0 : Ca++, null === u[c].config.setValue && !h && c <= B ? (c += Ia, lb++) : h = !0, d && h) {
                            d = h = !1;
                            break
                        }
                        0 !== Ca % Ia && (la = u[Ca].config, Wa = Ca)
                    } else if (y >= B && null === M) {
                        for (Ca = c = y; 0 < Ca && (void 0 !== u[Ca] || d ? d = !0 : Ca--, void 0 === u[c] && !h && 0 <= c ? c -= Ia : h = !0, !d || !h);) ;
                        0 !== Ca % Ia && (la = u[Ca].config, Wa = Ca)
                    }
                ...
                var b = this.graphics,
                    h = b && b.container, g = b && b.trackerContainer, b = b && b.dataLabelContainer,
                    f = a ? "show" : "hide";
                h.lineGroup[f]();
                h.anchorGroup[f]();
                ...
                var c = this.chart, b = c.config, h = this.yAxis;
                c._chartAnimation();
                this.visible = a;
        ...
        r.prototype.configure = function (a, c) {
            var b, h, g, f = {}, k = this, p = a.components, q = p.numberFormatter, r = p.paper, t = a.config;
            b = a.graphics;
            h = this.left = t._visx;
            g = this.top = t.canvasTop;
            var v = this.height = t.canvasHeight, y = this._visout = t._visout, u = this.plots = a.components.dataset,
                B = b.datalabelsGroup, z, C, A = c.labelstyle, E = c.valuestyle, G = p.yAxis[0], K = G.getLimit(),
                L = p.yAxis[1], N = L && L.getLimit();
            C = this.tracker;
            var p = this.labels, P = this.positionLabel;
            z = a.get("linkedItems");
            var Q = z.container, R =
            ...
            C || (C = k.tracker = Q, R.push(l(Q, "touchstart mousemove", function (c) {
                var b = k.onMouseMove, d = k.onMouseOut;
                a.isWithinCanvas(c, a).insideCanvas ? b.call(k, c) : d.call(k, c)
            }, k)), R.push(l(Q, "mousedown", function () {
                k.onMouseDown()
            }, k)), R.push(l(Q, "mouseup", function () {
                k.onMouseUp()
            }, k)), R.push(l(Q, "mouseout", function () {
                k.onMouseOut()
            }, k)));
            C =
                this.line;
            ...
            if (c.valueEnabled) {
                ...
                for (b = 0; b < p.items.length; b += 1) p[b].remove(), delete p[b];
                p.length = 0
            }
        };
        ...
        r.prototype.onMouseMove = function (a) {
            if (!(this.disabled || this._mouseIsDown && !z)) {
                var c, b = this.getZoomInfo(), h = this.line, g = this.left, b = b.step, f = this.chart,
                    k = f.components.xAxis[0], l = f.get("config"), m = l.canvasLeft,
                    p = k.getAxisConfig("axisDimention");
                a = ka(this.container, a, f).chartX - g;
                var g = k._getVisibleConfig(), p = p.x - m, q;
        ...
        r.prototype.updateLabels = function () {
            var a = this, c = a.labels, b = a.plots, f = a.width, g = a.position, h = a.lineX, k = ua(h),
                l = a.ppixelRatio, m = a.spixelRatio, p = a.yminValue, q = a._visout, r = a.numberFormatter,
                t = a.pyaxisminvalue, u = a.pyaxismaxvalue, v = a.syaxisminvalue, y = a.syaxismaxvalue,
                x = function () {
                    function c() {
                        this.y = 0;
                        this.lRef = void 0;
                    ...
                    function d(a) {
                        var c, b, e, g = {}, f = Number.POSITIVE_INFINITY;
                        for (c = 0; c < this.length; c++) b = this[c] - a, 0 > b ? e = v.NEG : e = v.POS, b = t(b), b <= f && (f = b, g.absValue = b, g.noScaleSide = e);
                        return g
                    }
                    ...
                    var f = -1 * a.height, h = p * l, k = 0, n, m = {}, r, t = Math.abs, u = Math.floor, v = {};
                    "function" != typeof Object.create && (Object.create = function () {
                        ...
                        return function (b) {
                            ...
                            g = new a;
                            a.prototype = null;
                            if (1 < arguments.length) for (e in d = Object(arguments[1]), d) c.call(d, e) && (g[e] = d[e]);
                            return g
                        }
                    }());
                    Array.prototype.indexOf || (Array.prototype.indexOf = function (a, c) {
                        ...
                        if (b >= e) return -1;
                        for (b =
                                 Math.max(0 <= b ? b : e - Math.abs(b), 0); b < e;) {
                    ...
                    Array.prototype.forEach || (Array.prototype.forEach = function (a, c) {
                        ...
                        for (d = 0; d < g;) d in e && (f = e[d], a.call(b, f, d, e)), d++
                    });
                    ...
                    try {
                        Object.defineProperty(v, "POS", {
                            enumerable: !1, configurable: !1, get: function () {
                                return 1
                            }
                        }), Object.defineProperty(v, "NEG", {
                            enumerable: !1, configurable: !1, get: function () {
                                return -1
                            }
                        })
                    ...
                    g.prototype.attachShift =
                        function (a, b, e) {
                            var g, f = this.length;
                            if (a === q) e.calcY = q; else if (f = b > f - 1 ? f - 1 : b, g = this[f], b = new c, b.y = a, b.lRef = e, g) {
                    ...
                    try {
                        Object.defineProperty(m, "top", {
                            enumerable: !1, configurable: !1, get: function () {
                                return f
                            }
                        }), Object.defineProperty(m, "bottom", {
                            enumerable: !1, configurable: !1, get: function () {
                                return h
                            }
                        })
            ...
            c && (c[0] && c[0].attr({text: r.yAxis("0")}), c[0] && x.init(c[0].getBBox().height, c.length), c.forEach(function (a, c) {
                var e = b[c], f = e.components.data[g] && e.components.data[g].config.setValue,
            ...
            c && c.forEach(function (a, c) {
                ...
                (e = r[e.config.parentYAxis ? "sYAxis" : "yAxis"](e.components.data[g] && e.components.data[g].config.setValue)) ? (a.attr({text: e}),
                    e = (e = (e = (e = a.getBBox()) && e.width) && .5 * e) && e + 10, m = a.calcY, l = fa(0, qa(k, f)), void 0 !== m && void 0 !== l && a.attr({
                    x: l,
                    y: m,
        ...
        E.addSymbol({
            pinModeIcon: function (a, c, b) {
                var f = .5 * b, g = a - b, h = a + b, k = a - f, l = a + f, m = a + .5, p = m + 1, q = m + 1.5,
                    r = c - b, t = c + f, u = c - f, f = c + (b - f);
                return ["M", g, r, "L",
                    k, u, k, f, g, t, a - .5, t, a, c + b + .5, m, t, h, t, l, f, l, u, h, r, q, r, q, u, q, f, p, f, p, u, q, u, q, r, "Z"]
            }, zoomOutIcon: function (a, c, b) {
                a -= .2 * b;
                c -= .2 * b;
                var f = .8 * b, g = E.rad(43), h = E.rad(48), k = a + f * wa(g), g = c + f * ta(g), l = a + f * wa(h),
                    h = c + f * ta(h), m = E.rad(45), p = k + b * wa(m), q = g + b * ta(m), r = l + b * wa(m);
                b = h + b * ta(m);
                return ["M", k, g, "A", f, f, 0, 1, 0, l, h, "Z", "M", k + 1, g + 1, "L", p, q, r, b, l + 1, h + 1, "Z", "M", a - 2, c, "L", a + 2, c, "Z"]
            }, resetIcon: function (a, b, d) {
                var f = a - d, g = (ba.PI / 2 + ba.PI) / 2;
                a += d * wa(g);
                var g = b + d * ta(g), h = 2 * d / 3;
